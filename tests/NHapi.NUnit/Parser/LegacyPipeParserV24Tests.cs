namespace NHapi.NUnit.Parser
{
    ...
    [TestFixture]
    public class LegacyPipeParserV24Tests
    {
        [Test]
        public void ParseQRYR02()
        {
            var message =
                "MSH|^~\\&|CohieCentral|COHIE|Clinical Data Provider|TCH|20060228155525||QRY^R02^QRY_R02|1|P|2.4|\r"
        ...
        {
            var message =
                "MSH|^~\\&|Query Result Locator|Query Facility Name|Query Application Name|ST ELSEWHERE HOSPITAL|20051024074506||ORF^R04|432|P|2.4|\r"
              + "MSA|AA|123456789|\r"
        ...
        {
            var message =
                "MSH|^~\\&|EPIC|AIDI|||20070921152053|ITFCOHIEIN|ORF^R04^ORF_R04|297|P|2.4|||\r"
              + "MSA|CA|1\r"
...
";
        ...
        public void TestGithubIssue24CantGetIN1Segment()
        {
            ...
            Assert.That(() => _ = (IN1)typedMessage.GetStructure("IN1"), Throws.TypeOf<HL7Exception>());
