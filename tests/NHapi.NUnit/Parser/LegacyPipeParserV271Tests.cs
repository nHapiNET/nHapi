namespace NHapi.NUnit.Parser
{
    ...
    public class LegacyPipeParserV271Tests
    {
        public string GetMessage()
        {
            return "MSH|^~\\&|XPress Arrival||||200610120839||ORU^R01|EBzH1711114101206|P|2.7.1|||AL|||ASCII\r"
        ...
        {
            var hl7Data =
                "MSH|^~\\&|CohieCentral|COHIE|Clinical Data Provider|TCH|20060228155525||ADT^A04|1|P|2.7.1|\r"
              + "EVN|\r"
              + "PID|1|12345\r"
              + "PV1|1";
