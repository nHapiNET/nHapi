...
///<li>4: DER_O44_DONOR_ORDER (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class DER_O44 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(DER_O44_DONOR_ORDER), true, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of DER_O44_DONOR_ORDER (a Group object) - creates it if necessary
	///</summary>
	public DER_O44_DONOR_ORDER GetDONOR_ORDER() {
	   DER_O44_DONOR_ORDER ret = null;
	   try {
	      ret = (DER_O44_DONOR_ORDER)this.GetStructure("DONOR_ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of DER_O44_DONOR_ORDER
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public DER_O44_DONOR_ORDER GetDONOR_ORDER(int rep) { 
	   return (DER_O44_DONOR_ORDER)this.GetStructure("DONOR_ORDER", rep);
	}

	/** 
	 * Returns the number of existing repetitions of DER_O44_DONOR_ORDER 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the DER_O44_DONOR_ORDER results 
	 */ 
	public IEnumerable<DER_O44_DONOR_ORDER> DONOR_ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < DONOR_ORDERRepetitionsUsed; rep++)
			{
				yield return (DER_O44_DONOR_ORDER)this.GetStructure("DONOR_ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new DER_O44_DONOR_ORDER
	///</summary>
	public DER_O44_DONOR_ORDER AddDONOR_ORDER()
	{
		return this.AddStructure("DONOR_ORDER") as DER_O44_DONOR_ORDER;
	}

	///<summary>
	///Removes the given DER_O44_DONOR_ORDER
	///</summary>
	public void RemoveDONOR_ORDER(DER_O44_DONOR_ORDER toRemove)
	{
		this.RemoveStructure("DONOR_ORDER", toRemove);
	}

	///<summary>
	///Removes the DER_O44_DONOR_ORDER at the given index
	///</summary>
