...
{
///<summary>
/// Represents a QBP_E03 message structure (see chapter 16.3.3). This structure contains the 
/// following elements:
///<ol>
...
///</summary>
[Serializable]
public class QBP_E03 : AbstractMessage  {

	///<summary> 
	/// Creates a new QBP_E03 Group with custom IModelClassFactory.
	///</summary>
	public QBP_E03(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new QBP_E03 Group with DefaultModelClassFactory. 
	///</summary> 
	public QBP_E03() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for QBP_E03.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating QBP_E03 - this is probably a bug in the source code generator.", e);
	   }
	}
