...
///<li>4: REF_I12_AUTHORIZATION_CONTACT1 (a Group object) optional </li>
...
public class REF_I12 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(REF_I12_AUTHORIZATION_CONTACT1), false, false);
...
get{
	...
	///<summary>
	/// Returns REF_I12_AUTHORIZATION_CONTACT1 (a Group object) - creates it if necessary
	///</summary>
	public REF_I12_AUTHORIZATION_CONTACT1 AUTHORIZATION_CONTACT1 { 
get{
	   REF_I12_AUTHORIZATION_CONTACT1 ret = null;
	   try {
	      ret = (REF_I12_AUTHORIZATION_CONTACT1)this.GetStructure("AUTHORIZATION_CONTACT1");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
