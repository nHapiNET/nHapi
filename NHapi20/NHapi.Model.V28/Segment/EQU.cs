...
public class EQU : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(EI), true, 0, 0, new System.Object[]{message}, "Equipment Instance Identifier");
	...
	///<summary>
	/// Returns a single repetition of Equipment Instance Identifier(EQU-1).
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Equipment Instance Identifier (EQU-1).
   ///</summary>
