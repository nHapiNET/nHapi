...
///<li>RXE-21: Special Dispensing Instructions (CWE)</li>
...
get{
	...
	///<summary>
	/// Returns a single repetition of Special Dispensing Instructions(RXE-21).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Special Dispensing Instructions (RXE-21).
   ///</summary>
