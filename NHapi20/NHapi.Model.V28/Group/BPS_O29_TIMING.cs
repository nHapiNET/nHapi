...
{
///<summary>
///Represents the BPS_O29_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class BPS_O29_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new BPS_O29_TIMING Group.
	///</summary>
	public BPS_O29_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating BPS_O29_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
