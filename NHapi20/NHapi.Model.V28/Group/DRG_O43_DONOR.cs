...
{
///<summary>
///Represents the DRG_O43_DONOR Group.  A Group is an ordered collection of message 
...
///<li>6: DRG_O43_DONOR_REGISTRATION (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class DRG_O43_DONOR : AbstractGroup {

	///<summary> 
	/// Creates a new DRG_O43_DONOR Group.
	///</summary>
	public DRG_O43_DONOR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(DRG_O43_DONOR_REGISTRATION), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating DRG_O43_DONOR - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns DRG_O43_DONOR_REGISTRATION (a Group object) - creates it if necessary
	///</summary>
	public DRG_O43_DONOR_REGISTRATION DONOR_REGISTRATION { 
get{
	   DRG_O43_DONOR_REGISTRATION ret = null;
	   try {
	      ret = (DRG_O43_DONOR_REGISTRATION)this.GetStructure("DONOR_REGISTRATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
