...
{
///<summary>
///Represents the RDE_O11_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RDE_O11_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RDE_O11_TIMING Group.
	///</summary>
	public RDE_O11_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RDE_O11_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
