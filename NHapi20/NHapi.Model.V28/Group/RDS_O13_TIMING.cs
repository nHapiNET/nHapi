...
{
///<summary>
///Represents the RDS_O13_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RDS_O13_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RDS_O13_TIMING Group.
	///</summary>
	public RDS_O13_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RDS_O13_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
