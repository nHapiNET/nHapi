...
///<li>1: OBR (Observation Request) optional repeating</li>
///<li>2: SPM (Specimen) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class EAC_U07_SPECIMEN_CONTAINER : AbstractGroup {
	...
	///</summary>
	public EAC_U07_SPECIMEN_CONTAINER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(SAC), true, false);
	      this.add(typeof(OBR), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of OBR (Observation Request) - creates it if necessary
	///</summary>
	public OBR GetOBR() {
	   OBR ret = null;
	   try {
	...
	///<summary>
	///Returns a specific repetition of OBR
	/// * (Observation Request) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OBR GetOBR(int rep) { 
	   return (OBR)this.GetStructure("OBR", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OBR 
	 */ 
	public int OBRRepetitionsUsed { 
get{
	    int reps = -1; 
	    try { 
	        reps = this.GetAll("OBR").Length; 
	    } catch (HL7Exception e) { 
