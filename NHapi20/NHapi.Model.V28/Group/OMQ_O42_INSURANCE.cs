...
{
///<summary>
///Represents the OMQ_O42_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMQ_O42_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new OMQ_O42_INSURANCE Group.
	///</summary>
	public OMQ_O42_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(IN1), true, false);
	      this.add(typeof(IN2), false, false);
	      this.add(typeof(IN3), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMQ_O42_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
