...
{
///<summary>
///Represents the CCR_I16_ROLE_PATHWAY Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCR_I16_ROLE_PATHWAY : AbstractGroup {

	///<summary> 
	/// Creates a new CCR_I16_ROLE_PATHWAY Group.
	///</summary>
	public CCR_I16_ROLE_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCR_I16_ROLE_PATHWAY - this is probably a bug in the source code generator.", e);
	   }
	}
