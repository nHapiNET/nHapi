...
///<li>2: OPU_R25_COMMON_ORDER (a Group object) optional </li>
///<li>3: NTE (Notes and Comments) optional repeating</li>
///<li>4: PRT (Participation Information) optional repeating</li>
///<li>5: OPU_R25_TIMING_QTY (a Group object) optional repeating</li>
///<li>6: OPU_R25_RESULT (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class OPU_R25_ORDER : AbstractGroup {
	...
	public OPU_R25_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OPU_R25_COMMON_ORDER), false, false);
...
get{
	...
	///</summary>
	public OPU_R25_COMMON_ORDER COMMON_ORDER { 
get{
	   OPU_R25_COMMON_ORDER ret = null;
	   try {
	      ret = (OPU_R25_COMMON_ORDER)this.GetStructure("COMMON_ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
