...
///<li>1: RAS_O17_ADDITIONAL_DEMOGRAPHICS (a Group object) optional </li>
///<li>2: NTE (Notes and Comments) optional repeating</li>
///<li>3: ARV (Access Restriction) optional repeating</li>
///<li>4: AL1 (Patient Allergy Information) optional repeating</li>
///<li>5: RAS_O17_PATIENT_VISIT (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RAS_O17_PATIENT : AbstractGroup {
	...
	public RAS_O17_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RAS_O17_ADDITIONAL_DEMOGRAPHICS), false, false);
...
get{
	...
	///<summary>
	/// Returns RAS_O17_ADDITIONAL_DEMOGRAPHICS (a Group object) - creates it if necessary
	///</summary>
	public RAS_O17_ADDITIONAL_DEMOGRAPHICS ADDITIONAL_DEMOGRAPHICS { 
get{
	   RAS_O17_ADDITIONAL_DEMOGRAPHICS ret = null;
	   try {
	      ret = (RAS_O17_ADDITIONAL_DEMOGRAPHICS)this.GetStructure("ADDITIONAL_DEMOGRAPHICS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
