...
{
///<summary>
///Represents the OMP_O09_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMP_O09_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OMP_O09_TIMING Group.
	///</summary>
	public OMP_O09_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMP_O09_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
