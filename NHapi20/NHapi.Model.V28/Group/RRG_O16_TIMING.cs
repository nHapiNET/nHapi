...
{
///<summary>
///Represents the RRG_O16_TIMING Group.  A Group is an ordered collection of message 
...
public class RRG_O16_TIMING : AbstractGroup {
	...
	///</summary>
	public RRG_O16_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
