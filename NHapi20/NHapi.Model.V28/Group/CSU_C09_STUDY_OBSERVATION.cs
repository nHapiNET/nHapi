...
///<ol>
///<li>0: CSU_C09_STUDY_OBSERVATION_ORDER (a Group object) optional </li>
...
public class CSU_C09_STUDY_OBSERVATION : AbstractGroup {
	...
	public CSU_C09_STUDY_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(CSU_C09_STUDY_OBSERVATION_ORDER), false, false);
	...
	///<summary>
	/// Returns CSU_C09_STUDY_OBSERVATION_ORDER (a Group object) - creates it if necessary
	///</summary>
	public CSU_C09_STUDY_OBSERVATION_ORDER STUDY_OBSERVATION_ORDER { 
get{
	   CSU_C09_STUDY_OBSERVATION_ORDER ret = null;
	   try {
	      ret = (CSU_C09_STUDY_OBSERVATION_ORDER)this.GetStructure("STUDY_OBSERVATION_ORDER");
	   } catch(HL7Exception e) {
