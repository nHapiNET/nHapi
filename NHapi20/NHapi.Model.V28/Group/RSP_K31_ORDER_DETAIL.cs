...
///<li>3: RSP_K31_COMPONENTS (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	///     greater than the number of existing repetitions.
	///</summary>
	public RSP_K31_COMPONENTS GetCOMPONENTS(int rep) { 
	   return (RSP_K31_COMPONENTS)this.GetStructure("COMPONENTS", rep);
	}
