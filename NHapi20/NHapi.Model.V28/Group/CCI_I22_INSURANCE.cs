...
{
///<summary>
///Represents the CCI_I22_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCI_I22_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new CCI_I22_INSURANCE Group.
	///</summary>
	public CCI_I22_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(IN1), true, false);
	      this.add(typeof(IN2), false, false);
	      this.add(typeof(IN3), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCI_I22_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
