...
///<li>2: OML_O35_TIMING (a Group object) optional repeating</li>
///<li>3: OML_O35_OBSERVATION_REQUEST (a Group object) optional </li>
...
get{
	...
	/** 
	 * Enumerate over the OML_O35_TIMING results 
	 */ 
	public IEnumerable<OML_O35_TIMING> TIMINGs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMINGRepetitionsUsed; rep++)
			{
				yield return (OML_O35_TIMING)this.GetStructure("TIMING", rep);
			}
		}
	}

	///<summary>
	///Adds a new OML_O35_TIMING
	///</summary>
	public OML_O35_TIMING AddTIMING()
	{
		return this.AddStructure("TIMING") as OML_O35_TIMING;
	}

	///<summary>
	///Removes the given OML_O35_TIMING
	///</summary>
	public void RemoveTIMING(OML_O35_TIMING toRemove)
	{
		this.RemoveStructure("TIMING", toRemove);
	}

	///<summary>
	///Removes the OML_O35_TIMING at the given index
	///</summary>
