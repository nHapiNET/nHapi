...
///<ol>
///<li>0: ORU_R01_COMMON_ORDER (a Group object) optional </li>
...
public class ORU_R01_ORDER_OBSERVATION : AbstractGroup {
	...
	public ORU_R01_ORDER_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ORU_R01_COMMON_ORDER), false, false);
	...
	///<summary>
	/// Returns ORU_R01_COMMON_ORDER (a Group object) - creates it if necessary
	///</summary>
	public ORU_R01_COMMON_ORDER COMMON_ORDER { 
get{
	   ORU_R01_COMMON_ORDER ret = null;
	   try {
	      ret = (ORU_R01_COMMON_ORDER)this.GetStructure("COMMON_ORDER");
	   } catch(HL7Exception e) {
