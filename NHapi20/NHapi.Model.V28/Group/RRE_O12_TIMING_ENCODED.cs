...
{
///<summary>
///Represents the RRE_O12_TIMING_ENCODED Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RRE_O12_TIMING_ENCODED : AbstractGroup {

	///<summary> 
	/// Creates a new RRE_O12_TIMING_ENCODED Group.
	///</summary>
	public RRE_O12_TIMING_ENCODED(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RRE_O12_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
	   }
	}
