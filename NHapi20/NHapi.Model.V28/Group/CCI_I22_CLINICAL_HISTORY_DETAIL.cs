...
{
///<summary>
///Represents the CCI_I22_CLINICAL_HISTORY_DETAIL Group.  A Group is an ordered collection of message 
...
///<li>12: CCI_I22_CLINICAL_HISTORY_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class CCI_I22_CLINICAL_HISTORY_DETAIL : AbstractGroup {
	...
	public CCI_I22_CLINICAL_HISTORY_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(CCI_I22_CLINICAL_HISTORY_OBSERVATION), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of CCI_I22_CLINICAL_HISTORY_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public CCI_I22_CLINICAL_HISTORY_OBSERVATION GetCLINICAL_HISTORY_OBSERVATION() {
	   CCI_I22_CLINICAL_HISTORY_OBSERVATION ret = null;
	   try {
	      ret = (CCI_I22_CLINICAL_HISTORY_OBSERVATION)this.GetStructure("CLINICAL_HISTORY_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of CCI_I22_CLINICAL_HISTORY_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public CCI_I22_CLINICAL_HISTORY_OBSERVATION GetCLINICAL_HISTORY_OBSERVATION(int rep) { 
	   return (CCI_I22_CLINICAL_HISTORY_OBSERVATION)this.GetStructure("CLINICAL_HISTORY_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CCI_I22_CLINICAL_HISTORY_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the CCI_I22_CLINICAL_HISTORY_OBSERVATION results 
	 */ 
	public IEnumerable<CCI_I22_CLINICAL_HISTORY_OBSERVATION> CLINICAL_HISTORY_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < CLINICAL_HISTORY_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCI_I22_CLINICAL_HISTORY_OBSERVATION)this.GetStructure("CLINICAL_HISTORY_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCI_I22_CLINICAL_HISTORY_OBSERVATION
	///</summary>
	public CCI_I22_CLINICAL_HISTORY_OBSERVATION AddCLINICAL_HISTORY_OBSERVATION()
	{
		return this.AddStructure("CLINICAL_HISTORY_OBSERVATION") as CCI_I22_CLINICAL_HISTORY_OBSERVATION;
	}

	///<summary>
	///Removes the given CCI_I22_CLINICAL_HISTORY_OBSERVATION
	///</summary>
	public void RemoveCLINICAL_HISTORY_OBSERVATION(CCI_I22_CLINICAL_HISTORY_OBSERVATION toRemove)
	{
		this.RemoveStructure("CLINICAL_HISTORY_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CCI_I22_CLINICAL_HISTORY_OBSERVATION at the given index
	///</summary>
