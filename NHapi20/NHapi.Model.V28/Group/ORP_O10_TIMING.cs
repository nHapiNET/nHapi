...
{
///<summary>
///Represents the ORP_O10_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORP_O10_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORP_O10_TIMING Group.
	///</summary>
	public ORP_O10_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORP_O10_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
