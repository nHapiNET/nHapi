...
{
///<summary>
///Represents the ADT_A16_PROCEDURE Group.  A Group is an ordered collection of message 
...
public class ADT_A16_PROCEDURE : AbstractGroup {
	...
	///</summary>
	public ADT_A16_PROCEDURE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PR1), true, false);
	      this.add(typeof(ROL), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ADT_A16_PROCEDURE - this is probably a bug in the source code generator.", e);
	   }
	}
