...
{
///<summary>
///Represents the OML_O33_PATIENT Group.  A Group is an ordered collection of message 
...
///<li>6: OML_O33_PATIENT_VISIT (a Group object) optional </li>
///<li>7: OML_O33_INSURANCE (a Group object) optional repeating</li>
///<li>8: GT1 (Guarantor) optional </li>
///<li>9: AL1 (Patient Allergy Information) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class OML_O33_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new OML_O33_PATIENT Group.
	///</summary>
	public OML_O33_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O33_PATIENT_VISIT), false, false);
	      this.add(typeof(OML_O33_INSURANCE), false, true);
	      this.add(typeof(GT1), false, false);
	      this.add(typeof(AL1), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OML_O33_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///</summary>
	public OML_O33_PATIENT_VISIT PATIENT_VISIT { 
get{
	   OML_O33_PATIENT_VISIT ret = null;
	   try {
	      ret = (OML_O33_PATIENT_VISIT)this.GetStructure("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OML_O33_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (OML_O33_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OML_O33_INSURANCE GetINSURANCE(int rep) { 
	   return (OML_O33_INSURANCE)this.GetStructure("INSURANCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the OML_O33_INSURANCE results 
	 */ 
	public IEnumerable<OML_O33_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (OML_O33_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new OML_O33_INSURANCE
	///</summary>
	public OML_O33_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as OML_O33_INSURANCE;
	}

	///<summary>
	///Removes the given OML_O33_INSURANCE
	///</summary>
	public void RemoveINSURANCE(OML_O33_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the OML_O33_INSURANCE at the given index
	///</summary>
