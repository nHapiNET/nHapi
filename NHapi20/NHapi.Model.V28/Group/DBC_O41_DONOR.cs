...
{
///<summary>
///Represents the DBC_O41_DONOR Group.  A Group is an ordered collection of message 
...
///<li>4: ARV (Access Restriction) optional repeating</li>
///<li>5: AL1 (Patient Allergy Information) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class DBC_O41_DONOR : AbstractGroup {

	///<summary> 
	/// Creates a new DBC_O41_DONOR Group.
	///</summary>
	public DBC_O41_DONOR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating DBC_O41_DONOR - this is probably a bug in the source code generator.", e);
	   }
	}
