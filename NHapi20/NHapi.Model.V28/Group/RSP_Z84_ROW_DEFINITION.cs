...
{
///<summary>
///Represents the RSP_Z84_ROW_DEFINITION Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RSP_Z84_ROW_DEFINITION : AbstractGroup {

	///<summary> 
	/// Creates a new RSP_Z84_ROW_DEFINITION Group.
	///</summary>
	public RSP_Z84_ROW_DEFINITION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(RDF), true, false);
	      this.add(typeof(RDT), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RSP_Z84_ROW_DEFINITION - this is probably a bug in the source code generator.", e);
	   }
	}
