...
///<li>4: RDE_O11_COMPONENTS (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class RDE_O11_ORDER_DETAIL : AbstractGroup {
	...
	public RDE_O11_ORDER_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RDE_O11_COMPONENTS), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of RDE_O11_COMPONENTS (a Group object) - creates it if necessary
	///</summary>
	public RDE_O11_COMPONENTS GetCOMPONENTS() {
	   RDE_O11_COMPONENTS ret = null;
	   try {
	      ret = (RDE_O11_COMPONENTS)this.GetStructure("COMPONENTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of RDE_O11_COMPONENTS
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public RDE_O11_COMPONENTS GetCOMPONENTS(int rep) { 
	   return (RDE_O11_COMPONENTS)this.GetStructure("COMPONENTS", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RDE_O11_COMPONENTS 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the RDE_O11_COMPONENTS results 
	 */ 
	public IEnumerable<RDE_O11_COMPONENTS> COMPONENTSs 
	{ 
		get
		{
			for (int rep = 0; rep < COMPONENTSRepetitionsUsed; rep++)
			{
				yield return (RDE_O11_COMPONENTS)this.GetStructure("COMPONENTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDE_O11_COMPONENTS
	///</summary>
	public RDE_O11_COMPONENTS AddCOMPONENTS()
	{
		return this.AddStructure("COMPONENTS") as RDE_O11_COMPONENTS;
	}

	///<summary>
	///Removes the given RDE_O11_COMPONENTS
	///</summary>
	public void RemoveCOMPONENTS(RDE_O11_COMPONENTS toRemove)
	{
		this.RemoveStructure("COMPONENTS", toRemove);
	}

	///<summary>
	///Removes the RDE_O11_COMPONENTS at the given index
	///</summary>
