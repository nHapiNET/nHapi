...
///<li>1: ORL_O36_SPECIMEN_OBSERVATION (a Group object) optional repeating</li>
...
public class ORL_O36_SPECIMEN : AbstractGroup {
	...
	public ORL_O36_SPECIMEN(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(ORL_O36_SPECIMEN_OBSERVATION), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of ORL_O36_SPECIMEN_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public ORL_O36_SPECIMEN_OBSERVATION GetSPECIMEN_OBSERVATION() {
	   ORL_O36_SPECIMEN_OBSERVATION ret = null;
	   try {
	      ret = (ORL_O36_SPECIMEN_OBSERVATION)this.GetStructure("SPECIMEN_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ORL_O36_SPECIMEN_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ORL_O36_SPECIMEN_OBSERVATION GetSPECIMEN_OBSERVATION(int rep) { 
	   return (ORL_O36_SPECIMEN_OBSERVATION)this.GetStructure("SPECIMEN_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ORL_O36_SPECIMEN_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the ORL_O36_SPECIMEN_OBSERVATION results 
	 */ 
	public IEnumerable<ORL_O36_SPECIMEN_OBSERVATION> SPECIMEN_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < SPECIMEN_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (ORL_O36_SPECIMEN_OBSERVATION)this.GetStructure("SPECIMEN_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O36_SPECIMEN_OBSERVATION
	///</summary>
	public ORL_O36_SPECIMEN_OBSERVATION AddSPECIMEN_OBSERVATION()
	{
		return this.AddStructure("SPECIMEN_OBSERVATION") as ORL_O36_SPECIMEN_OBSERVATION;
	}

	///<summary>
	///Removes the given ORL_O36_SPECIMEN_OBSERVATION
	///</summary>
	public void RemoveSPECIMEN_OBSERVATION(ORL_O36_SPECIMEN_OBSERVATION toRemove)
	{
		this.RemoveStructure("SPECIMEN_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the ORL_O36_SPECIMEN_OBSERVATION at the given index
	///</summary>
