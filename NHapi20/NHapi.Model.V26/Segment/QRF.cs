...
///<li>QRF-2: When Data Start Date/Time (DTM)</li>
///<li>QRF-3: When Data End Date/Time (DTM)</li>
...
public class QRF : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(DTM), false, 1, 0, new System.Object[]{message}, "When Data Start Date/Time");
       this.add(typeof(DTM), false, 1, 0, new System.Object[]{message}, "When Data End Date/Time");
       ...
       this.add(typeof(TQ), false, 1, 0, new System.Object[]{message}, "When Quantity/Timing Qualifier");
...
get{
	...
	///</summary>
	public DTM WhenDataStartDateTime
	{
		get{
			DTM ret = null;
			try
	...
	///</summary>
	public DTM WhenDataEndDateTime
	{
		get{
			DTM ret = null;
			try
