...
///<li>URS-2: R/U When Data Start Date/Time (DTM)</li>
///<li>URS-3: R/U When Data End Date/Time (DTM)</li>
...
///<li>URS-9: R/U Quantity/Timing Qualifier (TQ)</li>
///</ol>
...
public class URS : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "R/U When Data Start Date/Time");
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "R/U When Data End Date/Time");
       ...
       this.add(typeof(TQ), false, 1, 0, new System.Object[]{message}, "R/U Quantity/Timing Qualifier");
...
get{
	...
	///</summary>
	public DTM RUWhenDataStartDateTime
	{
		get{
			DTM ret = null;
			try
	...
	///</summary>
	public DTM RUWhenDataEndDateTime
	{
		get{
			DTM ret = null;
			try
