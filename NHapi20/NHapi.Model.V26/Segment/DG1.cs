...
///<li>DG1-25: DRG Diagnosis Determination Status (IS)</li>
///<li>DG1-26: Present On Admission (POA) Indicator (IS)</li>
///</ol>
...
public class DG1 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "Attestation Date/Time");
       ...
       this.add(typeof(EI), false, 1, 427, new System.Object[]{message}, "Parent Diagnosis");
       this.add(typeof(CWE), false, 1, 705, new System.Object[]{message}, "DRG CCL Value Code");
       this.add(typeof(ID), false, 1, 20, new System.Object[]{message, 136}, "DRG Grouping Usage");
       this.add(typeof(IS), false, 1, 20, new System.Object[]{message, 731}, "DRG Diagnosis Determination Status");
       this.add(typeof(IS), false, 1, 1, new System.Object[]{message, 895}, "Present On Admission (POA) Indicator");
...
get{
	...
	///</summary>
	public IS DRGDiagnosisDeterminationStatus
	{
		get{
			IS ret = null;
			try
	...
	///</summary>
	public IS PresentOnAdmissionIndicator
	{
		get{
			IS ret = null;
			try
