...
public class RMI : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Risk Management Incident Code");
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "Date/Time Incident");
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Incident Type Code");
