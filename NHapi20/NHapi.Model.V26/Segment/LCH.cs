...
public class LCH : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), true, 1, 250, new System.Object[]{message}, "Location Characteristic ID");
       this.add(typeof(CWE), true, 1, 250, new System.Object[]{message}, "Location Characteristic Value - LCH");
