...
///<li>QRD-1: Query Date/Time (DTM)</li>
...
///<li>QRD-6: Deferred Response Date/Time (DTM)</li>
///<li>QRD-7: Quantity Limited Request (CQ)</li>
///<li>QRD-8: Who Subject Filter (XCN)</li>
///<li>QRD-9: What Subject Filter (CWE)</li>
///<li>QRD-10: What Department Data Code (CWE)</li>
...
public class QRD : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(DTM), true, 1, 24, new System.Object[]{message}, "Query Date/Time");
       ...
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "Deferred Response Date/Time");
       ...
       this.add(typeof(CWE), true, 0, 250, new System.Object[]{message}, "What Subject Filter");
       this.add(typeof(CWE), true, 0, 250, new System.Object[]{message}, "What Department Data Code");
	...
	///</summary>
	public DTM DeferredResponseDateTime
	{
		get{
			DTM ret = null;
			try
