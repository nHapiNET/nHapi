...
///<li>PYE-2: Payee Type (IS)</li>
///<li>PYE-3: Payee Relationship to Invoice (Patient) (IS)</li>
///<li>PYE-4: Payee Identification List (XON)</li>
///<li>PYE-5: Payee Person Name (XPN)</li>
///<li>PYE-6: Payee Address (XAD)</li>
///<li>PYE-7: Payment Method (IS)</li>
///</ol>
...
public class PYE : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(IS), true, 1, 6, new System.Object[]{message, 557}, "Payee Type");
       this.add(typeof(IS), false, 1, 2, new System.Object[]{message, 558}, "Payee Relationship to Invoice (Patient)");
       this.add(typeof(XON), false, 1, 183, new System.Object[]{message}, "Payee Identification List");
       this.add(typeof(XPN), false, 1, 466, new System.Object[]{message}, "Payee Person Name");
       this.add(typeof(XAD), false, 1, 235, new System.Object[]{message}, "Payee Address");
       this.add(typeof(IS), false, 1, 80, new System.Object[]{message, 570}, "Payment Method");
	...
	///</summary>
	public IS PayeeRelationshipToInvoicePatient
	{
		get{
			IS ret = null;
			try
