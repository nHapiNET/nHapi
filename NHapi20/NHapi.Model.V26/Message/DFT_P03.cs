...
/// following elements:
///<ol>
///<li>0: MSH (Message Header) repeating</li>
...
///<li>7: PV1 (Patient Visit) optional </li>
...
///<li>11: DFT_P03_COMMON_ORDER (a Group object) optional repeating</li>
///<li>12: DFT_P03_FINANCIAL (a Group object) repeating</li>
...
///<li>16: DFT_P03_INSURANCE (a Group object) optional repeating</li>
...
public class DFT_P03 : AbstractMessage  {
	...
	///<summary>
	///Returns a specific repetition of MSH
	/// * (Message Header) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public MSH GetMSH(int rep) { 
	   return (MSH)this.GetStructure("MSH", rep);
	}

	/** 
	 * Returns the number of existing repetitions of MSH 
	 */ 
	public int MSHRepetitionsUsed { 
get{
	    int reps = -1; 
	    try { 
	        reps = this.GetAll("MSH").Length; 
	    } catch (HL7Exception e) { 
	...
	/** 
	 * Enumerate over the MSH results 
	 */ 
	public IEnumerable<MSH> MSHs 
	{ 
		get
		{
			for (int rep = 0; rep < MSHRepetitionsUsed; rep++)
			{
				yield return (MSH)this.GetStructure("MSH", rep);
			}
		}
	}
	...
	public MSH AddMSH()
	{
		return this.AddStructure("MSH") as MSH;
	}

	///<summary>
	///Removes the given MSH
	///</summary>
	public void RemoveMSH(MSH toRemove)
	{
		this.RemoveStructure("MSH", toRemove);
	}

	///<summary>
	///Removes the MSH at the given index
	///</summary>
	public void RemoveMSHAt(int index)
	{
		this.RemoveRepetition("MSH", index);
	}
