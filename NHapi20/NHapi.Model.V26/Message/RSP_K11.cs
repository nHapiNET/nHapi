...
{
///<summary>
/// Represents a RSP_K11 message structure (see chapter 5.3.1.2). This structure contains the 
/// following elements:
///<ol>
...
///<li>7: RSP_K11_ROW_DEFINITION (a Group object) optional </li>
...
public class RSP_K11 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RSP_K11_ROW_DEFINITION), false, false);
...
get{
	...
	///</summary>
	public RSP_K11_ROW_DEFINITION ROW_DEFINITION { 
get{
	   RSP_K11_ROW_DEFINITION ret = null;
	   try {
	      ret = (RSP_K11_ROW_DEFINITION)this.GetStructure("ROW_DEFINITION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
