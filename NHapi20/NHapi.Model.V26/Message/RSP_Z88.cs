...
{
///<summary>
/// Represents a RSP_Z88 message structure (see chapter 5.9.2.1.1). This structure contains the 
/// following elements:
///<ol>
...
///<li>8: RSP_Z88_QUERY_RESPONSE (a Group object) repeating</li>
///<li>9: DSC (Continuation Pointer) </li>
///</ol>
///</summary>
[Serializable]
public class RSP_Z88 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RSP_Z88.  This does the segment setup for the message. 
	///</summary> 
