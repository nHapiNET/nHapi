...
{
///<summary>
/// Represents a QRY_T12 message structure (see chapter 9.8.1). This structure contains the 
/// following elements:
///<ol>
...
public class QRY_T12 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for QRY_T12.  This does the segment setup for the message. 
	///</summary> 
