...
{
///<summary>
///Represents the EHC_E10_PRODUCT_SERVICE_GROUP Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class EHC_E10_PRODUCT_SERVICE_GROUP : AbstractGroup {

	///<summary> 
	/// Creates a new EHC_E10_PRODUCT_SERVICE_GROUP Group.
	///</summary>
	public EHC_E10_PRODUCT_SERVICE_GROUP(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PSG), true, false);
	      this.add(typeof(EHC_E10_PRODUCT_SERVICE_LINE_INFO), true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating EHC_E10_PRODUCT_SERVICE_GROUP - this is probably a bug in the source code generator.", e);
	   }
	}
