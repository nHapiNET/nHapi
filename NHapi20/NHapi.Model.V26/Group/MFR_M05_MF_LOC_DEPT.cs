...
{
///<summary>
///Represents the MFR_M05_MF_LOC_DEPT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class MFR_M05_MF_LOC_DEPT : AbstractGroup {

	///<summary> 
	/// Creates a new MFR_M05_MF_LOC_DEPT Group.
	///</summary>
	public MFR_M05_MF_LOC_DEPT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(LDP), true, false);
	      this.add(typeof(LCH), false, true);
	      this.add(typeof(LCC), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating MFR_M05_MF_LOC_DEPT - this is probably a bug in the source code generator.", e);
	   }
	}
