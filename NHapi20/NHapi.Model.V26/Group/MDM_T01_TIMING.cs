...
{
///<summary>
///Represents the MDM_T01_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class MDM_T01_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new MDM_T01_TIMING Group.
	///</summary>
	public MDM_T01_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating MDM_T01_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
