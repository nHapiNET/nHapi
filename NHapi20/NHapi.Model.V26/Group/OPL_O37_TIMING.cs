...
{
///<summary>
///Represents the OPL_O37_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OPL_O37_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OPL_O37_TIMING Group.
	///</summary>
	public OPL_O37_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OPL_O37_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
