...
{
///<summary>
///Represents the MFR_M06_MF_PHASE_SCHED_DETAIL Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class MFR_M06_MF_PHASE_SCHED_DETAIL : AbstractGroup {

	///<summary> 
	/// Creates a new MFR_M06_MF_PHASE_SCHED_DETAIL Group.
	///</summary>
	public MFR_M06_MF_PHASE_SCHED_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(CM1), true, false);
	      this.add(typeof(CM2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating MFR_M06_MF_PHASE_SCHED_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
