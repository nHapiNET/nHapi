...
get{
	...
	/** 
	 * Enumerate over the EHC_E01_PRODUCT_SERVICE_GROUP results 
	 */ 
	public IEnumerable<EHC_E01_PRODUCT_SERVICE_GROUP> PRODUCT_SERVICE_GROUPs 
	{ 
		get
		{
			for (int rep = 0; rep < PRODUCT_SERVICE_GROUPRepetitionsUsed; rep++)
			{
				yield return (EHC_E01_PRODUCT_SERVICE_GROUP)this.GetStructure("PRODUCT_SERVICE_GROUP", rep);
			}
		}
	}

	///<summary>
	///Adds a new EHC_E01_PRODUCT_SERVICE_GROUP
	///</summary>
	public EHC_E01_PRODUCT_SERVICE_GROUP AddPRODUCT_SERVICE_GROUP()
	{
		return this.AddStructure("PRODUCT_SERVICE_GROUP") as EHC_E01_PRODUCT_SERVICE_GROUP;
	}

	///<summary>
	///Removes the given EHC_E01_PRODUCT_SERVICE_GROUP
	///</summary>
	public void RemovePRODUCT_SERVICE_GROUP(EHC_E01_PRODUCT_SERVICE_GROUP toRemove)
	{
		this.RemoveStructure("PRODUCT_SERVICE_GROUP", toRemove);
	}

	///<summary>
	///Removes the EHC_E01_PRODUCT_SERVICE_GROUP at the given index
	///</summary>
