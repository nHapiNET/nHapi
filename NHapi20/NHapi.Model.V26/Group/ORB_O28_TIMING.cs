...
{
///<summary>
///Represents the ORB_O28_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORB_O28_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORB_O28_TIMING Group.
	///</summary>
	public ORB_O28_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORB_O28_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
