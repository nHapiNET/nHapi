...
{
///<summary>
///Represents the OMB_O27_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMB_O27_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OMB_O27_TIMING Group.
	///</summary>
	public OMB_O27_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMB_O27_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
