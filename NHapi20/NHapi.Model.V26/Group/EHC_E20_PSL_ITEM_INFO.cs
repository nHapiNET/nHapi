...
{
///<summary>
///Represents the EHC_E20_PSL_ITEM_INFO Group.  A Group is an ordered collection of message 
...
///<li>3: LOC (Location Identification) optional repeating</li>
///<li>4: ROL (Role) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class EHC_E20_PSL_ITEM_INFO : AbstractGroup {

	///<summary> 
	/// Creates a new EHC_E20_PSL_ITEM_INFO Group.
	///</summary>
	public EHC_E20_PSL_ITEM_INFO(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating EHC_E20_PSL_ITEM_INFO - this is probably a bug in the source code generator.", e);
	   }
	}
