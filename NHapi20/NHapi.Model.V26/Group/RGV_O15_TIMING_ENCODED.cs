...
{
///<summary>
///Represents the RGV_O15_TIMING_ENCODED Group.  A Group is an ordered collection of message 
...
public class RGV_O15_TIMING_ENCODED : AbstractGroup {
	...
	///</summary>
	public RGV_O15_TIMING_ENCODED(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
