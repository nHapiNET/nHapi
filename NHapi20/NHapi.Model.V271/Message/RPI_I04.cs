...
{
///<summary>
/// Represents a RPI_I04 message structure (see chapter 11.2.4). This structure contains the 
/// following elements:
///<ol>
...
///<li>4: RPI_I04_PROVIDER (a Group object) repeating</li>
///<li>5: PID (Patient Identification) </li>
///<li>6: NK1 (Next of Kin / Associated Parties) optional repeating</li>
///<li>7: RPI_I04_GUARANTOR_INSURANCE (a Group object) optional </li>
...
public class RPI_I04 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RPI_I04.  This does the segment setup for the message. 
	///</summary> 
