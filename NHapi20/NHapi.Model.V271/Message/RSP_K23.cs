...
///<li>7: RSP_K23_QUERY_RESPONSE (a Group object) optional </li>
...
public class RSP_K23 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RSP_K23.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RSP_K23_QUERY_RESPONSE), false, false);
...
get{
	...
	///</summary>
	public RSP_K23_QUERY_RESPONSE QUERY_RESPONSE { 
get{
	   RSP_K23_QUERY_RESPONSE ret = null;
	   try {
	      ret = (RSP_K23_QUERY_RESPONSE)this.GetStructure("QUERY_RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
