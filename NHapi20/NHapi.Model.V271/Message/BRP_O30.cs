...
{
///<summary>
/// Represents a BRP_O30 message structure (see chapter 4.12.4). This structure contains the 
/// following elements:
///<ol>
...
///<li>6: BRP_O30_RESPONSE (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class BRP_O30 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new BRP_O30 Group with custom IModelClassFactory.
	///</summary>
	public BRP_O30(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new BRP_O30 Group with DefaultModelClassFactory. 
	///</summary> 
	public BRP_O30() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for BRP_O30.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(BRP_O30_RESPONSE), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating BRP_O30 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns BRP_O30_RESPONSE (a Group object) - creates it if necessary
	///</summary>
	public BRP_O30_RESPONSE RESPONSE { 
get{
	   BRP_O30_RESPONSE ret = null;
	   try {
	      ret = (BRP_O30_RESPONSE)this.GetStructure("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
