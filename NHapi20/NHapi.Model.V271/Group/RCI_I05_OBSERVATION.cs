...
///<li>2: RCI_I05_RESULTS (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RCI_I05_OBSERVATION : AbstractGroup {
	...
	public RCI_I05_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RCI_I05_RESULTS), false, false);
...
get{
	...
	///<summary>
	/// Returns RCI_I05_RESULTS (a Group object) - creates it if necessary
	///</summary>
	public RCI_I05_RESULTS RESULTS { 
get{
