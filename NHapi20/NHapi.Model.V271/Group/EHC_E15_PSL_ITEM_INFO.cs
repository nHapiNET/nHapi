...
{
///<summary>
///Represents the EHC_E15_PSL_ITEM_INFO Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class EHC_E15_PSL_ITEM_INFO : AbstractGroup {

	///<summary> 
	/// Creates a new EHC_E15_PSL_ITEM_INFO Group.
	///</summary>
	public EHC_E15_PSL_ITEM_INFO(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PSL), true, false);
	      this.add(typeof(ADJ), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating EHC_E15_PSL_ITEM_INFO - this is probably a bug in the source code generator.", e);
	   }
	}
