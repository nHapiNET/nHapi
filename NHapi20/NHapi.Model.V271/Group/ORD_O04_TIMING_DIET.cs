...
{
///<summary>
///Represents the ORD_O04_TIMING_DIET Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORD_O04_TIMING_DIET : AbstractGroup {

	///<summary> 
	/// Creates a new ORD_O04_TIMING_DIET Group.
	///</summary>
	public ORD_O04_TIMING_DIET(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORD_O04_TIMING_DIET - this is probably a bug in the source code generator.", e);
	   }
	}
