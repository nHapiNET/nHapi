...
{
///<summary>
///Represents the OUL_R23_RESULT Group.  A Group is an ordered collection of message 
...
///<li>3: SID (Substance Identifier) optional repeating</li>
///<li>4: NTE (Notes and Comments) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class OUL_R23_RESULT : AbstractGroup {

	///<summary> 
	/// Creates a new OUL_R23_RESULT Group.
	///</summary>
	public OUL_R23_RESULT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OUL_R23_RESULT - this is probably a bug in the source code generator.", e);
	   }
	}
