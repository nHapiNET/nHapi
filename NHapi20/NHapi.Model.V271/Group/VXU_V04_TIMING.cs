...
{
///<summary>
///Represents the VXU_V04_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class VXU_V04_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new VXU_V04_TIMING Group.
	///</summary>
	public VXU_V04_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating VXU_V04_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
