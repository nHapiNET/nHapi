...
{
///<summary>
///Represents the SRR_S01_RESOURCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SRR_S01_RESOURCE : AbstractGroup {

	///<summary> 
	/// Creates a new SRR_S01_RESOURCE Group.
	///</summary>
	public SRR_S01_RESOURCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRR_S01_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
