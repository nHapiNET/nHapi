...
{
///<summary>
///Represents the BRP_O30_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class BRP_O30_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new BRP_O30_TIMING Group.
	///</summary>
	public BRP_O30_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating BRP_O30_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
