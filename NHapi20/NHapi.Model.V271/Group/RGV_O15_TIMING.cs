...
{
///<summary>
///Represents the RGV_O15_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RGV_O15_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RGV_O15_TIMING Group.
	///</summary>
	public RGV_O15_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RGV_O15_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
