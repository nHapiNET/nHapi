...
///<li>4: SRR_S01_RESOURCE (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class SRR_S01_SCHEDULE : AbstractGroup {
	...
	public SRR_S01_SCHEDULE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(SRR_S01_RESOURCE), true, true);
...
get{
	...
	///<summary>
	///Returns a specific repetition of SRR_S01_RESOURCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public SRR_S01_RESOURCE GetRESOURCE(int rep) { 
	   return (SRR_S01_RESOURCE)this.GetStructure("RESOURCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of SRR_S01_RESOURCE 
	 */ 
	public int RESOURCERepetitionsUsed { 
get{
	    int reps = -1; 
	    try { 
	        reps = this.GetAll("RESOURCE").Length; 
	    } catch (HL7Exception e) { 
	        string message = "Unexpected error accessing data - this is probably a bug in the source code generator."; 
	        HapiLogFactory.GetHapiLog(GetType()).Error(message, e); 
	        throw new System.Exception(message);
	...
	/** 
	 * Enumerate over the SRR_S01_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S01_RESOURCE> RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S01_RESOURCE)this.GetStructure("RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S01_RESOURCE
	///</summary>
	public SRR_S01_RESOURCE AddRESOURCE()
	{
		return this.AddStructure("RESOURCE") as SRR_S01_RESOURCE;
	}
	...
	///<summary>
	///Removes the SRR_S01_RESOURCE at the given index
	///</summary>
	public void RemoveRESOURCEAt(int index)
	{
		this.RemoveRepetition("RESOURCE", index);
	}
