...
{
///<summary>
///Represents the RRG_O16_TIMING_GIVE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RRG_O16_TIMING_GIVE : AbstractGroup {

	///<summary> 
	/// Creates a new RRG_O16_TIMING_GIVE Group.
	///</summary>
	public RRG_O16_TIMING_GIVE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RRG_O16_TIMING_GIVE - this is probably a bug in the source code generator.", e);
	   }
	}
