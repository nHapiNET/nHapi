...
{
///<summary>
///Represents the CCQ_I19_PROVIDER_CONTACT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCQ_I19_PROVIDER_CONTACT : AbstractGroup {

	///<summary> 
	/// Creates a new CCQ_I19_PROVIDER_CONTACT Group.
	///</summary>
	public CCQ_I19_PROVIDER_CONTACT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCQ_I19_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
	   }
	}
