...
{
///<summary>
///Represents the CCU_I20_PROVIDER_CONTACT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCU_I20_PROVIDER_CONTACT : AbstractGroup {

	///<summary> 
	/// Creates a new CCU_I20_PROVIDER_CONTACT Group.
	///</summary>
	public CCU_I20_PROVIDER_CONTACT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCU_I20_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
	   }
	}
