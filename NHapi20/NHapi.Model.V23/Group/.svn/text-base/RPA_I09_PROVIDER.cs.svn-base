...
{
///<summary>
///Represents the RPA_I09_PROVIDER Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RPA_I09_PROVIDER : AbstractGroup {

	///<summary> 
	/// Creates a new RPA_I09_PROVIDER Group.
	///</summary>
	public RPA_I09_PROVIDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RPA_I09_PROVIDER - this is probably a bug in the source code generator.", e);
	   }
	}
