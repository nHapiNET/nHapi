...
{
///<summary>
///Represents the CSU_C11_STUDY_OBSERVATION Group.  A Group is an ordered collection of message 
...
public class CSU_C11_STUDY_OBSERVATION : AbstractGroup {
	...
	///</summary>
	public CSU_C11_STUDY_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
