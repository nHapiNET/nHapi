...
{
///<summary>
///Represents the RPA_I09_AUTHORIZATION Group.  A Group is an ordered collection of message 
...
public class RPA_I09_AUTHORIZATION : AbstractGroup {
	...
	///</summary>
	public RPA_I09_AUTHORIZATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
