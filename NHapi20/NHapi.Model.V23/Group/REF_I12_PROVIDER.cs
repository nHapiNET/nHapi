...
{
///<summary>
///Represents the REF_I12_PROVIDER Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class REF_I12_PROVIDER : AbstractGroup {

	///<summary> 
	/// Creates a new REF_I12_PROVIDER Group.
	///</summary>
	public REF_I12_PROVIDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating REF_I12_PROVIDER - this is probably a bug in the source code generator.", e);
	   }
	}
