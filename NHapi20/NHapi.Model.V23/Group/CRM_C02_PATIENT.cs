...
{
///<summary>
///Represents the CRM_C02_PATIENT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CRM_C02_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new CRM_C02_PATIENT Group.
	///</summary>
	public CRM_C02_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CRM_C02_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
