...
{
///<summary>
///Represents the PEX_P08_STUDY Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PEX_P08_STUDY : AbstractGroup {

	///<summary> 
	/// Creates a new PEX_P08_STUDY Group.
	///</summary>
	public PEX_P08_STUDY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(CSR), true, false);
	      this.add(typeof(CSP), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PEX_P08_STUDY - this is probably a bug in the source code generator.", e);
	   }
	}
