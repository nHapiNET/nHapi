...
public class SIU_S23_RESOURCES : AbstractGroup {
	...
	///<summary> 
	/// Creates a new SIU_S23_RESOURCES Group.
	///</summary>
...
get{
	...
	/** 
	 * Returns the number of existing repetitions of SIU_S23_SERVICE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SIU_S23_SERVICE results 
	 */ 
	public IEnumerable<SIU_S23_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SIU_S23_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S23_SERVICE
	///</summary>
	public SIU_S23_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SIU_S23_SERVICE;
	}

	///<summary>
	///Removes the given SIU_S23_SERVICE
	///</summary>
	public void RemoveSERVICE(SIU_S23_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SIU_S23_SERVICE at the given index
	///</summary>
	...
	///<summary>
	/// Returns  first repetition of SIU_S23_GENERAL_RESOURCE (a Group object) - creates it if necessary
	///</summary>
	...
	/** 
	 * Returns the number of existing repetitions of SIU_S23_GENERAL_RESOURCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SIU_S23_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SIU_S23_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SIU_S23_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S23_GENERAL_RESOURCE
	///</summary>
	public SIU_S23_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SIU_S23_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SIU_S23_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SIU_S23_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SIU_S23_GENERAL_RESOURCE at the given index
	///</summary>
	...
	///<summary>
	/// Returns  first repetition of SIU_S23_LOCATION_RESOURCE (a Group object) - creates it if necessary
	///</summary>
	...
	/** 
	 * Returns the number of existing repetitions of SIU_S23_LOCATION_RESOURCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SIU_S23_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SIU_S23_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SIU_S23_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S23_LOCATION_RESOURCE
	///</summary>
	public SIU_S23_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SIU_S23_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SIU_S23_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SIU_S23_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SIU_S23_LOCATION_RESOURCE at the given index
	///</summary>
	...
	///<summary>
	/// Returns  first repetition of SIU_S23_PERSONNEL_RESOURCE (a Group object) - creates it if necessary
	///</summary>
	...
	/** 
	 * Returns the number of existing repetitions of SIU_S23_PERSONNEL_RESOURCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SIU_S23_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SIU_S23_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SIU_S23_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S23_PERSONNEL_RESOURCE
	///</summary>
	public SIU_S23_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SIU_S23_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SIU_S23_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SIU_S23_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SIU_S23_PERSONNEL_RESOURCE at the given index
	///</summary>
