...
public class SRR_S10_RESOURCES : AbstractGroup {
	...
	public SRR_S10_RESOURCES(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(SRR_S10_SERVICE), false, true);
	      this.add(typeof(SRR_S10_GENERAL_RESOURCE), false, true);
	      this.add(typeof(SRR_S10_LOCATION_RESOURCE), false, true);
	      this.add(typeof(SRR_S10_PERSONNEL_RESOURCE), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRR_S10_RESOURCES - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	public SRR_S10_SERVICE GetSERVICE() {
	   ...
	   try {
	      ret = (SRR_S10_SERVICE)this.GetStructure("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the SRR_S10_SERVICE results 
	 */ 
	public IEnumerable<SRR_S10_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SRR_S10_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S10_SERVICE
	///</summary>
	public SRR_S10_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SRR_S10_SERVICE;
	}

	///<summary>
	///Removes the given SRR_S10_SERVICE
	///</summary>
	public void RemoveSERVICE(SRR_S10_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SRR_S10_SERVICE at the given index
	///</summary>
	...
	public SRR_S10_GENERAL_RESOURCE GetGENERAL_RESOURCE() {
	   ...
	   try {
	      ret = (SRR_S10_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the SRR_S10_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S10_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S10_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S10_GENERAL_RESOURCE
	///</summary>
	public SRR_S10_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SRR_S10_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S10_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SRR_S10_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S10_GENERAL_RESOURCE at the given index
	///</summary>
	...
	public SRR_S10_LOCATION_RESOURCE GetLOCATION_RESOURCE() {
	   ...
	   try {
	      ret = (SRR_S10_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the SRR_S10_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S10_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S10_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S10_LOCATION_RESOURCE
	///</summary>
	public SRR_S10_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SRR_S10_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S10_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SRR_S10_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S10_LOCATION_RESOURCE at the given index
	///</summary>
	...
	public SRR_S10_PERSONNEL_RESOURCE GetPERSONNEL_RESOURCE() {
	   ...
	   try {
	      ret = (SRR_S10_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the SRR_S10_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S10_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S10_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S10_PERSONNEL_RESOURCE
	///</summary>
	public SRR_S10_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SRR_S10_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S10_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SRR_S10_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S10_PERSONNEL_RESOURCE at the given index
	///</summary>
