...
{
///<summary>
///Represents the SRM_S06_LOCATION_RESOURCE Group.  A Group is an ordered collection of message 
...
public class SRM_S06_LOCATION_RESOURCE : AbstractGroup {
	...
	///</summary>
	public SRM_S06_LOCATION_RESOURCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
