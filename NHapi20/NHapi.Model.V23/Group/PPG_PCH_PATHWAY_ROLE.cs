...
{
///<summary>
///Represents the PPG_PCH_PATHWAY_ROLE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PPG_PCH_PATHWAY_ROLE : AbstractGroup {

	///<summary> 
	/// Creates a new PPG_PCH_PATHWAY_ROLE Group.
	///</summary>
	public PPG_PCH_PATHWAY_ROLE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PPG_PCH_PATHWAY_ROLE - this is probably a bug in the source code generator.", e);
	   }
	}
