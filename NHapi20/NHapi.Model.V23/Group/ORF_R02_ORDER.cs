...
///<li>3: ORF_R02_OBSERVATION (a Group object) repeating</li>
...
public class ORF_R02_ORDER : AbstractGroup {
	...
	///</summary>
	public ORF_R02_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	/** 
	 * Enumerate over the ORF_R02_OBSERVATION results 
	 */ 
	public IEnumerable<ORF_R02_OBSERVATION> OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (ORF_R02_OBSERVATION)this.GetStructure("OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORF_R02_OBSERVATION
	///</summary>
	public ORF_R02_OBSERVATION AddOBSERVATION()
	{
		return this.AddStructure("OBSERVATION") as ORF_R02_OBSERVATION;
	}

	///<summary>
	///Removes the given ORF_R02_OBSERVATION
	///</summary>
	public void RemoveOBSERVATION(ORF_R02_OBSERVATION toRemove)
	{
		this.RemoveStructure("OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the ORF_R02_OBSERVATION at the given index
	///</summary>
