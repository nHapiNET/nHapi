...
get{
	...
	/** 
	 * Enumerate over the PEX_P08_RX_ADMINISTRATION results 
	 */ 
	public IEnumerable<PEX_P08_RX_ADMINISTRATION> RX_ADMINISTRATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < RX_ADMINISTRATIONRepetitionsUsed; rep++)
			{
				yield return (PEX_P08_RX_ADMINISTRATION)this.GetStructure("RX_ADMINISTRATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PEX_P08_RX_ADMINISTRATION
	///</summary>
	public PEX_P08_RX_ADMINISTRATION AddRX_ADMINISTRATION()
	{
		return this.AddStructure("RX_ADMINISTRATION") as PEX_P08_RX_ADMINISTRATION;
	}

	///<summary>
	///Removes the given PEX_P08_RX_ADMINISTRATION
	///</summary>
	public void RemoveRX_ADMINISTRATION(PEX_P08_RX_ADMINISTRATION toRemove)
	{
		this.RemoveStructure("RX_ADMINISTRATION", toRemove);
	}

	///<summary>
	///Removes the PEX_P08_RX_ADMINISTRATION at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PEX_P08_STUDY results 
	 */ 
	public IEnumerable<PEX_P08_STUDY> STUDYs 
	{ 
		get
		{
			for (int rep = 0; rep < STUDYRepetitionsUsed; rep++)
			{
				yield return (PEX_P08_STUDY)this.GetStructure("STUDY", rep);
			}
		}
	}

	///<summary>
	///Adds a new PEX_P08_STUDY
	///</summary>
	public PEX_P08_STUDY AddSTUDY()
	{
		return this.AddStructure("STUDY") as PEX_P08_STUDY;
	}

	///<summary>
	///Removes the given PEX_P08_STUDY
	///</summary>
	public void RemoveSTUDY(PEX_P08_STUDY toRemove)
	{
		this.RemoveStructure("STUDY", toRemove);
	}

	///<summary>
	///Removes the PEX_P08_STUDY at the given index
	///</summary>
