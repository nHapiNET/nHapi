...
{
///<summary>
///Represents the SRM_S08_PERSONNEL_RESOURCE Group.  A Group is an ordered collection of message 
...
public class SRM_S08_PERSONNEL_RESOURCE : AbstractGroup {
	...
	///</summary>
	public SRM_S08_PERSONNEL_RESOURCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
