...
{
///<summary>
///Represents the RRI_I15_PROVIDER Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RRI_I15_PROVIDER : AbstractGroup {

	///<summary> 
	/// Creates a new RRI_I15_PROVIDER Group.
	///</summary>
	public RRI_I15_PROVIDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RRI_I15_PROVIDER - this is probably a bug in the source code generator.", e);
	   }
	}
