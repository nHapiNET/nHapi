...
{
///<summary>
///Represents the PPP_PCC_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PPP_PCC_ORDER_OBSERVATION : AbstractGroup {

	///<summary> 
	/// Creates a new PPP_PCC_ORDER_OBSERVATION Group.
	///</summary>
	public PPP_PCC_ORDER_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(OBX), true, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PPP_PCC_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
