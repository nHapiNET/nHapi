...
{
///<summary>
///Represents the RGV_O01_ENCODING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RGV_O01_ENCODING : AbstractGroup {

	///<summary> 
	/// Creates a new RGV_O01_ENCODING Group.
	///</summary>
	public RGV_O01_ENCODING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(RXE), true, false);
	      this.add(typeof(RXR), true, true);
	      this.add(typeof(RXC), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RGV_O01_ENCODING - this is probably a bug in the source code generator.", e);
	   }
	}
