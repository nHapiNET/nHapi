...
{
///<summary>
///Represents the SRR_S07_PATIENT Group.  A Group is an ordered collection of message 
...
public class SRR_S07_PATIENT : AbstractGroup {
	...
	///</summary>
	public SRR_S07_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
