...
{
///<summary>
///Represents the PEX_P08_ASSOCIATED_RX_ADMIN Group.  A Group is an ordered collection of message 
...
public class PEX_P08_ASSOCIATED_RX_ADMIN : AbstractGroup {
	...
	///</summary>
	public PEX_P08_ASSOCIATED_RX_ADMIN(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
