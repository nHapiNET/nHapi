...
///<li>3: PGL_PC8_ORDER_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the PGL_PC8_ORDER_OBSERVATION results 
	 */ 
	public IEnumerable<PGL_PC8_ORDER_OBSERVATION> ORDER_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDER_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (PGL_PC8_ORDER_OBSERVATION)this.GetStructure("ORDER_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PGL_PC8_ORDER_OBSERVATION
	///</summary>
	public PGL_PC8_ORDER_OBSERVATION AddORDER_OBSERVATION()
	{
		return this.AddStructure("ORDER_OBSERVATION") as PGL_PC8_ORDER_OBSERVATION;
	}

	///<summary>
	///Removes the given PGL_PC8_ORDER_OBSERVATION
	///</summary>
	public void RemoveORDER_OBSERVATION(PGL_PC8_ORDER_OBSERVATION toRemove)
	{
		this.RemoveStructure("ORDER_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the PGL_PC8_ORDER_OBSERVATION at the given index
	///</summary>
