...
public class SRR_S08_SCHEDULE : AbstractGroup {
	...
	///<summary> 
	/// Creates a new SRR_S08_SCHEDULE Group.
	///</summary>
	public SRR_S08_SCHEDULE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(SCH), true, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(SRR_S08_PATIENT), false, true);
	      this.add(typeof(SRR_S08_RESOURCES), true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRR_S08_SCHEDULE - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	///Returns a specific repetition of SRR_S08_PATIENT
...
get{
	...
	/** 
	 * Enumerate over the SRR_S08_PATIENT results 
	 */ 
	public IEnumerable<SRR_S08_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SRR_S08_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S08_PATIENT
	///</summary>
	public SRR_S08_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SRR_S08_PATIENT;
	}

	///<summary>
	///Removes the given SRR_S08_PATIENT
	///</summary>
	public void RemovePATIENT(SRR_S08_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SRR_S08_PATIENT at the given index
	///</summary>
	...
	///<summary>
	///Returns a specific repetition of SRR_S08_RESOURCES
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRR_S08_RESOURCES results 
	 */ 
	public IEnumerable<SRR_S08_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SRR_S08_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S08_RESOURCES
	///</summary>
	public SRR_S08_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SRR_S08_RESOURCES;
	}

	///<summary>
	///Removes the given SRR_S08_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SRR_S08_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SRR_S08_RESOURCES at the given index
	///</summary>
