...
{
///<summary>
///Represents the RQI_I01_PRDCTD Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RQI_I01_PRDCTD : AbstractGroup {

	///<summary> 
	/// Creates a new RQI_I01_PRDCTD Group.
	///</summary>
	public RQI_I01_PRDCTD(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RQI_I01_PRDCTD - this is probably a bug in the source code generator.", e);
	   }
	}
