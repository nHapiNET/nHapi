...
public class CM2 : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(SI), false, 1, 4, new System.Object[]{message}, "CM2 - Set ID");
       this.add(typeof(CE), true, 1, 60, new System.Object[]{message}, "Scheduled Time Point");
       this.add(typeof(ST), false, 1, 300, new System.Object[]{message}, "Description of Time Point");
       this.add(typeof(CE), true, 200, 60, new System.Object[]{message}, "Events Scheduled This Time Point");
