...
///<li>GOL-8: Expected Goal Achievement Date/Time (TS)</li>
...
public class GOL : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(TS), false, 1, 26, new System.Object[]{message}, "Expected Goal Achievement Date/Time");
	...
	///<summary>
	/// Returns Expected Goal Achievement Date/Time(GOL-8).
	///</summary>
