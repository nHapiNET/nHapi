...
{
///<summary>
/// Represents a RPA_I11 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: MSA (Message acknowledgement segment) </li>
///<li>2: RF1 (Referral Information Segment) optional </li>
///<li>3: RPA_I11_AUTHORIZATION (a Group object) optional </li>
///<li>4: RPA_I11_PROVIDER (a Group object) repeating</li>
///<li>5: PID (Patient Identification) </li>
///<li>6: NK1 (Next of kin) optional repeating</li>
///<li>7: GT1 (Guarantor) optional repeating</li>
///<li>8: RPA_I11_INSURANCE (a Group object) optional repeating</li>
...
///<li>13: RPA_I11_PROCEDURE (a Group object) repeating</li>
///<li>14: RPA_I11_RESULTS (a Group object) optional repeating</li>
///<li>15: RPA_I11_VISIT (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RPA_I11 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RPA_I11 Group with custom IModelClassFactory.
	///</summary>
	public RPA_I11(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for RPA_I11.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RPA_I11_AUTHORIZATION), false, false);
	      this.add(typeof(RPA_I11_PROVIDER), true, true);
	      this.add(typeof(PID), true, false);
	      this.add(typeof(NK1), false, true);
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(RPA_I11_INSURANCE), false, true);
	      this.add(typeof(ACC), false, false);
	      this.add(typeof(DG1), false, true);
	      this.add(typeof(DRG), false, true);
	      this.add(typeof(AL1), false, true);
	      this.add(typeof(RPA_I11_PROCEDURE), true, true);
	      this.add(typeof(RPA_I11_RESULTS), false, true);
	      this.add(typeof(RPA_I11_VISIT), false, false);
...
get{
	   ...
	   try {
	      ret = (RPA_I11_AUTHORIZATION)this.GetStructure("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I11_PROVIDER GetPROVIDER() {
	   ...
	   try {
	      ret = (RPA_I11_PROVIDER)this.GetStructure("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I11_PROVIDER GetPROVIDER(int rep) { 
	   return (RPA_I11_PROVIDER)this.GetStructure("PROVIDER", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RPA_I11_PROVIDER results 
	 */ 
	public IEnumerable<RPA_I11_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RPA_I11_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I11_PROVIDER
	///</summary>
	public RPA_I11_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RPA_I11_PROVIDER;
	}

	///<summary>
	///Removes the given RPA_I11_PROVIDER
	///</summary>
	public void RemovePROVIDER(RPA_I11_PROVIDER toRemove)
	{
		this.RemoveStructure("PROVIDER", toRemove);
	}

	///<summary>
	///Removes the RPA_I11_PROVIDER at the given index
	///</summary>
...
get{
	...
	public RPA_I11_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (RPA_I11_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I11_INSURANCE GetINSURANCE(int rep) { 
	   return (RPA_I11_INSURANCE)this.GetStructure("INSURANCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RPA_I11_INSURANCE results 
	 */ 
	public IEnumerable<RPA_I11_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RPA_I11_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I11_INSURANCE
	///</summary>
	public RPA_I11_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RPA_I11_INSURANCE;
	}

	///<summary>
	///Removes the given RPA_I11_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RPA_I11_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RPA_I11_INSURANCE at the given index
	///</summary>
...
get{
	...
	public RPA_I11_PROCEDURE GetPROCEDURE() {
	   ...
	   try {
	      ret = (RPA_I11_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I11_PROCEDURE GetPROCEDURE(int rep) { 
	   return (RPA_I11_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RPA_I11_PROCEDURE results 
	 */ 
	public IEnumerable<RPA_I11_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (RPA_I11_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I11_PROCEDURE
	///</summary>
	public RPA_I11_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as RPA_I11_PROCEDURE;
	}

	///<summary>
	///Removes the given RPA_I11_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(RPA_I11_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the RPA_I11_PROCEDURE at the given index
	///</summary>
	...
	public RPA_I11_RESULTS GetRESULTS() {
	   ...
	   try {
	      ret = (RPA_I11_RESULTS)this.GetStructure("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I11_RESULTS GetRESULTS(int rep) { 
	   return (RPA_I11_RESULTS)this.GetStructure("RESULTS", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RPA_I11_RESULTS results 
	 */ 
	public IEnumerable<RPA_I11_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (RPA_I11_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I11_RESULTS
	///</summary>
	public RPA_I11_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as RPA_I11_RESULTS;
	}

	///<summary>
	///Removes the given RPA_I11_RESULTS
	///</summary>
	public void RemoveRESULTS(RPA_I11_RESULTS toRemove)
	{
		this.RemoveStructure("RESULTS", toRemove);
	}

	///<summary>
	///Removes the RPA_I11_RESULTS at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RPA_I11_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
