...
{
///<summary>
/// Represents a MFK_M04 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
...
public class MFK_M04 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new MFK_M04 Group with custom IModelClassFactory.
	///</summary>
	public MFK_M04(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new MFK_M04 Group with DefaultModelClassFactory. 
	///</summary> 
	...
	///<summary>
	/// initalize method for MFK_M04.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating MFK_M04 - this is probably a bug in the source code generator.", e);
	   }
	}
