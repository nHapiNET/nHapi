...
get{
	...
	/** 
	 * Enumerate over the PEX_P08_EXPERIENCE results 
	 */ 
	public IEnumerable<PEX_P08_EXPERIENCE> EXPERIENCEs 
	{ 
		get
		{
			for (int rep = 0; rep < EXPERIENCERepetitionsUsed; rep++)
			{
				yield return (PEX_P08_EXPERIENCE)this.GetStructure("EXPERIENCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new PEX_P08_EXPERIENCE
	///</summary>
	public PEX_P08_EXPERIENCE AddEXPERIENCE()
	{
		return this.AddStructure("EXPERIENCE") as PEX_P08_EXPERIENCE;
	}

	///<summary>
	///Removes the given PEX_P08_EXPERIENCE
	///</summary>
	public void RemoveEXPERIENCE(PEX_P08_EXPERIENCE toRemove)
	{
		this.RemoveStructure("EXPERIENCE", toRemove);
	}

	///<summary>
	///Removes the PEX_P08_EXPERIENCE at the given index
	///</summary>
