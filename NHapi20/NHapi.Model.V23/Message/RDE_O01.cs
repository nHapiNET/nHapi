...
///<li>2: RDE_O01_PATIENT (a Group object) optional </li>
///<li>3: RDE_O01_ORDER (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the RDE_O01_ORDER results 
	 */ 
	public IEnumerable<RDE_O01_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (RDE_O01_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDE_O01_ORDER
	///</summary>
	public RDE_O01_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as RDE_O01_ORDER;
	}

	///<summary>
	///Removes the given RDE_O01_ORDER
	///</summary>
	public void RemoveORDER(RDE_O01_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the RDE_O01_ORDER at the given index
	///</summary>
