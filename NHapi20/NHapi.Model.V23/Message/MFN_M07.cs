...
get{
	...
	/** 
	 * Enumerate over the MFN_M07_MF_CLIN_STUDY results 
	 */ 
	public IEnumerable<MFN_M07_MF_CLIN_STUDY> MF_CLIN_STUDYs 
	{ 
		get
		{
			for (int rep = 0; rep < MF_CLIN_STUDYRepetitionsUsed; rep++)
			{
				yield return (MFN_M07_MF_CLIN_STUDY)this.GetStructure("MF_CLIN_STUDY", rep);
			}
		}
	}

	///<summary>
	///Adds a new MFN_M07_MF_CLIN_STUDY
	///</summary>
	public MFN_M07_MF_CLIN_STUDY AddMF_CLIN_STUDY()
	{
		return this.AddStructure("MF_CLIN_STUDY") as MFN_M07_MF_CLIN_STUDY;
	}

	///<summary>
	///Removes the given MFN_M07_MF_CLIN_STUDY
	///</summary>
	public void RemoveMF_CLIN_STUDY(MFN_M07_MF_CLIN_STUDY toRemove)
	{
		this.RemoveStructure("MF_CLIN_STUDY", toRemove);
	}

	///<summary>
	///Removes the MFN_M07_MF_CLIN_STUDY at the given index
	///</summary>
