...
public class RXD : AbstractSegment  {
  ...
  /**
   * Creates a RXD (Pharmacy dispense segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 0, 200, new System.Object[]{message}, "Dispense Notes");
       this.add(typeof(XCN), false, 1, 200, new System.Object[]{message}, "Dispensing Provider");
       ...
       this.add(typeof(CE), false, 1, 60, new System.Object[]{message}, "Actual Strength Unit");
