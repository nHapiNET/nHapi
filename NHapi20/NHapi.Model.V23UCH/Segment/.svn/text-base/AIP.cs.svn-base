...
public class AIP : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(XCN), false, 1, 80, new System.Object[]{message}, "Personnel Resource ID");
       this.add(typeof(CE), true, 1, 60, new System.Object[]{message}, "Resource Role");
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Resource Group (AIP-5).
   ///</summary>
