...
///<li>MRG-1: Prior Patient ID - Internal (CX)</li>
...
public class MRG : AbstractSegment  {
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Prior Patient ID - Internal (MRG-1).
   ///</summary>
  public int PriorPatientIDInternalRepetitionsUsed
{
get{
    try {
