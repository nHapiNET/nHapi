...
///<li>LCH-1: Primary Key Value (PL)</li>
...
public class LCH : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CE), true, 1, 80, new System.Object[]{message}, "Location Characteristic ID");
       this.add(typeof(CE), true, 1, 80, new System.Object[]{message}, "Location Characteristic Value");
	...
	///<summary>
	/// Returns Primary Key Value(LCH-1).
	///</summary>
