...
///<li>3: SIU_S12_VISIT (a Group object) optional </li>
...
///<li>8: SIU_S12_REG_INSURANCE (a Group object) repeating</li>
///<li>9: SIU_S12_VISIT_INSURANCE (a Group object) repeating</li>
...
public class SIU_S12 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(SIU_S12_VISIT), false, false);
	      this.add(typeof(AIS), true, false);
	      this.add(typeof(AIG), true, false);
	      this.add(typeof(AIL), true, false);
	      this.add(typeof(AIP), true, false);
	      this.add(typeof(SIU_S12_REG_INSURANCE), true, true);
	      this.add(typeof(SIU_S12_VISIT_INSURANCE), true, true);
...
get{
	...
	///<summary>
	/// Returns SIU_S12_VISIT (a Group object) - creates it if necessary
	///</summary>
	public SIU_S12_VISIT VISIT { 
get{
	   SIU_S12_VISIT ret = null;
	   try {
	      ret = (SIU_S12_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	///<summary>
	/// Returns  first repetition of SIU_S12_REG_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public SIU_S12_REG_INSURANCE GetREG_INSURANCE() {
	   SIU_S12_REG_INSURANCE ret = null;
	   try {
	      ret = (SIU_S12_REG_INSURANCE)this.GetStructure("REG_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of SIU_S12_REG_INSURANCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public SIU_S12_REG_INSURANCE GetREG_INSURANCE(int rep) { 
	   return (SIU_S12_REG_INSURANCE)this.GetStructure("REG_INSURANCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of SIU_S12_REG_INSURANCE 
	 */ 
...
get{
	...
	///<summary>
	/// Returns  first repetition of SIU_S12_VISIT_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public SIU_S12_VISIT_INSURANCE GetVISIT_INSURANCE() {
	   SIU_S12_VISIT_INSURANCE ret = null;
	   try {
	      ret = (SIU_S12_VISIT_INSURANCE)this.GetStructure("VISIT_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of SIU_S12_VISIT_INSURANCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public SIU_S12_VISIT_INSURANCE GetVISIT_INSURANCE(int rep) { 
	   return (SIU_S12_VISIT_INSURANCE)this.GetStructure("VISIT_INSURANCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of SIU_S12_VISIT_INSURANCE 
	 */ 
