...
///<li>12: ADT_A31_PROCEDURE (a Group object) optional repeating</li>
///<li>13: GT1 (Guarantor) optional repeating</li>
///<li>14: ADT_A31_INSURANCE (a Group object) optional repeating</li>
	///<li>15: ADT_A31_REG_INSURANCE (a Group object) optional repeating</li>
...
public class ADT_A31 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(ADT_A31_PROCEDURE), false, true);
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(ADT_A31_INSURANCE), false, true);
	      this.add(typeof(ADT_A31_REG_INSURANCE), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of ADT_A31_REG_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public ADT_A31_REG_INSURANCE GetREG_INSURANCE() {
	   ADT_A31_REG_INSURANCE ret = null;
	   try {
	      ret = (ADT_A31_REG_INSURANCE)this.GetStructure("REG_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ADT_A31_REG_INSURANCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ADT_A31_REG_INSURANCE GetREG_INSURANCE(int rep) { 
	   return (ADT_A31_REG_INSURANCE)this.GetStructure("REG_INSURANCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A31_REG_INSURANCE 
	 */ 
