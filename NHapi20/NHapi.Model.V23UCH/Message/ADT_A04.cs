...
///<li>15: ADT_A04_REG_INSURANCE (a Group object) repeating</li>
...
public class ADT_A04 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(ADT_A04_REG_INSURANCE), true, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of ADT_A04_REG_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public ADT_A04_REG_INSURANCE GetREG_INSURANCE() {
	   ADT_A04_REG_INSURANCE ret = null;
	   try {
	      ret = (ADT_A04_REG_INSURANCE)this.GetStructure("REG_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ADT_A04_REG_INSURANCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ADT_A04_REG_INSURANCE GetREG_INSURANCE(int rep) { 
	   return (ADT_A04_REG_INSURANCE)this.GetStructure("REG_INSURANCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A04_REG_INSURANCE 
	 */ 
