...
///</summary>
[Serializable]
public class CM_OSD : AbstractType, IComposite{
	private IType[] data;
	...
	///</summary>
	public CM_OSD(IMessage message) : this(message, null){}
...
get{
		try { 
			...
			throw new DataTypeException("Element " + index + " doesn't exist in 11 element CM_OSD composite"); 
		} 
	} 
	} 
	///<summary>
