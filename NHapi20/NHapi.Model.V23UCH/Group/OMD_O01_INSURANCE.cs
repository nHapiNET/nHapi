...
{
///<summary>
///Represents the OMD_O01_INSURANCE Group.  A Group is an ordered collection of message 
...
public class OMD_O01_INSURANCE : AbstractGroup {
	...
	///</summary>
	public OMD_O01_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
