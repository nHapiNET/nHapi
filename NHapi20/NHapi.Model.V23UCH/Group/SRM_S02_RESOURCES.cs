...
{
///<summary>
///Represents the SRM_S02_RESOURCES Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: RGS (Resource Group) </li>
///<li>1: SRM_S02_SERVICE (a Group object) optional repeating</li>
///<li>2: SRM_S02_GENERAL_RESOURCE (a Group object) optional repeating</li>
///<li>3: SRM_S02_LOCATION_RESOURCE (a Group object) optional repeating</li>
///<li>4: SRM_S02_PERSONNEL_RESOURCE (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class SRM_S02_RESOURCES : AbstractGroup {
	...
	///</summary>
	public SRM_S02_RESOURCES(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	public SRM_S02_SERVICE GetSERVICE() {
	   ...
	   try {
	      ret = (SRM_S02_SERVICE)this.GetStructure("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S02_SERVICE GetSERVICE(int rep) { 
	   return (SRM_S02_SERVICE)this.GetStructure("SERVICE", rep);
	}
...
get{
	...
	public SRM_S02_GENERAL_RESOURCE GetGENERAL_RESOURCE() {
	   ...
	   try {
	      ret = (SRM_S02_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S02_GENERAL_RESOURCE GetGENERAL_RESOURCE(int rep) { 
	   return (SRM_S02_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
	}
...
get{
	...
	public SRM_S02_LOCATION_RESOURCE GetLOCATION_RESOURCE() {
	   ...
	   try {
	      ret = (SRM_S02_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S02_LOCATION_RESOURCE GetLOCATION_RESOURCE(int rep) { 
	   return (SRM_S02_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
	}
...
get{
	...
	public SRM_S02_PERSONNEL_RESOURCE GetPERSONNEL_RESOURCE() {
	   ...
	   try {
	      ret = (SRM_S02_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S02_PERSONNEL_RESOURCE GetPERSONNEL_RESOURCE(int rep) { 
	   return (SRM_S02_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
	}
