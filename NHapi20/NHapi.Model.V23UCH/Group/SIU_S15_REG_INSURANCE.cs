...
{
///<summary>
///Represents the SIU_S15_REG_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SIU_S15_REG_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new SIU_S15_REG_INSURANCE Group.
	///</summary>
	public SIU_S15_REG_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(IN1), true, false);
	      this.add(typeof(IN2), true, false);
	      this.add(typeof(IN3), true, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SIU_S15_REG_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
