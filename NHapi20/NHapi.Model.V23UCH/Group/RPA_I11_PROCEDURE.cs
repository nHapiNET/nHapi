...
{
///<summary>
///Represents the RPA_I11_PROCEDURE Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: PR1 (Procedures) </li>
///<li>1: RPA_I11_AUTHORIZATION (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RPA_I11_PROCEDURE : AbstractGroup {
	...
	///</summary>
	public RPA_I11_PROCEDURE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
