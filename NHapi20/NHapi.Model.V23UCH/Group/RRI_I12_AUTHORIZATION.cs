...
{
///<summary>
///Represents the RRI_I12_AUTHORIZATION Group.  A Group is an ordered collection of message 
...
public class RRI_I12_AUTHORIZATION : AbstractGroup {
	...
	///</summary>
	public RRI_I12_AUTHORIZATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
