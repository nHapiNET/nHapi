...
{
///<summary>
///Represents the RRE_O01_ENCODING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RRE_O01_ENCODING : AbstractGroup {

	///<summary> 
	/// Creates a new RRE_O01_ENCODING Group.
	///</summary>
	public RRE_O01_ENCODING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(RXE), true, false);
	      this.add(typeof(RXR), true, true);
	      this.add(typeof(RXC), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RRE_O01_ENCODING - this is probably a bug in the source code generator.", e);
	   }
	}
