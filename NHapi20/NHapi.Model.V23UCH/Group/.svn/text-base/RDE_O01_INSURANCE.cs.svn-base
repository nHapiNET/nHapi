...
{
///<summary>
///Represents the RDE_O01_INSURANCE Group.  A Group is an ordered collection of message 
...
public class RDE_O01_INSURANCE : AbstractGroup {
	...
	///</summary>
	public RDE_O01_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
