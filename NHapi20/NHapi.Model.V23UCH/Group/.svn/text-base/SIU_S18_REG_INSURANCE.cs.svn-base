...
{
///<summary>
///Represents the SIU_S18_REG_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SIU_S18_REG_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new SIU_S18_REG_INSURANCE Group.
	///</summary>
	public SIU_S18_REG_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ZN1), true, false);
	      this.add(typeof(ZN2), false, false);
	      this.add(typeof(ZN3), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SIU_S18_REG_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
