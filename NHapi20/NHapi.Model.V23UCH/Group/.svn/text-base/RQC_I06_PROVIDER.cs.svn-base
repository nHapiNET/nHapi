...
{
///<summary>
///Represents the RQC_I06_PROVIDER Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RQC_I06_PROVIDER : AbstractGroup {

	///<summary> 
	/// Creates a new RQC_I06_PROVIDER Group.
	///</summary>
	public RQC_I06_PROVIDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RQC_I06_PROVIDER - this is probably a bug in the source code generator.", e);
	   }
	}
