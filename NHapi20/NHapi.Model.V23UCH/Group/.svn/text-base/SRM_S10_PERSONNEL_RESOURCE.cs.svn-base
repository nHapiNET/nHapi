...
{
///<summary>
///Represents the SRM_S10_PERSONNEL_RESOURCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SRM_S10_PERSONNEL_RESOURCE : AbstractGroup {

	///<summary> 
	/// Creates a new SRM_S10_PERSONNEL_RESOURCE Group.
	///</summary>
	public SRM_S10_PERSONNEL_RESOURCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(AIP), true, false);
	      this.add(typeof(APR), false, false);
	      this.add(typeof(NTE), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRM_S10_PERSONNEL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
