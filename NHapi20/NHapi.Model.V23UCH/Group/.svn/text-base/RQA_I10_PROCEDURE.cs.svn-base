...
{
///<summary>
///Represents the RQA_I10_PROCEDURE Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: PR1 (Procedures) </li>
///<li>1: RQA_I10_AUTHORIZATION (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RQA_I10_PROCEDURE : AbstractGroup {
	...
	///</summary>
	public RQA_I10_PROCEDURE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
