...
{
///<summary>
///Represents the ORU_R01_RESPONSE Group.  A Group is an ordered collection of message 
...
public class ORU_R01_RESPONSE : AbstractGroup {
	...
	///</summary>
	public ORU_R01_RESPONSE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
