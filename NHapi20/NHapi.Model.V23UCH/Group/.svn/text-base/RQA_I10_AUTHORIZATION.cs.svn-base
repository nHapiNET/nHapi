...
public class RQA_I10_AUTHORIZATION : AbstractGroup {
	...
	///<summary> 
	/// Creates a new RQA_I10_AUTHORIZATION Group.
	///</summary>
	public RQA_I10_AUTHORIZATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(AUT), true, false);
	      this.add(typeof(CTD), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RQA_I10_AUTHORIZATION - this is probably a bug in the source code generator.", e);
	   }
	}
