...
{
///<summary>
///Represents the SIU_S17_REG_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SIU_S17_REG_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new SIU_S17_REG_INSURANCE Group.
	///</summary>
