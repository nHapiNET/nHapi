...
///<li>11: ARD_A19_PROCEDURE (a Group object) optional repeating</li>
///<li>12: GT1 (Guarantor) optional repeating</li>
///<li>13: ARD_A19_INSURANCE (a Group object) optional repeating</li>
///<li>14: ACC (Accident) optional </li>
///<li>15: UB1 (UB82  data) optional </li>
///<li>16: UB2 (UB92 data) optional </li>
///</ol>
///</summary>
[Serializable]
public class ARD_A19_QUERY_RESPONSE : AbstractGroup {
	...
	public ARD_A19_QUERY_RESPONSE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(ARD_A19_PROCEDURE), false, true);
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(ARD_A19_INSURANCE), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of ARD_A19_PROCEDURE (a Group object) - creates it if necessary
	///</summary>
	public ARD_A19_PROCEDURE GetPROCEDURE() {
	   ARD_A19_PROCEDURE ret = null;
	   try {
	      ret = (ARD_A19_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ARD_A19_PROCEDURE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ARD_A19_PROCEDURE GetPROCEDURE(int rep) { 
	   return (ARD_A19_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ARD_A19_PROCEDURE 
	 */ 
...
get{
	...
	public ARD_A19_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (ARD_A19_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
