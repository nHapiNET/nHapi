...
///<li>5: CON (Consent Segment) optional repeating</li>
...
///<li>12: CON (Consent Segment) optional repeating</li>
///<li>13: NTE (Notes and Comments) optional repeating</li>
///<li>14: FT1 (Financial Transaction) optional repeating</li>
///<li>15: DG1 (Diagnosis) optional repeating</li>
///<li>16: PR1 (Procedures) optional repeating</li>
///<li>17: GT1 (Guarantor) optional </li>
///<li>18: ADT_A01_INSURANCE (a Group object) optional repeating</li>
...
get{
	...
	///<summary>
	/// Returns  first repetition of CON2 (Consent Segment) - creates it if necessary
	///</summary>
	public CON GetCON2() {
	   CON ret = null;
	   try {
	      ret = (CON)this.GetStructure("CON2");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of CON2
	/// * (Consent Segment) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public CON GetCON2(int rep) { 
	   return (CON)this.GetStructure("CON2", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CON2 
	 */ 
	public int CON2RepetitionsUsed { 
get{
	    int reps = -1; 
	    try { 
	        reps = this.GetAll("CON2").Length; 
	    } catch (HL7Exception e) { 
	        string message = "Unexpected error accessing data - this is probably a bug in the source code generator."; 
	        HapiLogFactory.GetHapiLog(GetType()).Error(message, e); 
	        throw new System.Exception(message);
