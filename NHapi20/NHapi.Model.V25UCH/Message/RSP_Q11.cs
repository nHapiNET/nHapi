...
{
///<summary>
/// Represents a RSP_Q11 message structure (see chapter 8.4.5.1). This structure contains the 
/// following elements:
///<ol>
...
///<li>6: RSP_Q11_QUERY_RESULT_CLUSTER (a Group object) optional </li>
...
public class RSP_Q11 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RSP_Q11 Group with custom IModelClassFactory.
	///</summary>
	public RSP_Q11(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new RSP_Q11 Group with DefaultModelClassFactory. 
	///</summary> 
	...
	///<summary>
	/// initalize method for RSP_Q11.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RSP_Q11 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns RSP_Q11_QUERY_RESULT_CLUSTER (a Group object) - creates it if necessary
	///</summary>
	public RSP_Q11_QUERY_RESULT_CLUSTER QUERY_RESULT_CLUSTER { 
get{
	   RSP_Q11_QUERY_RESULT_CLUSTER ret = null;
	   try {
	      ret = (RSP_Q11_QUERY_RESULT_CLUSTER)this.GetStructure("QUERY_RESULT_CLUSTER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
