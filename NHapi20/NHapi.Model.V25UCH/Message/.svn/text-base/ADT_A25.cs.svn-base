...
{
///<summary>
/// Represents a ADT_A25 message structure (see chapter 3.3.21). This structure contains the 
/// following elements:
///<ol>
...
public class ADT_A25 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for ADT_A25.  This does the segment setup for the message. 
	///</summary> 
