...
{
///<summary>
///Represents the OML_O35_TIIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OML_O35_TIIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OML_O35_TIIMING Group.
	///</summary>
	public OML_O35_TIIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OML_O35_TIIMING - this is probably a bug in the source code generator.", e);
	   }
	}
