...
{
///<summary>
///Represents the RRA_O18_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RRA_O18_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RRA_O18_TIMING Group.
	///</summary>
	public RRA_O18_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RRA_O18_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
