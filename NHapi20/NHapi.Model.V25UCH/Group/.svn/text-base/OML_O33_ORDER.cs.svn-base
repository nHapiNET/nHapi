...
///<li>1: OML_O33_TIIMING (a Group object) optional repeating</li>
...
public class OML_O33_ORDER : AbstractGroup {
	...
	public OML_O33_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O33_TIIMING), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of OML_O33_TIIMING (a Group object) - creates it if necessary
	///</summary>
	public OML_O33_TIIMING GetTIIMING() {
	   OML_O33_TIIMING ret = null;
	   try {
	      ret = (OML_O33_TIIMING)this.GetStructure("TIIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of OML_O33_TIIMING
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OML_O33_TIIMING GetTIIMING(int rep) { 
	   return (OML_O33_TIIMING)this.GetStructure("TIIMING", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OML_O33_TIIMING 
	 */ 
