...
{
///<summary>
///Represents the DFT_P03_TIMING_QUANTITY Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class DFT_P03_TIMING_QUANTITY : AbstractGroup {

	///<summary> 
	/// Creates a new DFT_P03_TIMING_QUANTITY Group.
	///</summary>
	public DFT_P03_TIMING_QUANTITY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating DFT_P03_TIMING_QUANTITY - this is probably a bug in the source code generator.", e);
	   }
	}
