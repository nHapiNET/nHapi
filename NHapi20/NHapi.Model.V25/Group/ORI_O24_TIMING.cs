...
{
///<summary>
///Represents the ORI_O24_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORI_O24_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORI_O24_TIMING Group.
	///</summary>
	public ORI_O24_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORI_O24_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
