...
{
///<summary>
///Represents the RAS_O17_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RAS_O17_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RAS_O17_TIMING Group.
	///</summary>
	public RAS_O17_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RAS_O17_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
