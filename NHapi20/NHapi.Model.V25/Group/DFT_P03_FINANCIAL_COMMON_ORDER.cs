...
///<li>1: DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) optional repeating</li>
///<li>2: DFT_P03_FINANCIAL_ORDER (a Group object) optional </li>
///<li>3: DFT_P03_FINANCIAL_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class DFT_P03_FINANCIAL_COMMON_ORDER : AbstractGroup {
	...
	public DFT_P03_FINANCIAL_COMMON_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(DFT_P03_FINANCIAL_TIMING_QUANTITY), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) - creates it if necessary
	///</summary>
	public DFT_P03_FINANCIAL_TIMING_QUANTITY GetFINANCIAL_TIMING_QUANTITY() {
	   DFT_P03_FINANCIAL_TIMING_QUANTITY ret = null;
	   try {
	      ret = (DFT_P03_FINANCIAL_TIMING_QUANTITY)this.GetStructure("FINANCIAL_TIMING_QUANTITY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public DFT_P03_FINANCIAL_TIMING_QUANTITY GetFINANCIAL_TIMING_QUANTITY(int rep) { 
	   return (DFT_P03_FINANCIAL_TIMING_QUANTITY)this.GetStructure("FINANCIAL_TIMING_QUANTITY", rep);
	}

	/** 
	 * Returns the number of existing repetitions of DFT_P03_FINANCIAL_TIMING_QUANTITY 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the DFT_P03_FINANCIAL_TIMING_QUANTITY results 
	 */ 
	public IEnumerable<DFT_P03_FINANCIAL_TIMING_QUANTITY> FINANCIAL_TIMING_QUANTITYs 
	{ 
		get
		{
			for (int rep = 0; rep < FINANCIAL_TIMING_QUANTITYRepetitionsUsed; rep++)
			{
				yield return (DFT_P03_FINANCIAL_TIMING_QUANTITY)this.GetStructure("FINANCIAL_TIMING_QUANTITY", rep);
			}
		}
	}

	///<summary>
	///Adds a new DFT_P03_FINANCIAL_TIMING_QUANTITY
	///</summary>
	public DFT_P03_FINANCIAL_TIMING_QUANTITY AddFINANCIAL_TIMING_QUANTITY()
	{
		return this.AddStructure("FINANCIAL_TIMING_QUANTITY") as DFT_P03_FINANCIAL_TIMING_QUANTITY;
	}

	///<summary>
	///Removes the given DFT_P03_FINANCIAL_TIMING_QUANTITY
	///</summary>
	public void RemoveFINANCIAL_TIMING_QUANTITY(DFT_P03_FINANCIAL_TIMING_QUANTITY toRemove)
	{
		this.RemoveStructure("FINANCIAL_TIMING_QUANTITY", toRemove);
	}

	///<summary>
	///Removes the DFT_P03_FINANCIAL_TIMING_QUANTITY at the given index
	///</summary>
