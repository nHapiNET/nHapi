...
{
///<summary>
///Represents the OUL_R24_CONTAINER Group.  A Group is an ordered collection of message 
...
public class OUL_R24_CONTAINER : AbstractGroup {
	...
	///</summary>
	public OUL_R24_CONTAINER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
