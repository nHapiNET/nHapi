...
{
///<summary>
///Represents the RRD_O14_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RRD_O14_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RRD_O14_TIMING Group.
	///</summary>
	public RRD_O14_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RRD_O14_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
