...
///<li>4: PRR_PC5_ORDER_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PRR_PC5_ORDER_DETAIL : AbstractGroup {
	...
	public PRR_PC5_ORDER_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PRR_PC5_ORDER_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PRR_PC5_ORDER_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PRR_PC5_ORDER_OBSERVATION ORDER_OBSERVATION { 
get{
