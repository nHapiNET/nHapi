...
///<li>3: OUL_R23_TQ1TQ2 (a Group object) </li>
///<li>4: OUL_R23_OBXTCDSIDNTE (a Group object) </li>
...
public class OUL_R23_ORDER : AbstractGroup {
	...
	public OUL_R23_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OUL_R23_TQ1TQ2), true, false);
	      this.add(typeof(OUL_R23_OBXTCDSIDNTE), true, false);
...
get{
	...
	///<summary>
	/// Returns OUL_R23_TQ1TQ2 (a Group object) - creates it if necessary
	///</summary>
	public OUL_R23_TQ1TQ2 TQ1TQ2 { 
get{
	   OUL_R23_TQ1TQ2 ret = null;
	   try {
	      ret = (OUL_R23_TQ1TQ2)this.GetStructure("TQ1TQ2");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	/// Returns OUL_R23_OBXTCDSIDNTE (a Group object) - creates it if necessary
	///</summary>
	public OUL_R23_OBXTCDSIDNTE OBXTCDSIDNTE { 
get{
	   OUL_R23_OBXTCDSIDNTE ret = null;
	   try {
	      ret = (OUL_R23_OBXTCDSIDNTE)this.GetStructure("OBXTCDSIDNTE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
