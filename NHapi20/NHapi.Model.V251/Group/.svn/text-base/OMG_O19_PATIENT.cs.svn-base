...
///<li>5: OMG_O19_INSURANCE (a Group object) </li>
...
public class OMG_O19_PATIENT : AbstractGroup {
	...
	public OMG_O19_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMG_O19_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns OMG_O19_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OMG_O19_INSURANCE INSURANCE { 
get{
