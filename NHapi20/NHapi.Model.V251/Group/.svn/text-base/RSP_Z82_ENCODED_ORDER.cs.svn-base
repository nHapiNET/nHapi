...
///<li>1: RSP_Z82_TIMING_ENCODED (a Group object) </li>
...
public class RSP_Z82_ENCODED_ORDER : AbstractGroup {
	...
	public RSP_Z82_ENCODED_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RSP_Z82_TIMING_ENCODED), true, false);
...
get{
	...
	///<summary>
	/// Returns RSP_Z82_TIMING_ENCODED (a Group object) - creates it if necessary
	///</summary>
	public RSP_Z82_TIMING_ENCODED TIMING_ENCODED { 
get{
