...
///<li>3: PTR_PCF_GOAL_ROLE (a Group object) </li>
///<li>4: PTR_PCF_GOAL_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PTR_PCF_GOAL : AbstractGroup {
	...
	public PTR_PCF_GOAL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PTR_PCF_GOAL_ROLE), true, false);
	      this.add(typeof(PTR_PCF_GOAL_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PTR_PCF_GOAL_ROLE (a Group object) - creates it if necessary
	///</summary>
	public PTR_PCF_GOAL_ROLE GOAL_ROLE { 
get{
	...
	///<summary>
	/// Returns PTR_PCF_GOAL_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PTR_PCF_GOAL_OBSERVATION GOAL_OBSERVATION { 
get{
