...
///<li>3: PPG_PCG_PROBLEM_ROLE (a Group object) </li>
///<li>4: PPG_PCG_PROBLEM_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PPG_PCG_PROBLEM : AbstractGroup {
	...
	public PPG_PCG_PROBLEM(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PPG_PCG_PROBLEM_ROLE), true, false);
	      this.add(typeof(PPG_PCG_PROBLEM_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PPG_PCG_PROBLEM_ROLE (a Group object) - creates it if necessary
	///</summary>
	public PPG_PCG_PROBLEM_ROLE PROBLEM_ROLE { 
get{
	...
	///<summary>
	/// Returns PPG_PCG_PROBLEM_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PPG_PCG_PROBLEM_OBSERVATION PROBLEM_OBSERVATION { 
get{
