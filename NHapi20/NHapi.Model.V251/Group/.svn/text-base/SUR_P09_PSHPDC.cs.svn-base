...
{
///<summary>
///Represents the SUR_P09_PSHPDC Group.  A Group is an ordered collection of message 
...
public class SUR_P09_PSHPDC : AbstractGroup {
	...
	///<summary> 
	/// Creates a new SUR_P09_PSHPDC Group.
	///</summary>
	public SUR_P09_PSHPDC(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PSH), true, false);
	      this.add(typeof(PDC), true, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SUR_P09_PSHPDC - this is probably a bug in the source code generator.", e);
	   }
	}
