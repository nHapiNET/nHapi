...
///<li>4: OMB_O27_INSURANCE (a Group object) </li>
...
public class OMB_O27_PATIENT : AbstractGroup {
	...
	public OMB_O27_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMB_O27_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns OMB_O27_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OMB_O27_INSURANCE INSURANCE { 
get{
