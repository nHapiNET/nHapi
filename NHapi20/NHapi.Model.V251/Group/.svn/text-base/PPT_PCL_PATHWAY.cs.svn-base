...
///<li>3: PPT_PCL_PATHWAY_ROLE (a Group object) </li>
///<li>4: PPT_PCL_GOAL (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PPT_PCL_PATHWAY : AbstractGroup {
	...
	public PPT_PCL_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PPT_PCL_PATHWAY_ROLE), true, false);
	      this.add(typeof(PPT_PCL_GOAL), true, false);
