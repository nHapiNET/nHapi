...
{
///<summary>
///Represents the RSP_K31_TIMING_ENCODED Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RSP_K31_TIMING_ENCODED : AbstractGroup {

	///<summary> 
	/// Creates a new RSP_K31_TIMING_ENCODED Group.
	///</summary>
	public RSP_K31_TIMING_ENCODED(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RSP_K31_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
	   }
	}
