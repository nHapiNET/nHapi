...
///<li>1: RSP_Z88_TIMING (a Group object) </li>
...
public class RSP_Z88_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z88_COMMON_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RSP_Z88_TIMING), true, false);
...
get{
	...
	///<summary>
	/// Returns RSP_Z88_TIMING (a Group object) - creates it if necessary
	///</summary>
	public RSP_Z88_TIMING TIMING { 
get{
