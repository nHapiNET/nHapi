...
{
///<summary>
///Represents the OUL_R24_OBXTCDSIDNTE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OUL_R24_OBXTCDSIDNTE : AbstractGroup {

	///<summary> 
	/// Creates a new OUL_R24_OBXTCDSIDNTE Group.
	///</summary>
	public OUL_R24_OBXTCDSIDNTE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OUL_R24_OBXTCDSIDNTE - this is probably a bug in the source code generator.", e);
	   }
	}
