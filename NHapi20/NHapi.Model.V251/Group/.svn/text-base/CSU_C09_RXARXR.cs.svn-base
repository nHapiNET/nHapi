...
{
///<summary>
///Represents the CSU_C09_RXARXR Group.  A Group is an ordered collection of message 
...
public class CSU_C09_RXARXR : AbstractGroup {
	...
	///</summary>
	public CSU_C09_RXARXR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(RXA), true, false);
	      this.add(typeof(RXR), true, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CSU_C09_RXARXR - this is probably a bug in the source code generator.", e);
	   }
	}
