...
public class DFT_P03_FINANCIAL_COMMON_ORDER : AbstractGroup {
	...
	public DFT_P03_FINANCIAL_COMMON_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(DFT_P03_FINANCIAL_TIMING_QUANTITY), true, false);
	      this.add(typeof(DFT_P03_FINANCIAL_ORDER), false, false);
	      this.add(typeof(DFT_P03_FINANCIAL_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) - creates it if necessary
	///</summary>
   public DFT_P03_FINANCIAL_TIMING_QUANTITY FINANCIAL_TIMING_QUANTITY
   { 
get{
...
get{
	...
	///<summary>
	/// Returns DFT_P03_FINANCIAL_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public DFT_P03_FINANCIAL_OBSERVATION FINANCIAL_OBSERVATION { 
get{
