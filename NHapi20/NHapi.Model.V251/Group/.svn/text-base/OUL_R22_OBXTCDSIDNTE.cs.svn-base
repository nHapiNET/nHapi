...
{
///<summary>
///Represents the OUL_R22_OBXTCDSIDNTE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OUL_R22_OBXTCDSIDNTE : AbstractGroup {

	///<summary> 
	/// Creates a new OUL_R22_OBXTCDSIDNTE Group.
	///</summary>
	public OUL_R22_OBXTCDSIDNTE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OUL_R22_OBXTCDSIDNTE - this is probably a bug in the source code generator.", e);
	   }
	}
