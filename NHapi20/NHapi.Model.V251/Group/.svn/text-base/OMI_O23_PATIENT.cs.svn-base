...
///<li>4: OMI_O23_INSURANCE (a Group object) </li>
...
public class OMI_O23_PATIENT : AbstractGroup {
	...
	public OMI_O23_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMI_O23_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns OMI_O23_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OMI_O23_INSURANCE INSURANCE { 
get{
