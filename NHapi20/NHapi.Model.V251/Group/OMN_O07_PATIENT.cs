...
///<li>4: OMN_O07_INSURANCE (a Group object) </li>
...
public class OMN_O07_PATIENT : AbstractGroup {
	...
	public OMN_O07_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMN_O07_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns OMN_O07_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OMN_O07_INSURANCE INSURANCE { 
get{
