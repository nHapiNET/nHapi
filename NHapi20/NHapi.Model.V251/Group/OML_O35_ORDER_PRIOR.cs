...
///<li>3: OML_O35_TIMING_PRIOR (a Group object) </li>
...
public class OML_O35_ORDER_PRIOR : AbstractGroup {
	...
	public OML_O35_ORDER_PRIOR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O35_TIMING_PRIOR), true, false);
...
get{
	...
	///<summary>
	/// Returns OML_O35_TIMING_PRIOR (a Group object) - creates it if necessary
	///</summary>
	public OML_O35_TIMING_PRIOR TIMING_PRIOR { 
get{
