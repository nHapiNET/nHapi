...
{
///<summary>
///Represents the ORS_O06_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORS_O06_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORS_O06_TIMING Group.
	///</summary>
	public ORS_O06_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORS_O06_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
