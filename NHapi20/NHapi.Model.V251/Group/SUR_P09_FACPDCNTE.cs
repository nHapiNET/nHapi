...
{
///<summary>
///Represents the SUR_P09_FACPDCNTE Group.  A Group is an ordered collection of message 
...
public class SUR_P09_FACPDCNTE : AbstractGroup {
	...
	///</summary>
	public SUR_P09_FACPDCNTE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(FAC), true, false);
	      this.add(typeof(PDC), true, false);
	      this.add(typeof(NTE), true, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SUR_P09_FACPDCNTE - this is probably a bug in the source code generator.", e);
	   }
	}
