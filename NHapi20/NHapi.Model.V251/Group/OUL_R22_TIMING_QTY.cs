...
{
///<summary>
///Represents the OUL_R22_TIMING_QTY Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OUL_R22_TIMING_QTY : AbstractGroup {

	///<summary> 
	/// Creates a new OUL_R22_TIMING_QTY Group.
	///</summary>
	public OUL_R22_TIMING_QTY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OUL_R22_TIMING_QTY - this is probably a bug in the source code generator.", e);
	   }
	}
