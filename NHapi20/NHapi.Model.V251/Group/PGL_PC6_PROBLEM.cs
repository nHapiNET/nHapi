...
///<li>3: PGL_PC6_PROBLEM_ROLE (a Group object) </li>
///<li>4: PGL_PC6_PROBLEM_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PGL_PC6_PROBLEM : AbstractGroup {
	...
	public PGL_PC6_PROBLEM(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PGL_PC6_PROBLEM_ROLE), true, false);
	      this.add(typeof(PGL_PC6_PROBLEM_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PGL_PC6_PROBLEM_ROLE (a Group object) - creates it if necessary
	///</summary>
	public PGL_PC6_PROBLEM_ROLE PROBLEM_ROLE { 
get{
	...
	///<summary>
	/// Returns PGL_PC6_PROBLEM_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PGL_PC6_PROBLEM_OBSERVATION PROBLEM_OBSERVATION { 
get{
