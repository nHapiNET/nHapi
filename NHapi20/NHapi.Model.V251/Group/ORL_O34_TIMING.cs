...
{
///<summary>
///Represents the ORL_O34_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORL_O34_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORL_O34_TIMING Group.
	///</summary>
	public ORL_O34_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORL_O34_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
