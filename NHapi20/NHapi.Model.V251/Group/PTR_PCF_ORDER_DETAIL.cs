...
///<li>3: PTR_PCF_ORDER_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PTR_PCF_ORDER_DETAIL : AbstractGroup {
	...
	public PTR_PCF_ORDER_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PTR_PCF_ORDER_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PTR_PCF_ORDER_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PTR_PCF_ORDER_OBSERVATION ORDER_OBSERVATION { 
get{
