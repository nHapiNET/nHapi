...
///<li>4: OML_O21_PATIENT_VISIT (a Group object) optional </li>
///<li>5: OML_O21_INSURANCE (a Group object) </li>
...
public class OML_O21_PATIENT : AbstractGroup {
	...
	public OML_O21_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O21_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns OML_O21_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OML_O21_INSURANCE INSURANCE { 
get{
