...
{
///<summary>
///Represents the RSP_K31_ORDER_DETAIL Group.  A Group is an ordered collection of message 
...
///<li>3: RSP_K31_COMPONENTS (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class RSP_K31_ORDER_DETAIL : AbstractGroup {
	...
	public RSP_K31_ORDER_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RSP_K31_COMPONENTS), true, false);
...
get{
	...
	///<summary>
	/// Returns RSP_K31_COMPONENTS (a Group object) - creates it if necessary
	///</summary>
	public RSP_K31_COMPONENTS COMPONENTS { 
get{
	   RSP_K31_COMPONENTS ret = null;
	   try {
	      ret = (RSP_K31_COMPONENTS)this.GetStructure("COMPONENTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
