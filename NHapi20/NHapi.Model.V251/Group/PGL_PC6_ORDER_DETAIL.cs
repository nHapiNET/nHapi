...
///<li>3: PGL_PC6_ORDER_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PGL_PC6_ORDER_DETAIL : AbstractGroup {
	...
	public PGL_PC6_ORDER_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PGL_PC6_ORDER_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PGL_PC6_ORDER_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PGL_PC6_ORDER_OBSERVATION ORDER_OBSERVATION { 
get{
