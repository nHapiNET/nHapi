...
///<li>4: OMP_O09_INSURANCE (a Group object) </li>
...
public class OMP_O09_PATIENT : AbstractGroup {
	...
	public OMP_O09_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMP_O09_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns OMP_O09_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OMP_O09_INSURANCE INSURANCE { 
get{
