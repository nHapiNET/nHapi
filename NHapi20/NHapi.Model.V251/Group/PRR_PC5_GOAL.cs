...
///<li>3: PRR_PC5_GOAL_ROLE (a Group object) </li>
///<li>4: PRR_PC5_GOAL_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PRR_PC5_GOAL : AbstractGroup {
	...
	public PRR_PC5_GOAL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PRR_PC5_GOAL_ROLE), true, false);
	      this.add(typeof(PRR_PC5_GOAL_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PRR_PC5_GOAL_ROLE (a Group object) - creates it if necessary
	///</summary>
	public PRR_PC5_GOAL_ROLE GOAL_ROLE { 
get{
	...
	///<summary>
	/// Returns PRR_PC5_GOAL_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PRR_PC5_GOAL_OBSERVATION GOAL_OBSERVATION { 
get{
