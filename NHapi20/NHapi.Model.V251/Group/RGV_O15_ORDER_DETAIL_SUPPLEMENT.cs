...
///<li>2: RGV_O15_COMPONENTS (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class RGV_O15_ORDER_DETAIL_SUPPLEMENT : AbstractGroup {
	...
	public RGV_O15_ORDER_DETAIL_SUPPLEMENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RGV_O15_COMPONENTS), false, true);
...
get{
	...
	///     greater than the number of existing repetitions.
	///</summary>
	public RGV_O15_COMPONENTS GetCOMPONENTS(int rep) { 
	   return (RGV_O15_COMPONENTS)this.GetStructure("COMPONENTS", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RGV_O15_COMPONENTS results 
	 */ 
	public IEnumerable<RGV_O15_COMPONENTS> COMPONENTSs 
	{ 
		get
		{
			for (int rep = 0; rep < COMPONENTSRepetitionsUsed; rep++)
			{
				yield return (RGV_O15_COMPONENTS)this.GetStructure("COMPONENTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RGV_O15_COMPONENTS
	///</summary>
	public RGV_O15_COMPONENTS AddCOMPONENTS()
	{
		return this.AddStructure("COMPONENTS") as RGV_O15_COMPONENTS;
	}

	///<summary>
	///Removes the given RGV_O15_COMPONENTS
	///</summary>
	public void RemoveCOMPONENTS(RGV_O15_COMPONENTS toRemove)
	{
		this.RemoveStructure("COMPONENTS", toRemove);
	}

	///<summary>
	///Removes the RGV_O15_COMPONENTS at the given index
	///</summary>
