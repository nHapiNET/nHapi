...
///<li>4: OML_O35_OBSERVATION (a Group object) </li>
///<li>5: OML_O35_PRIOR_RESULT (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class OML_O35_OBSERVATION_REQUEST : AbstractGroup {
	...
	public OML_O35_OBSERVATION_REQUEST(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O35_OBSERVATION), true, false);
	      this.add(typeof(OML_O35_PRIOR_RESULT), true, false);
