...
///<li>3: PPG_PCG_ORDER_OBSERVATION (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PPG_PCG_ORDER_DETAIL : AbstractGroup {
	...
	public PPG_PCG_ORDER_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PPG_PCG_ORDER_OBSERVATION), true, false);
...
get{
	...
	///<summary>
	/// Returns PPG_PCG_ORDER_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PPG_PCG_ORDER_OBSERVATION ORDER_OBSERVATION { 
get{
