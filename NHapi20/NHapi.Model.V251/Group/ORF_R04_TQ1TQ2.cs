...
{
///<summary>
///Represents the ORF_R04_TQ1TQ2 Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORF_R04_TQ1TQ2 : AbstractGroup {

	///<summary> 
	/// Creates a new ORF_R04_TQ1TQ2 Group.
	///</summary>
	public ORF_R04_TQ1TQ2(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORF_R04_TQ1TQ2 - this is probably a bug in the source code generator.", e);
	   }
	}
