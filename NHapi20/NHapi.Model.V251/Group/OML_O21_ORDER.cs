...
///<li>1: OML_O21_TIMING (a Group object) </li>
...
public class OML_O21_ORDER : AbstractGroup {
	...
	public OML_O21_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O21_TIMING), true, false);
...
get{
	...
	///<summary>
	/// Returns OML_O21_TIMING (a Group object) - creates it if necessary
	///</summary>
	public OML_O21_TIMING TIMING { 
get{
