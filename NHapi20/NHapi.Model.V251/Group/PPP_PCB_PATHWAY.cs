...
///<li>3: PPP_PCB_PATHWAY_ROLE (a Group object) </li>
///<li>4: PPP_PCB_PROBLEM (a Group object) </li>
///</ol>
///</summary>
[Serializable]
public class PPP_PCB_PATHWAY : AbstractGroup {
	...
	public PPP_PCB_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PPP_PCB_PATHWAY_ROLE), true, false);
	      this.add(typeof(PPP_PCB_PROBLEM), true, false);
...
get{
	...
	///<summary>
	/// Returns PPP_PCB_PATHWAY_ROLE (a Group object) - creates it if necessary
	///</summary>
	public PPP_PCB_PATHWAY_ROLE PATHWAY_ROLE { 
get{
	...
	///<summary>
	/// Returns PPP_PCB_PROBLEM (a Group object) - creates it if necessary
	///</summary>
	public PPP_PCB_PROBLEM PROBLEM { 
get{
