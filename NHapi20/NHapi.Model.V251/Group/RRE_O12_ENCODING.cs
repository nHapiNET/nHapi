...
///<li>1: RRE_O12_TIMING_ENCODED (a Group object) repeating</li>
...
get{
	...
	public RRE_O12_TIMING_ENCODED GetTIMING_ENCODED() {
	   ...
	   try {
	      ret = (RRE_O12_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RRE_O12_TIMING_ENCODED GetTIMING_ENCODED(int rep) { 
	   return (RRE_O12_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RRE_O12_TIMING_ENCODED results 
	 */ 
	public IEnumerable<RRE_O12_TIMING_ENCODED> TIMING_ENCODEDs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_ENCODEDRepetitionsUsed; rep++)
			{
				yield return (RRE_O12_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRE_O12_TIMING_ENCODED
	///</summary>
	public RRE_O12_TIMING_ENCODED AddTIMING_ENCODED()
	{
		return this.AddStructure("TIMING_ENCODED") as RRE_O12_TIMING_ENCODED;
	}

	///<summary>
	///Removes the given RRE_O12_TIMING_ENCODED
	///</summary>
	public void RemoveTIMING_ENCODED(RRE_O12_TIMING_ENCODED toRemove)
	{
		this.RemoveStructure("TIMING_ENCODED", toRemove);
	}

	///<summary>
	///Removes the RRE_O12_TIMING_ENCODED at the given index
	///</summary>
