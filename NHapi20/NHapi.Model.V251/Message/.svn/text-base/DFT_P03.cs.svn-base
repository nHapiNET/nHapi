...
public class DFT_P03 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(DFT_P03_COMMON_ORDER), true, false);
	      this.add(typeof(DFT_P03_FINANCIAL), true, true);
	      this.add(typeof(DG1), false, true);
	      this.add(typeof(DRG), false, false);
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(DFT_P03_INSURANCE), true, false);
...
get{
	...
	///<summary>
	/// Returns DFT_P03_COMMON_ORDER (a Group object) - creates it if necessary
	///</summary>
	public DFT_P03_COMMON_ORDER COMMON_ORDER { 
get{
...
get{
	...
	///<summary>
	/// Returns DFT_P03_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public DFT_P03_INSURANCE INSURANCE { 
get{
