...
///<li>PV2-48: Expected Pre-admission Testing Date/Time (TS)</li>
...
public class PV2 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(TS), false, 1, 26, new System.Object[]{message}, "Expected Pre-admission Testing Date/Time");
...
get{
	...
	///</summary>
	public TS ExpectedPreAdmissionTestingDateTime
	{
		get{
			TS ret = null;
			try
