...
public class OM3 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 0, 250, new System.Object[]{message}, "Abnormal Text/Codes for Categorical Observations");
       this.add(typeof(CE), false, 0, 250, new System.Object[]{message}, "Critical Text/Codes for Categorical Observations");
