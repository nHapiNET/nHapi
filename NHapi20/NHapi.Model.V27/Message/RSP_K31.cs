...
{
///<summary>
/// Represents a RSP_K31 message structure (see chapter 4.A.3.19). This structure contains the 
/// following elements:
///<ol>
...
///<li>7: RCP (Response Control Parameter) </li>
///<li>8: RSP_K31_RESPONSE (a Group object) repeating</li>
...
public class RSP_K31 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RSP_K31 Group with custom IModelClassFactory.
	///</summary>
	public RSP_K31(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for RSP_K31.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RSP_K31 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	public RSP_K31_RESPONSE GetRESPONSE() {
	   ...
	   try {
	      ret = (RSP_K31_RESPONSE)this.GetStructure("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///     greater than the number of existing repetitions.
	///</summary>
	public RSP_K31_RESPONSE GetRESPONSE(int rep) { 
	   return (RSP_K31_RESPONSE)this.GetStructure("RESPONSE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RSP_K31_RESPONSE results 
	 */ 
	public IEnumerable<RSP_K31_RESPONSE> RESPONSEs 
	{ 
		get
		{
			for (int rep = 0; rep < RESPONSERepetitionsUsed; rep++)
			{
				yield return (RSP_K31_RESPONSE)this.GetStructure("RESPONSE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RSP_K31_RESPONSE
	///</summary>
	public RSP_K31_RESPONSE AddRESPONSE()
	{
		return this.AddStructure("RESPONSE") as RSP_K31_RESPONSE;
	}

	///<summary>
	///Removes the given RSP_K31_RESPONSE
	///</summary>
	public void RemoveRESPONSE(RSP_K31_RESPONSE toRemove)
	{
		this.RemoveStructure("RESPONSE", toRemove);
	}

	///<summary>
	///Removes the RSP_K31_RESPONSE at the given index
	///</summary>
