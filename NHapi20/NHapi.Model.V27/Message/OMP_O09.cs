...
{
///<summary>
/// Represents a OMP_O09 message structure (see chapter 4.A.3.2). This structure contains the 
/// following elements:
///<ol>
...
///<li>4: OMP_O09_PATIENT (a Group object) optional </li>
///<li>5: OMP_O09_ORDER (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class OMP_O09 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for OMP_O09.  This does the segment setup for the message. 
	///</summary> 
