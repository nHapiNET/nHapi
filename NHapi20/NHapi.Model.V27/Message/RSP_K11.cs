...
{
///<summary>
/// Represents a RSP_K11 message structure (see chapter 5.3.1.1). This structure contains the 
/// following elements:
///<ol>
...
///<li>7: RSP_K11_SEGMENT_PATTERN (a Group object) optional </li>
...
public class RSP_K11 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RSP_K11.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RSP_K11_SEGMENT_PATTERN), false, false);
...
get{
	...
	///<summary>
	/// Returns RSP_K11_SEGMENT_PATTERN (a Group object) - creates it if necessary
	///</summary>
	public RSP_K11_SEGMENT_PATTERN SEGMENT_PATTERN { 
get{
	   RSP_K11_SEGMENT_PATTERN ret = null;
	   try {
	      ret = (RSP_K11_SEGMENT_PATTERN)this.GetStructure("SEGMENT_PATTERN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
