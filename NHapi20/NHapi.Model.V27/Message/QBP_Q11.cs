...
{
///<summary>
/// Represents a QBP_Q11 message structure (see chapter 4.A.3.19). This structure contains the 
/// following elements:
///<ol>
...
///<li>4: QBP_Q11_QBP (a Group object) optional </li>
...
public class QBP_Q11 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for QBP_Q11.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(QBP_Q11_QBP), false, false);
...
get{
	...
	///<summary>
	/// Returns QBP_Q11_QBP (a Group object) - creates it if necessary
	///</summary>
	public QBP_Q11_QBP QBP { 
get{
	   QBP_Q11_QBP ret = null;
	   try {
	      ret = (QBP_Q11_QBP)this.GetStructure("QBP");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
