...
{
///<summary>
/// Represents a QBP_E22 message structure (see chapter 16.3.12). This structure contains the 
/// following elements:
///<ol>
...
///</summary>
[Serializable]
public class QBP_E22 : AbstractMessage  {

	///<summary> 
	/// Creates a new QBP_E22 Group with custom IModelClassFactory.
	///</summary>
	public QBP_E22(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new QBP_E22 Group with DefaultModelClassFactory. 
	///</summary> 
	public QBP_E22() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for QBP_E22.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating QBP_E22 - this is probably a bug in the source code generator.", e);
	   }
	}
