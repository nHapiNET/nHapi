...
///<li>4: QRD (withdrawn) </li>
///<li>5: QRF (withdrawn) optional </li>
///<li>6: RCI_I05_PROVIDER (a Group object) repeating</li>
...
///<li>11: RCI_I05_OBSERVATION (a Group object) optional </li>
...
public class RCI_I05 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RCI_I05_OBSERVATION), false, false);
...
get{
	...
	///<summary>
	/// Returns QRD (withdrawn) - creates it if necessary
	///</summary>
	public QRD QRD { 
get{
	   QRD ret = null;
	...
	///<summary>
	/// Returns QRF (withdrawn) - creates it if necessary
	///</summary>
	public QRF QRF { 
get{
	   QRF ret = null;
...
get{
	...
	///<summary>
	/// Returns RCI_I05_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public RCI_I05_OBSERVATION OBSERVATION { 
get{
