...
{
///<summary>
/// Represents a RSP_Z90 message structure (see chapter 5.9.2.3). This structure contains the 
/// following elements:
///<ol>
...
///<li>8: RSP_Z90_QUERY_RESPONSE (a Group object) repeating</li>
...
public class RSP_Z90 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RSP_Z90.  This does the segment setup for the message. 
	///</summary> 
