...
{
///<summary>
/// Represents a RSP_Z82 message structure (see chapter 5.9.1.0.1). This structure contains the 
/// following elements:
///<ol>
...
///<li>8: RSP_Z82_QUERY_RESPONSE (a Group object) repeating</li>
...
public class RSP_Z82 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RSP_Z82.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RSP_Z82_QUERY_RESPONSE), true, true);
