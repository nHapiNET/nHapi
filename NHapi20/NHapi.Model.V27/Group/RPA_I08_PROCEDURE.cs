...
///<li>1: RPA_I08_AUTHORIZATION2 (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RPA_I08_PROCEDURE : AbstractGroup {
	...
	public RPA_I08_PROCEDURE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RPA_I08_AUTHORIZATION2), false, false);
...
get{
	...
	///<summary>
	/// Returns RPA_I08_AUTHORIZATION2 (a Group object) - creates it if necessary
	///</summary>
	public RPA_I08_AUTHORIZATION2 AUTHORIZATION2 { 
get{
	   RPA_I08_AUTHORIZATION2 ret = null;
	   try {
	      ret = (RPA_I08_AUTHORIZATION2)this.GetStructure("AUTHORIZATION2");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
