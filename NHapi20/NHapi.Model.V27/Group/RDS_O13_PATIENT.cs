...
///<li>1: RDS_O13_ADDITIONAL_DEMOGRAPHICS (a Group object) optional </li>
...
public class RDS_O13_PATIENT : AbstractGroup {
	...
	public RDS_O13_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RDS_O13_ADDITIONAL_DEMOGRAPHICS), false, false);
...
get{
	...
	///<summary>
	/// Returns RDS_O13_ADDITIONAL_DEMOGRAPHICS (a Group object) - creates it if necessary
	///</summary>
	public RDS_O13_ADDITIONAL_DEMOGRAPHICS ADDITIONAL_DEMOGRAPHICS { 
get{
	   RDS_O13_ADDITIONAL_DEMOGRAPHICS ret = null;
	   try {
	      ret = (RDS_O13_ADDITIONAL_DEMOGRAPHICS)this.GetStructure("ADDITIONAL_DEMOGRAPHICS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
