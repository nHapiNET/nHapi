...
///<li>1: RDR_RDR_TIMING_ENCODED (a Group object) optional repeating</li>
...
public class RDR_RDR_ENCODING : AbstractGroup {
	...
	public RDR_RDR_ENCODING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RDR_RDR_TIMING_ENCODED), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of RDR_RDR_TIMING_ENCODED (a Group object) - creates it if necessary
	///</summary>
	public RDR_RDR_TIMING_ENCODED GetTIMING_ENCODED() {
	   RDR_RDR_TIMING_ENCODED ret = null;
	   try {
	      ret = (RDR_RDR_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of RDR_RDR_TIMING_ENCODED
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public RDR_RDR_TIMING_ENCODED GetTIMING_ENCODED(int rep) { 
	   return (RDR_RDR_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RDR_RDR_TIMING_ENCODED 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the RDR_RDR_TIMING_ENCODED results 
	 */ 
	public IEnumerable<RDR_RDR_TIMING_ENCODED> TIMING_ENCODEDs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_ENCODEDRepetitionsUsed; rep++)
			{
				yield return (RDR_RDR_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDR_RDR_TIMING_ENCODED
	///</summary>
	public RDR_RDR_TIMING_ENCODED AddTIMING_ENCODED()
	{
		return this.AddStructure("TIMING_ENCODED") as RDR_RDR_TIMING_ENCODED;
	}

	///<summary>
	///Removes the given RDR_RDR_TIMING_ENCODED
	///</summary>
	public void RemoveTIMING_ENCODED(RDR_RDR_TIMING_ENCODED toRemove)
	{
		this.RemoveStructure("TIMING_ENCODED", toRemove);
	}

	///<summary>
	///Removes the RDR_RDR_TIMING_ENCODED at the given index
	///</summary>
