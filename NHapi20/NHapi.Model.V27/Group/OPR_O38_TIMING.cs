...
{
///<summary>
///Represents the OPR_O38_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OPR_O38_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OPR_O38_TIMING Group.
	///</summary>
	public OPR_O38_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OPR_O38_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
