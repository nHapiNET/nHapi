...
{
///<summary>
///Represents the CCM_I21_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCM_I21_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new CCM_I21_INSURANCE Group.
	///</summary>
	public CCM_I21_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(IN1), true, false);
	      this.add(typeof(IN2), false, false);
	      this.add(typeof(IN3), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCM_I21_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
