...
{
///<summary>
///Represents the CCR_I16_PROVIDER_CONTACT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCR_I16_PROVIDER_CONTACT : AbstractGroup {

	///<summary> 
	/// Creates a new CCR_I16_PROVIDER_CONTACT Group.
	///</summary>
	public CCR_I16_PROVIDER_CONTACT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCR_I16_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
	   }
	}
