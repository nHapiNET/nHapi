...
{
///<summary>
///Represents the ORU_R01_TIMING_QTY Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORU_R01_TIMING_QTY : AbstractGroup {

	///<summary> 
	/// Creates a new ORU_R01_TIMING_QTY Group.
	///</summary>
	public ORU_R01_TIMING_QTY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORU_R01_TIMING_QTY - this is probably a bug in the source code generator.", e);
	   }
	}
