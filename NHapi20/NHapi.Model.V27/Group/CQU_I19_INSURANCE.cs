...
{
///<summary>
///Represents the CQU_I19_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CQU_I19_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new CQU_I19_INSURANCE Group.
	///</summary>
	public CQU_I19_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(IN1), true, false);
	      this.add(typeof(IN2), false, false);
	      this.add(typeof(IN3), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CQU_I19_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
