...
public class RXR : AbstractSegment  {
  ...
  /**
   * Creates a RXR (RXR - pharmacy/treatment route segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 1, 60, new System.Object[]{message}, "Routing Instruction");
