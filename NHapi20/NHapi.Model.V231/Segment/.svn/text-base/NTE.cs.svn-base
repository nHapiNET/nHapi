...
public class NTE : AbstractSegment  {
  ...
  /**
   * Creates a NTE (NTE - notes and comments segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 1, 60, new System.Object[]{message}, "Comment Type");
