...
{
///<summary>
///Represents the ADT_A42_PATIENT Group.  A Group is an ordered collection of message 
...
public class ADT_A42_PATIENT : AbstractGroup {
	...
	///</summary>
	public ADT_A42_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
