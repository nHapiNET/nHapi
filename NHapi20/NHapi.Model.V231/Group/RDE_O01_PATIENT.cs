...
{
///<summary>
///Represents the RDE_O01_PATIENT Group.  A Group is an ordered collection of message 
...
///<li>3: RDE_O01_PATIENT_VISIT (a Group object) optional </li>
///<li>4: RDE_O01_INSURANCE (a Group object) optional repeating</li>
...
public class RDE_O01_PATIENT : AbstractGroup {
	...
	///</summary>
	public RDE_O01_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PID), true, false);
	      this.add(typeof(PD1), false, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(RDE_O01_PATIENT_VISIT), false, false);
	      this.add(typeof(RDE_O01_INSURANCE), false, true);
...
get{
	   ...
	   try {
	      ret = (RDE_O01_PATIENT_VISIT)this.GetStructure("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RDE_O01_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (RDE_O01_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RDE_O01_INSURANCE GetINSURANCE(int rep) { 
	   return (RDE_O01_INSURANCE)this.GetStructure("INSURANCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RDE_O01_INSURANCE results 
	 */ 
	public IEnumerable<RDE_O01_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RDE_O01_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDE_O01_INSURANCE
	///</summary>
	public RDE_O01_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RDE_O01_INSURANCE;
	}

	///<summary>
	///Removes the given RDE_O01_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RDE_O01_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RDE_O01_INSURANCE at the given index
	///</summary>
