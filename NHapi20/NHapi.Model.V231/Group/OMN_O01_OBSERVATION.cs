...
{
///<summary>
///Represents the OMN_O01_OBSERVATION Group.  A Group is an ordered collection of message 
...
public class OMN_O01_OBSERVATION : AbstractGroup {
	...
	///</summary>
	public OMN_O01_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
