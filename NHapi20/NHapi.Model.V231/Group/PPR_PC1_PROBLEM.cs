...
///<li>5: PPR_PC1_PATHWAY_OBSERVATION (a Group object) optional repeating</li>
...
public class PPR_PC1_PROBLEM : AbstractGroup {
	...
	public PPR_PC1_PROBLEM(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(PPR_PC1_PATHWAY_OBSERVATION), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of PPR_PC1_PATHWAY_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public PPR_PC1_PATHWAY_OBSERVATION GetPATHWAY_OBSERVATION() {
	   PPR_PC1_PATHWAY_OBSERVATION ret = null;
	   try {
	      ret = (PPR_PC1_PATHWAY_OBSERVATION)this.GetStructure("PATHWAY_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of PPR_PC1_PATHWAY_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public PPR_PC1_PATHWAY_OBSERVATION GetPATHWAY_OBSERVATION(int rep) { 
	   return (PPR_PC1_PATHWAY_OBSERVATION)this.GetStructure("PATHWAY_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of PPR_PC1_PATHWAY_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC1_PATHWAY_OBSERVATION results 
	 */ 
	public IEnumerable<PPR_PC1_PATHWAY_OBSERVATION> PATHWAY_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PATHWAY_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (PPR_PC1_PATHWAY_OBSERVATION)this.GetStructure("PATHWAY_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC1_PATHWAY_OBSERVATION
	///</summary>
	public PPR_PC1_PATHWAY_OBSERVATION AddPATHWAY_OBSERVATION()
	{
		return this.AddStructure("PATHWAY_OBSERVATION") as PPR_PC1_PATHWAY_OBSERVATION;
	}

	///<summary>
	///Removes the given PPR_PC1_PATHWAY_OBSERVATION
	///</summary>
	public void RemovePATHWAY_OBSERVATION(PPR_PC1_PATHWAY_OBSERVATION toRemove)
	{
		this.RemoveStructure("PATHWAY_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the PPR_PC1_PATHWAY_OBSERVATION at the given index
	///</summary>
