...
{
///<summary>
///Represents the RDS_O01_ORDER_DETAIL_SUPPLEMENT Group.  A Group is an ordered collection of message 
...
///<li>2: RDS_O01_COMPONENT (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RDS_O01_ORDER_DETAIL_SUPPLEMENT : AbstractGroup {
	...
	///</summary>
	public RDS_O01_ORDER_DETAIL_SUPPLEMENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(NTE), true, true);
	      this.add(typeof(RXR), true, true);
	      this.add(typeof(RDS_O01_COMPONENT), false, false);
...
get{
	   ...
	   try {
	      ret = (RDS_O01_COMPONENT)this.GetStructure("COMPONENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
