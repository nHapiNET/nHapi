...
{
///<summary>
///Represents the RDS_O01_PATIENT Group.  A Group is an ordered collection of message 
...
///<li>4: RDS_O01_PATIENT_VISIT (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RDS_O01_PATIENT : AbstractGroup {
	...
	///</summary>
	public RDS_O01_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	   ...
	   try {
	      ret = (RDS_O01_PATIENT_VISIT)this.GetStructure("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
