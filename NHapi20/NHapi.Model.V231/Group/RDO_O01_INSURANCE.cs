...
{
///<summary>
///Represents the RDO_O01_INSURANCE Group.  A Group is an ordered collection of message 
...
public class RDO_O01_INSURANCE : AbstractGroup {
	...
	///</summary>
	public RDO_O01_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
