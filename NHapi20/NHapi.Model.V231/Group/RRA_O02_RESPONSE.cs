...
get{
	...
	/** 
	 * Enumerate over the RRA_O02_ORDER results 
	 */ 
	public IEnumerable<RRA_O02_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (RRA_O02_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRA_O02_ORDER
	///</summary>
	public RRA_O02_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as RRA_O02_ORDER;
	}

	///<summary>
	///Removes the given RRA_O02_ORDER
	///</summary>
	public void RemoveORDER(RRA_O02_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the RRA_O02_ORDER at the given index
	///</summary>
