...
{
///<summary>
///Represents the RDE_O01_COMPONENT Group.  A Group is an ordered collection of message 
...
public class RDE_O01_COMPONENT : AbstractGroup {
	...
	///</summary>
	public RDE_O01_COMPONENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
