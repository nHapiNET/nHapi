...
{
///<summary>
///Represents the RGV_O01_PATIENT Group.  A Group is an ordered collection of message 
...
///<li>2: AL1 (AL1 - patient allergy information segment) optional repeating</li>
///<li>3: RGV_O01_PATIENT_VISIT (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RGV_O01_PATIENT : AbstractGroup {
	...
	///</summary>
	public RGV_O01_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PID), true, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(AL1), false, true);
	      this.add(typeof(RGV_O01_PATIENT_VISIT), false, false);
...
get{
	   ...
	   try {
	      ret = (RGV_O01_PATIENT_VISIT)this.GetStructure("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
