...
get{
	...
	/** 
	 * Enumerate over the RDO_O01_ORDER results 
	 */ 
	public IEnumerable<RDO_O01_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (RDO_O01_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDO_O01_ORDER
	///</summary>
	public RDO_O01_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as RDO_O01_ORDER;
	}

	///<summary>
	///Removes the given RDO_O01_ORDER
	///</summary>
	public void RemoveORDER(RDO_O01_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the RDO_O01_ORDER at the given index
	///</summary>
