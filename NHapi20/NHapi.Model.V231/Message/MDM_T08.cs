...
{
///<summary>
/// Represents a MDM_T08 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
...
///</summary>
[Serializable]
public class MDM_T08 : AbstractMessage  {

	///<summary> 
	/// Creates a new MDM_T08 Group with custom IModelClassFactory.
	///</summary>
	public MDM_T08(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new MDM_T08 Group with DefaultModelClassFactory. 
	///</summary> 
	public MDM_T08() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for MDM_T08.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating MDM_T08 - this is probably a bug in the source code generator.", e);
	   }
	}
