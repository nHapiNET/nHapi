...
///<li>OM1-39: Factors that may Affect Affect the Observation (TX)</li>
...
public class OM1 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(TX), false, 1, 200, new System.Object[]{message}, "Factors that may Affect Affect the Observation");
