...
{
///<summary>
///Represents the OML_O33_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OML_O33_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OML_O33_TIMING Group.
	///</summary>
	public OML_O33_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OML_O33_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
