...
{
///<summary>
///Represents the OMQ_O42_PATIENT_PRIOR Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMQ_O42_PATIENT_PRIOR : AbstractGroup {

	///<summary> 
	/// Creates a new OMQ_O42_PATIENT_PRIOR Group.
	///</summary>
	public OMQ_O42_PATIENT_PRIOR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMQ_O42_PATIENT_PRIOR - this is probably a bug in the source code generator.", e);
	   }
	}
