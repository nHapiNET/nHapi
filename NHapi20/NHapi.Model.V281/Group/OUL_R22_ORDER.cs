...
///<li>2: OUL_R22_COMMON_ORDER (a Group object) optional </li>
///<li>3: NTE (Notes and Comments) optional repeating</li>
///<li>4: PRT (Participation Information) optional repeating</li>
///<li>5: OUL_R22_TIMING_QTY (a Group object) optional repeating</li>
///<li>6: OUL_R22_RESULT (a Group object) optional repeating</li>
...
public class OUL_R22_ORDER : AbstractGroup {
	...
	public OUL_R22_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OUL_R22_COMMON_ORDER), false, false);
...
get{
	...
	///<summary>
	/// Returns OUL_R22_COMMON_ORDER (a Group object) - creates it if necessary
	///</summary>
	public OUL_R22_COMMON_ORDER COMMON_ORDER { 
get{
	   OUL_R22_COMMON_ORDER ret = null;
	   try {
	      ret = (OUL_R22_COMMON_ORDER)this.GetStructure("COMMON_ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
