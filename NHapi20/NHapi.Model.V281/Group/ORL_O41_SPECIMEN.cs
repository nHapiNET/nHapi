...
{
///<summary>
///Represents the ORL_O41_SPECIMEN Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORL_O41_SPECIMEN : AbstractGroup {

	///<summary> 
	/// Creates a new ORL_O41_SPECIMEN Group.
	///</summary>
	public ORL_O41_SPECIMEN(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(SPM), true, false);
	      this.add(typeof(SAC), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORL_O41_SPECIMEN - this is probably a bug in the source code generator.", e);
	   }
	}
