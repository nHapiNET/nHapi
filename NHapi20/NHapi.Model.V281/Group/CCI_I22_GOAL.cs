...
///<li>3: CCI_I22_GOAL_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class CCI_I22_GOAL : AbstractGroup {
	...
	public CCI_I22_GOAL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(CCI_I22_GOAL_OBSERVATION), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of CCI_I22_GOAL_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public CCI_I22_GOAL_OBSERVATION GetGOAL_OBSERVATION() {
	   CCI_I22_GOAL_OBSERVATION ret = null;
	   try {
	      ret = (CCI_I22_GOAL_OBSERVATION)this.GetStructure("GOAL_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of CCI_I22_GOAL_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public CCI_I22_GOAL_OBSERVATION GetGOAL_OBSERVATION(int rep) { 
	   return (CCI_I22_GOAL_OBSERVATION)this.GetStructure("GOAL_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CCI_I22_GOAL_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the CCI_I22_GOAL_OBSERVATION results 
	 */ 
	public IEnumerable<CCI_I22_GOAL_OBSERVATION> GOAL_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < GOAL_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCI_I22_GOAL_OBSERVATION)this.GetStructure("GOAL_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCI_I22_GOAL_OBSERVATION
	///</summary>
	public CCI_I22_GOAL_OBSERVATION AddGOAL_OBSERVATION()
	{
		return this.AddStructure("GOAL_OBSERVATION") as CCI_I22_GOAL_OBSERVATION;
	}

	///<summary>
	///Removes the given CCI_I22_GOAL_OBSERVATION
	///</summary>
	public void RemoveGOAL_OBSERVATION(CCI_I22_GOAL_OBSERVATION toRemove)
	{
		this.RemoveStructure("GOAL_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CCI_I22_GOAL_OBSERVATION at the given index
	///</summary>
