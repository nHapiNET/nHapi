...
{
///<summary>
///Represents the CCR_I16_CLINICAL_HISTORY_DETAIL Group.  A Group is an ordered collection of message 
...
///<li>11: CCR_I16_CLINICAL_HISTORY_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class CCR_I16_CLINICAL_HISTORY_DETAIL : AbstractGroup {

	///<summary> 
	/// Creates a new CCR_I16_CLINICAL_HISTORY_DETAIL Group.
	///</summary>
	public CCR_I16_CLINICAL_HISTORY_DETAIL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(CCR_I16_CLINICAL_HISTORY_OBSERVATION), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCR_I16_CLINICAL_HISTORY_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	///Returns a specific repetition of CCR_I16_CLINICAL_HISTORY_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public CCR_I16_CLINICAL_HISTORY_OBSERVATION GetCLINICAL_HISTORY_OBSERVATION(int rep) { 
	   return (CCR_I16_CLINICAL_HISTORY_OBSERVATION)this.GetStructure("CLINICAL_HISTORY_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CCR_I16_CLINICAL_HISTORY_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the CCR_I16_CLINICAL_HISTORY_OBSERVATION results 
	 */ 
	public IEnumerable<CCR_I16_CLINICAL_HISTORY_OBSERVATION> CLINICAL_HISTORY_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < CLINICAL_HISTORY_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCR_I16_CLINICAL_HISTORY_OBSERVATION)this.GetStructure("CLINICAL_HISTORY_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCR_I16_CLINICAL_HISTORY_OBSERVATION
	///</summary>
	public CCR_I16_CLINICAL_HISTORY_OBSERVATION AddCLINICAL_HISTORY_OBSERVATION()
	{
		return this.AddStructure("CLINICAL_HISTORY_OBSERVATION") as CCR_I16_CLINICAL_HISTORY_OBSERVATION;
	}
	...
	///<summary>
	///Removes the CCR_I16_CLINICAL_HISTORY_OBSERVATION at the given index
	///</summary>
