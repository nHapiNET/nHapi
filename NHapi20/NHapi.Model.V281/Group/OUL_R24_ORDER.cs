...
{
///<summary>
///Represents the OUL_R24_ORDER Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: OBR (Observation Request) </li>
///<li>1: PRT (Participation Information) optional repeating</li>
///<li>2: OUL_R24_COMMON_ORDER (a Group object) optional </li>
///<li>3: NTE (Notes and Comments) optional repeating</li>
///<li>4: PRT (Participation Information) optional repeating</li>
///<li>5: OUL_R24_TIMING_QTY (a Group object) optional repeating</li>
///<li>6: OUL_R24_SPECIMEN (a Group object) optional repeating</li>
///<li>7: OUL_R24_RESULT (a Group object) optional repeating</li>
///<li>8: CTI (Clinical Trial Identification) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class OUL_R24_ORDER : AbstractGroup {

	///<summary> 
	/// Creates a new OUL_R24_ORDER Group.
	///</summary>
	public OUL_R24_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(OBR), true, false);
	      this.add(typeof(PRT), false, true);
	      this.add(typeof(OUL_R24_COMMON_ORDER), false, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(PRT), false, true);
	      this.add(typeof(OUL_R24_TIMING_QTY), false, true);
	      this.add(typeof(OUL_R24_SPECIMEN), false, true);
	      this.add(typeof(OUL_R24_RESULT), false, true);
	      this.add(typeof(CTI), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OUL_R24_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns OUL_R24_COMMON_ORDER (a Group object) - creates it if necessary
	///</summary>
	public OUL_R24_COMMON_ORDER COMMON_ORDER { 
get{
	   OUL_R24_COMMON_ORDER ret = null;
	   try {
	      ret = (OUL_R24_COMMON_ORDER)this.GetStructure("COMMON_ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	public OUL_R24_TIMING_QTY GetTIMING_QTY() {
	   ...
	   try {
	      ret = (OUL_R24_TIMING_QTY)this.GetStructure("TIMING_QTY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OUL_R24_TIMING_QTY GetTIMING_QTY(int rep) { 
	   return (OUL_R24_TIMING_QTY)this.GetStructure("TIMING_QTY", rep);
	}
...
get{
	...
	public OUL_R24_SPECIMEN GetSPECIMEN() {
	   ...
	   try {
	      ret = (OUL_R24_SPECIMEN)this.GetStructure("SPECIMEN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OUL_R24_SPECIMEN GetSPECIMEN(int rep) { 
	   return (OUL_R24_SPECIMEN)this.GetStructure("SPECIMEN", rep);
	}
...
get{
	...
	public OUL_R24_RESULT GetRESULT() {
	   ...
	   try {
	      ret = (OUL_R24_RESULT)this.GetStructure("RESULT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OUL_R24_RESULT GetRESULT(int rep) { 
	   return (OUL_R24_RESULT)this.GetStructure("RESULT", rep);
	}
