...
get{
	...
	/** 
	 * Enumerate over the CQU_I19_MEDICATION_ORDER_OBSERVATION results 
	 */ 
	public IEnumerable<CQU_I19_MEDICATION_ORDER_OBSERVATION> MEDICATION_ORDER_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < MEDICATION_ORDER_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CQU_I19_MEDICATION_ORDER_OBSERVATION)this.GetStructure("MEDICATION_ORDER_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CQU_I19_MEDICATION_ORDER_OBSERVATION
	///</summary>
	public CQU_I19_MEDICATION_ORDER_OBSERVATION AddMEDICATION_ORDER_OBSERVATION()
	{
		return this.AddStructure("MEDICATION_ORDER_OBSERVATION") as CQU_I19_MEDICATION_ORDER_OBSERVATION;
	}

	///<summary>
	///Removes the given CQU_I19_MEDICATION_ORDER_OBSERVATION
	///</summary>
	public void RemoveMEDICATION_ORDER_OBSERVATION(CQU_I19_MEDICATION_ORDER_OBSERVATION toRemove)
	{
		this.RemoveStructure("MEDICATION_ORDER_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CQU_I19_MEDICATION_ORDER_OBSERVATION at the given index
	///</summary>
