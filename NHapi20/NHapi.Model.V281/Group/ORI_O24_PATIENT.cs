...
{
///<summary>
///Represents the ORI_O24_PATIENT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORI_O24_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new ORI_O24_PATIENT Group.
	///</summary>
	public ORI_O24_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORI_O24_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
