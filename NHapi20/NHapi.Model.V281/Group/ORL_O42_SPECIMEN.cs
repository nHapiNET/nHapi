...
get{
	...
	/** 
	 * Enumerate over the ORL_O42_SPECIMEN_OBSERVATION results 
	 */ 
	public IEnumerable<ORL_O42_SPECIMEN_OBSERVATION> SPECIMEN_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < SPECIMEN_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (ORL_O42_SPECIMEN_OBSERVATION)this.GetStructure("SPECIMEN_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O42_SPECIMEN_OBSERVATION
	///</summary>
	public ORL_O42_SPECIMEN_OBSERVATION AddSPECIMEN_OBSERVATION()
	{
		return this.AddStructure("SPECIMEN_OBSERVATION") as ORL_O42_SPECIMEN_OBSERVATION;
	}

	///<summary>
	///Removes the given ORL_O42_SPECIMEN_OBSERVATION
	///</summary>
	public void RemoveSPECIMEN_OBSERVATION(ORL_O42_SPECIMEN_OBSERVATION toRemove)
	{
		this.RemoveStructure("SPECIMEN_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the ORL_O42_SPECIMEN_OBSERVATION at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the ORL_O42_ORDER results 
	 */ 
	public IEnumerable<ORL_O42_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (ORL_O42_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O42_ORDER
	///</summary>
	public ORL_O42_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as ORL_O42_ORDER;
	}

	///<summary>
	///Removes the given ORL_O42_ORDER
	///</summary>
	public void RemoveORDER(ORL_O42_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the ORL_O42_ORDER at the given index
	///</summary>
