...
get{
	...
	/** 
	 * Enumerate over the ORL_O44_SPECIMEN_IN_PACKAGE results 
	 */ 
	public IEnumerable<ORL_O44_SPECIMEN_IN_PACKAGE> SPECIMEN_IN_PACKAGEs 
	{ 
		get
		{
			for (int rep = 0; rep < SPECIMEN_IN_PACKAGERepetitionsUsed; rep++)
			{
				yield return (ORL_O44_SPECIMEN_IN_PACKAGE)this.GetStructure("SPECIMEN_IN_PACKAGE", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O44_SPECIMEN_IN_PACKAGE
	///</summary>
	public ORL_O44_SPECIMEN_IN_PACKAGE AddSPECIMEN_IN_PACKAGE()
	{
		return this.AddStructure("SPECIMEN_IN_PACKAGE") as ORL_O44_SPECIMEN_IN_PACKAGE;
	}

	///<summary>
	///Removes the given ORL_O44_SPECIMEN_IN_PACKAGE
	///</summary>
	public void RemoveSPECIMEN_IN_PACKAGE(ORL_O44_SPECIMEN_IN_PACKAGE toRemove)
	{
		this.RemoveStructure("SPECIMEN_IN_PACKAGE", toRemove);
	}

	///<summary>
	///Removes the ORL_O44_SPECIMEN_IN_PACKAGE at the given index
	///</summary>
