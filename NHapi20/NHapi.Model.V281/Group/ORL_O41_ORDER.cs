...
get{
	...
	/** 
	 * Enumerate over the ORL_O41_TIMING results 
	 */ 
	public IEnumerable<ORL_O41_TIMING> TIMINGs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMINGRepetitionsUsed; rep++)
			{
				yield return (ORL_O41_TIMING)this.GetStructure("TIMING", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O41_TIMING
	///</summary>
	public ORL_O41_TIMING AddTIMING()
	{
		return this.AddStructure("TIMING") as ORL_O41_TIMING;
	}

	///<summary>
	///Removes the given ORL_O41_TIMING
	///</summary>
	public void RemoveTIMING(ORL_O41_TIMING toRemove)
	{
		this.RemoveStructure("TIMING", toRemove);
	}

	///<summary>
	///Removes the ORL_O41_TIMING at the given index
	///</summary>
