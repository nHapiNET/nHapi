...
{
///<summary>
///Represents the OMN_O07_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMN_O07_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OMN_O07_TIMING Group.
	///</summary>
	public OMN_O07_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMN_O07_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
