...
{
///<summary>
///Represents the CCR_I16_CLINICAL_ORDER_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCR_I16_CLINICAL_ORDER_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new CCR_I16_CLINICAL_ORDER_TIMING Group.
	///</summary>
	public CCR_I16_CLINICAL_ORDER_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCR_I16_CLINICAL_ORDER_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
