...
{
///<summary>
///Represents the ORN_O08_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORN_O08_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORN_O08_TIMING Group.
	///</summary>
	public ORN_O08_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORN_O08_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
