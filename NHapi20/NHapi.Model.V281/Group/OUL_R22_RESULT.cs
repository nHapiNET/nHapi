...
{
///<summary>
///Represents the OUL_R22_RESULT Group.  A Group is an ordered collection of message 
...
public class OUL_R22_RESULT : AbstractGroup {
	...
	///</summary>
	public OUL_R22_RESULT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
