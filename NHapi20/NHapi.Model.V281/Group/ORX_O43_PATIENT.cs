...
{
///<summary>
///Represents the ORX_O43_PATIENT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORX_O43_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new ORX_O43_PATIENT Group.
	///</summary>
	public ORX_O43_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORX_O43_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
