...
///<li>4: CDO (Cumulative Dosage) optional repeating</li>
///<li>5: RGV_O15_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class RGV_O15_GIVE : AbstractGroup {
	...
	public RGV_O15_GIVE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RGV_O15_OBSERVATION), false, true);
