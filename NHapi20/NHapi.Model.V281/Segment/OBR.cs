...
///<li>OBR-5: Deliver-To Location (-)</li>
///<li>OBR-6: Deliver-To Location (-)</li>
...
///<li>OBR-14: Deliver-To Location (-)</li>
///<li>OBR-15: Deliver-To Location (-)</li>
...
///<li>OBR-27: Deliver-To Location (-)</li>
...
get{
	...
	///<summary>
	/// Returns a single repetition of Relevant Clinical Information(OBR-13).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Relevant Clinical Information (OBR-13).
   ///</summary>
  public int RelevantClinicalInformationRepetitionsUsed
{
get{
    try {
...
get{
	...
	///<summary>
	/// Returns Parent  Results Observation Identifier(OBR-29).
	///</summary>
	public EIP ParentResultsObservationIdentifier
	{
		get{
			EIP ret = null;
			try
