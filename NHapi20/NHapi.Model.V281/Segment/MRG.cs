...
public class MRG : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CX), false, 1, 0, new System.Object[]{message}, "Prior Alternate Patient ID");
       this.add(typeof(CX), false, 1, 0, new System.Object[]{message}, "Prior Patient Account Number");
       this.add(typeof(CX), false, 1, 0, new System.Object[]{message}, "Prior Patient ID");
       this.add(typeof(CX), false, 1, 0, new System.Object[]{message}, "Prior Visit Number");
       this.add(typeof(CX), false, 0, 0, new System.Object[]{message}, "Prior Alternate Visit ID");
...
get{
	...
	///<summary>
	/// Returns a single repetition of Prior Alternate Visit ID(MRG-6).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
	public CX GetPriorAlternateVisitID(int rep)
	{
			CX ret = null;
			try
			{
  ...
  ///<summary>
  /// Returns all repetitions of Prior Alternate Visit ID (MRG-6).
   ///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Prior Alternate Visit ID (MRG-6).
   ///</summary>
  public int PriorAlternateVisitIDRepetitionsUsed
{
get{
    try {
