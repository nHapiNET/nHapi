...
///<li>IN1-55: Insurance Action Code (ID)</li>
///</ol>
...
public class IN1 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(ID), false, 1, 1, new System.Object[]{message, 206}, "Insurance Action Code");
...
get{
	...
	///<summary>
	/// Returns Insurance Action Code(IN1-55).
	///</summary>
	public ID InsuranceActionCode
	{
		get{
			ID ret = null;
			try
