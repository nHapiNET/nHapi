...
///<li>OBX-29: Observation Type (ID)</li>
///</ol>
...
public class OBX : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(ID), false, 1, 0, new System.Object[]{message, 936}, "Observation Type");
...
get{
	...
	///<summary>
	/// Returns Observation Type(OBX-29).
	///</summary>
	public ID ObservationType
	{
		get{
			ID ret = null;
			try
