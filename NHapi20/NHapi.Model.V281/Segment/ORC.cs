...
///<li>ORC-4: Placer Group Number (EIP)</li>
///<li>ORC-5: Order Status (ID)</li>
///<li>ORC-6: Response Flag (ID)</li>
///<li>ORC-7: Deliver-To Location (-)</li>
...
///<li>ORC-34: Order Workflow Profile (CWE)</li>
///</ol>
...
public class ORC : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(EIP), false, 1, 0, new System.Object[]{message}, "Placer Group Number");
       ...
       this.add(typeof(-), false, 0, 0, new System.Object[]{message}, "Deliver-To Location");
       ...
       this.add(typeof(CWE), false, 0, 0, new System.Object[]{message}, "Order Workflow Profile");
	...
	///<summary>
	/// Returns a single repetition of Deliver-To Location(ORC-7).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
	public - GetDeliverToLocation(int rep)
	{
			- ret = null;
			try
			{
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Deliver-To Location (ORC-7).
   ///</summary>
...
get{
	...
	///<summary>
	/// Returns a single repetition of Order Workflow Profile(ORC-34).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Order Workflow Profile (ORC-34).
   ///</summary>
  public int OrderWorkflowProfileRepetitionsUsed
{
get{
    try {
