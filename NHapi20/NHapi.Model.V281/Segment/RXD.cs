...
///<li>RXD-35: Dispense Tag Identifier (EI)</li>
///</ol>
...
public class RXD : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(EI), false, 0, 0, new System.Object[]{message}, "Dispense Tag Identifier");
...
get{
	...
	///<summary>
	/// Returns a single repetition of Special Dispensing Instructions(RXD-15).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
  ...
  ///<summary>
  /// Returns all repetitions of Special Dispensing Instructions (RXD-15).
   ///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Special Dispensing Instructions (RXD-15).
   ///</summary>
  public int SpecialDispensingInstructionsRepetitionsUsed
{
get{
    try {
...
get{
	...
	///<summary>
	/// Returns a single repetition of Dispense Tag Identifier(RXD-35).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
  ...
  ///<summary>
  /// Returns all repetitions of Dispense Tag Identifier (RXD-35).
   ///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Dispense Tag Identifier (RXD-35).
   ///</summary>
  public int DispenseTagIdentifierRepetitionsUsed
{
get{
    try {
