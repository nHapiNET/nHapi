...
///<li>7: ORU_R30_PATIENT_OBSERVATION (a Group object) optional repeating</li>
///<li>8: ORU_R30_VISIT (a Group object) optional </li>
///<li>9: ORC (Common Order) </li>
///<li>10: PRT (Participation Information) optional repeating</li>
///<li>11: OBR (Observation Request) </li>
///<li>12: NTE (Notes and Comments) optional repeating</li>
///<li>13: PRT (Participation Information) optional repeating</li>
///<li>14: ORU_R30_TIMING_QTY (a Group object) optional repeating</li>
///<li>15: ORU_R30_OBSERVATION (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	///<summary>
	/// Returns  first repetition of ORU_R30_PATIENT_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public ORU_R30_PATIENT_OBSERVATION GetPATIENT_OBSERVATION() {
	   ORU_R30_PATIENT_OBSERVATION ret = null;
	   try {
	      ret = (ORU_R30_PATIENT_OBSERVATION)this.GetStructure("PATIENT_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ORU_R30_PATIENT_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ORU_R30_PATIENT_OBSERVATION GetPATIENT_OBSERVATION(int rep) { 
	   return (ORU_R30_PATIENT_OBSERVATION)this.GetStructure("PATIENT_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ORU_R30_PATIENT_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the ORU_R30_PATIENT_OBSERVATION results 
	 */ 
	public IEnumerable<ORU_R30_PATIENT_OBSERVATION> PATIENT_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENT_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (ORU_R30_PATIENT_OBSERVATION)this.GetStructure("PATIENT_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORU_R30_PATIENT_OBSERVATION
	///</summary>
	public ORU_R30_PATIENT_OBSERVATION AddPATIENT_OBSERVATION()
	{
		return this.AddStructure("PATIENT_OBSERVATION") as ORU_R30_PATIENT_OBSERVATION;
	}

	///<summary>
	///Removes the given ORU_R30_PATIENT_OBSERVATION
	///</summary>
	public void RemovePATIENT_OBSERVATION(ORU_R30_PATIENT_OBSERVATION toRemove)
	{
		this.RemoveStructure("PATIENT_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the ORU_R30_PATIENT_OBSERVATION at the given index
	///</summary>
...
get{
	...
	///<summary>
	/// Returns  first repetition of PRT3 (Participation Information) - creates it if necessary
	///</summary>
	public PRT GetPRT3() {
	   PRT ret = null;
	   try {
	      ret = (PRT)this.GetStructure("PRT3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of PRT3
	/// * (Participation Information) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public PRT GetPRT3(int rep) { 
	   return (PRT)this.GetStructure("PRT3", rep);
	}

	/** 
	 * Returns the number of existing repetitions of PRT3 
	 */ 
	public int PRT3RepetitionsUsed { 
get{
	    int reps = -1; 
	    try { 
	        reps = this.GetAll("PRT3").Length; 
	    } catch (HL7Exception e) { 
	        string message = "Unexpected error accessing data - this is probably a bug in the source code generator."; 
	        HapiLogFactory.GetHapiLog(GetType()).Error(message, e); 
	        throw new System.Exception(message);
	 ...
	 * Enumerate over the PRT results 
	 */ 
	public IEnumerable<PRT> PRT3s 
	{ 
		get
		{
			for (int rep = 0; rep < PRT3RepetitionsUsed; rep++)
			{
				yield return (PRT)this.GetStructure("PRT3", rep);
			}
		}
	}
	...
	public PRT AddPRT3()
	{
		return this.AddStructure("PRT3") as PRT;
	}

	///<summary>
	///Removes the given PRT
	///</summary>
	public void RemovePRT3(PRT toRemove)
	{
		this.RemoveStructure("PRT3", toRemove);
	}

	///<summary>
	///Removes the PRT at the given index
	///</summary>
	public void RemovePRT3At(int index)
	{
		this.RemoveRepetition("PRT3", index);
	}
