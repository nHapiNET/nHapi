...
{
///<summary>
/// Represents a OPR_O38 message structure (see chapter 4.4.17). This structure contains the 
/// following elements:
///<ol>
...
///<li>6: OPR_O38_RESPONSE (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class OPR_O38 : AbstractMessage  {

	///<summary> 
	/// Creates a new OPR_O38 Group with custom IModelClassFactory.
	///</summary>
	public OPR_O38(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new OPR_O38 Group with DefaultModelClassFactory. 
	///</summary> 
	public OPR_O38() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for OPR_O38.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(OPR_O38_RESPONSE), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OPR_O38 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	///Returns a specific repetition of OPR_O38_RESPONSE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OPR_O38_RESPONSE GetRESPONSE(int rep) { 
	   return (OPR_O38_RESPONSE)this.GetStructure("RESPONSE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OPR_O38_RESPONSE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the OPR_O38_RESPONSE results 
	 */ 
	public IEnumerable<OPR_O38_RESPONSE> RESPONSEs 
	{ 
		get
		{
			for (int rep = 0; rep < RESPONSERepetitionsUsed; rep++)
			{
				yield return (OPR_O38_RESPONSE)this.GetStructure("RESPONSE", rep);
			}
		}
	}

	///<summary>
	///Adds a new OPR_O38_RESPONSE
	///</summary>
	public OPR_O38_RESPONSE AddRESPONSE()
	{
		return this.AddStructure("RESPONSE") as OPR_O38_RESPONSE;
	}
	...
	///<summary>
	///Removes the OPR_O38_RESPONSE at the given index
	///</summary>
