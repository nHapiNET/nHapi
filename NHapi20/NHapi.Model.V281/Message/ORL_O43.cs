...
{
///<summary>
/// Represents a ORL_O43 message structure (see chapter 4.4.11.2). This structure contains the 
/// following elements:
///<ol>
...
///<li>6: ORL_O43_RESPONSE (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class ORL_O43 : AbstractMessage  {

	///<summary> 
	/// Creates a new ORL_O43 Group with custom IModelClassFactory.
	///</summary>
	public ORL_O43(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new ORL_O43 Group with DefaultModelClassFactory. 
	///</summary> 
	public ORL_O43() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for ORL_O43.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(ORL_O43_RESPONSE), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORL_O43 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns ORL_O43_RESPONSE (a Group object) - creates it if necessary
	///</summary>
	public ORL_O43_RESPONSE RESPONSE { 
get{
	   ORL_O43_RESPONSE ret = null;
	   try {
	      ret = (ORL_O43_RESPONSE)this.GetStructure("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
