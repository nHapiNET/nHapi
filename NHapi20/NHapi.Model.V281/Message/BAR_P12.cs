...
{
///<summary>
/// Represents a BAR_P12 message structure (see chapter 6.4.9). This structure contains the 
/// following elements:
///<ol>
...
///<li>8: BAR_P12_PROCEDURE (a Group object) optional repeating</li>
///<li>9: OBX (Observation/Result) optional </li>
///</ol>
///</summary>
[Serializable]
public class BAR_P12 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new BAR_P12 Group with custom IModelClassFactory.
	///</summary>
	public BAR_P12(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new BAR_P12 Group with DefaultModelClassFactory. 
	///</summary> 
	...
	///<summary>
	/// initalize method for BAR_P12.  This does the segment setup for the message. 
	///</summary> 
...
get{
	...
	/** 
	 * Enumerate over the BAR_P12_PROCEDURE results 
	 */ 
	public IEnumerable<BAR_P12_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (BAR_P12_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new BAR_P12_PROCEDURE
	///</summary>
	public BAR_P12_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as BAR_P12_PROCEDURE;
	}

	///<summary>
	///Removes the given BAR_P12_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(BAR_P12_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the BAR_P12_PROCEDURE at the given index
	///</summary>
