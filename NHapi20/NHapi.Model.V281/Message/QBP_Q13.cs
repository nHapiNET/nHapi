...
{
///<summary>
/// Represents a QBP_Q13 message structure (see chapter 5.3.1.2). This structure contains the 
/// following elements:
///<ol>
...
///<li>4: PID (Patient Identification) optional </li>
///<li>5: RDF (Table Row Definition) optional </li>
///<li>6: RCP (Response Control Parameter) </li>
///<li>7: RDF (Table Row Definition) optional </li>
...
get{
	...
	///<summary>
	/// Returns RDF2 (Table Row Definition) - creates it if necessary
	///</summary>
	public RDF RDF2 { 
get{
	   RDF ret = null;
	   try {
	      ret = (RDF)this.GetStructure("RDF2");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
