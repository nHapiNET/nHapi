...
OBX|3|FT|||This\.br\is\.br\A Test~MoreText~SomeMoreText||||||F";
		...
		public void TestOBR5RepeatingValuesMessage()
		{
			...
			Assert.IsTrue(oru.GetPATIENT_RESULT(0).ORDER_OBSERVATIONRepetitionsUsed == expectedObservationCount, string.Format("Expected 3 OBX repetitions used for this segment, found {0}", expectedObservationCount));
