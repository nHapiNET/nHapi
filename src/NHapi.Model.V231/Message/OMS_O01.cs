...
///<li>2: OMS_O01_PATIENT (a Group object) optional </li>
///<li>3: OMS_O01_ORDER (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the OMS_O01_ORDER results 
	 */ 
	public IEnumerable<OMS_O01_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (OMS_O01_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new OMS_O01_ORDER
	///</summary>
	public OMS_O01_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as OMS_O01_ORDER;
	}

	///<summary>
	///Removes the given OMS_O01_ORDER
	///</summary>
	public void RemoveORDER(OMS_O01_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the OMS_O01_ORDER at the given index
	///</summary>
