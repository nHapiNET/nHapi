...
{
///<summary>
/// Represents a ROR_R0R message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (MSH - message header segment) </li>
///<li>1: MSA (MSA - message acknowledgment segment) </li>
///<li>2: ERR (ERR - error segment) optional </li>
///<li>3: ROR_R0R_DEFINITION (a Group object) repeating</li>
...
public class ROR_R0R : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new ROR_R0R Group with custom IModelClassFactory.
	///</summary>
	public ROR_R0R(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for ROR_R0R.  This does the segment setup for the message. 
	///</summary> 
...
get{
	...
	public ROR_R0R_DEFINITION GetDEFINITION() {
	   ...
	   try {
	      ret = (ROR_R0R_DEFINITION)this.GetStructure("DEFINITION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ROR_R0R_DEFINITION GetDEFINITION(int rep) { 
	   return (ROR_R0R_DEFINITION)this.GetStructure("DEFINITION", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the ROR_R0R_DEFINITION results 
	 */ 
	public IEnumerable<ROR_R0R_DEFINITION> DEFINITIONs 
	{ 
		get
		{
			for (int rep = 0; rep < DEFINITIONRepetitionsUsed; rep++)
			{
				yield return (ROR_R0R_DEFINITION)this.GetStructure("DEFINITION", rep);
			}
		}
	}

	///<summary>
	///Adds a new ROR_R0R_DEFINITION
	///</summary>
	public ROR_R0R_DEFINITION AddDEFINITION()
	{
		return this.AddStructure("DEFINITION") as ROR_R0R_DEFINITION;
	}

	///<summary>
	///Removes the given ROR_R0R_DEFINITION
	///</summary>
	public void RemoveDEFINITION(ROR_R0R_DEFINITION toRemove)
	{
		this.RemoveStructure("DEFINITION", toRemove);
	}

	///<summary>
	///Removes the ROR_R0R_DEFINITION at the given index
	///</summary>
