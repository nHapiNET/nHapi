...
///<li>12: ADT_A13_PROCEDURE (a Group object) optional repeating</li>
///<li>13: GT1 (GT1 - guarantor segment) optional repeating</li>
///<li>14: ADT_A13_INSURANCE (a Group object) optional repeating</li>
...
get{
	...
	/** 
	 * Enumerate over the ADT_A13_PROCEDURE results 
	 */ 
	public IEnumerable<ADT_A13_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (ADT_A13_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new ADT_A13_PROCEDURE
	///</summary>
	public ADT_A13_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as ADT_A13_PROCEDURE;
	}

	///<summary>
	///Removes the given ADT_A13_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(ADT_A13_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the ADT_A13_PROCEDURE at the given index
	///</summary>
