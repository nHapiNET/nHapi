...
///<li>12: ADT_A08_PROCEDURE (a Group object) optional repeating</li>
///<li>13: GT1 (GT1 - guarantor segment) optional repeating</li>
///<li>14: ADT_A08_INSURANCE (a Group object) optional repeating</li>
...
public class ADT_A08 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(ADT_A08_PROCEDURE), false, true);
...
get{
	...
	public ADT_A08_PROCEDURE GetPROCEDURE() {
	   ...
	   try {
	      ret = (ADT_A08_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ADT_A08_PROCEDURE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ADT_A08_PROCEDURE GetPROCEDURE(int rep) { 
	   return (ADT_A08_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the ADT_A08_PROCEDURE results 
	 */ 
	public IEnumerable<ADT_A08_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (ADT_A08_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new ADT_A08_PROCEDURE
	///</summary>
	public ADT_A08_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as ADT_A08_PROCEDURE;
	}

	///<summary>
	///Removes the given ADT_A08_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(ADT_A08_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the ADT_A08_PROCEDURE at the given index
	///</summary>
