...
public class RXC : AbstractSegment  {
  ...
  /**
   * Creates a RXC (RXC - pharmacy/treatment component order segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), true, 1, 60, new System.Object[]{message}, "Component Units");
       this.add(typeof(NM), false, 1, 20, new System.Object[]{message}, "Component Strength");
       this.add(typeof(CE), false, 1, 60, new System.Object[]{message}, "Component Strength Units");
