...
public class ARQ : AbstractSegment  {
  ...
  /**
   * Creates a ARQ (ARQ - appointment request segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(XCN), true, 0, 48, new System.Object[]{message}, "Placer Contact Person");
       this.add(typeof(XTN), false, 0, 40, new System.Object[]{message}, "Placer Contact Phone Number");
