...
public class AIG : AbstractSegment  {
  ...
  /**
   * Creates a AIG (AIG - appointment information - general resource segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 1, 200, new System.Object[]{message}, "Resource ID");
       this.add(typeof(CE), true, 1, 200, new System.Object[]{message}, "Resource Type");
