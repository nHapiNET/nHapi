...
public class NPU : AbstractSegment  {
  ...
  /**
   * Creates a NPU (NPU - bed status update segment) segment object that belongs to the given 
   * message.  
   */
	public NPU(IGroup parent, IModelClassFactory factory) : base(parent,factory) {
	IMessage message = Message;
    try {
       this.add(typeof(PL), true, 1, 80, new System.Object[]{message}, "Bed Location");
