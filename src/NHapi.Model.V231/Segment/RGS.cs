...
public class RGS : AbstractSegment  {
  ...
  /**
   * Creates a RGS (RGS - resource group segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 1, 200, new System.Object[]{message}, "Resource Group ID");
