...
public class UB2 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(UVC), false, 12, 11, new System.Object[]{message}, "Value Amount and Code");
       this.add(typeof(OCD), false, 8, 11, new System.Object[]{message}, "Occurrence Code and Date (32-35)");
