...
public class AIP : AbstractSegment  {
  ...
  /**
   * Creates a AIP (AIP - appointment information - personnel resource segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(XCN), false, 0, 80, new System.Object[]{message}, "Personnel Resource ID");
       this.add(typeof(CE), true, 1, 200, new System.Object[]{message}, "Resource Role");
       this.add(typeof(CE), false, 1, 200, new System.Object[]{message}, "Resource Group");
