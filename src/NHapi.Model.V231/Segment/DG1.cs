...
public class DG1 : AbstractSegment  {
  ...
  /**
   * Creates a DG1 (DG1 - diagnosis segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 1, 60, new System.Object[]{message}, "Diagnosis Code - DG1");
       ...
       this.add(typeof(CE), false, 1, 60, new System.Object[]{message}, "Diagnostic Related Group");
       ...
       this.add(typeof(XCN), false, 0, 60, new System.Object[]{message}, "Diagnosing Clinician");
