...
{
///<summary>
///Represents the RQI_I03_PROVIDER Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RQI_I03_PROVIDER : AbstractGroup {

	///<summary> 
	/// Creates a new RQI_I03_PROVIDER Group.
	///</summary>
	public RQI_I03_PROVIDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RQI_I03_PROVIDER - this is probably a bug in the source code generator.", e);
	   }
	}
