...
{
///<summary>
///Represents the RQI_I03_GUARANTOR_INSURANCE Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: GT1 (GT1 - guarantor segment) optional repeating</li>
///<li>1: RQI_I03_INSURANCE (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class RQI_I03_GUARANTOR_INSURANCE : AbstractGroup {
	...
	///</summary>
	public RQI_I03_GUARANTOR_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	public RQI_I03_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (RQI_I03_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQI_I03_INSURANCE GetINSURANCE(int rep) { 
	   return (RQI_I03_INSURANCE)this.GetStructure("INSURANCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQI_I03_INSURANCE results 
	 */ 
	public IEnumerable<RQI_I03_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RQI_I03_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQI_I03_INSURANCE
	///</summary>
	public RQI_I03_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RQI_I03_INSURANCE;
	}

	///<summary>
	///Removes the given RQI_I03_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RQI_I03_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RQI_I03_INSURANCE at the given index
	///</summary>
