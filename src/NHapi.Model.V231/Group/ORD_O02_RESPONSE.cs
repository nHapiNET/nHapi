...
get{
	...
	/** 
	 * Enumerate over the ORD_O02_ORDER_DIET results 
	 */ 
	public IEnumerable<ORD_O02_ORDER_DIET> ORDER_DIETs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDER_DIETRepetitionsUsed; rep++)
			{
				yield return (ORD_O02_ORDER_DIET)this.GetStructure("ORDER_DIET", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORD_O02_ORDER_DIET
	///</summary>
	public ORD_O02_ORDER_DIET AddORDER_DIET()
	{
		return this.AddStructure("ORDER_DIET") as ORD_O02_ORDER_DIET;
	}
	...
	///<summary>
	///Removes the ORD_O02_ORDER_DIET at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the ORD_O02_ORDER_TRAY results 
	 */ 
	public IEnumerable<ORD_O02_ORDER_TRAY> ORDER_TRAYs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDER_TRAYRepetitionsUsed; rep++)
			{
				yield return (ORD_O02_ORDER_TRAY)this.GetStructure("ORDER_TRAY", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORD_O02_ORDER_TRAY
	///</summary>
	public ORD_O02_ORDER_TRAY AddORDER_TRAY()
	{
		return this.AddStructure("ORDER_TRAY") as ORD_O02_ORDER_TRAY;
	}

	///<summary>
	///Removes the given ORD_O02_ORDER_TRAY
	///</summary>
	public void RemoveORDER_TRAY(ORD_O02_ORDER_TRAY toRemove)
	{
		this.RemoveStructure("ORDER_TRAY", toRemove);
	}

	///<summary>
	///Removes the ORD_O02_ORDER_TRAY at the given index
	///</summary>
