...
///<ol>
///<li>0: RXA (RXA - pharmacy/treatment administration segment) repeating</li>
...
public class RRA_O02_ADMINISTRATION : AbstractGroup {
	...
	///</summary>
	public RRA_O02_ADMINISTRATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
