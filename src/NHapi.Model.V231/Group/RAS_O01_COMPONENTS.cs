...
{
///<summary>
///Represents the RAS_O01_COMPONENTS Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: RXC (RXC - pharmacy/treatment component order segment) repeating</li>
///<li>1: NTE (NTE - notes and comments segment) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class RAS_O01_COMPONENTS : AbstractGroup {

	///<summary> 
	/// Creates a new RAS_O01_COMPONENTS Group.
	///</summary>
	public RAS_O01_COMPONENTS(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(RXC), true, true);
	      this.add(typeof(NTE), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RAS_O01_COMPONENTS - this is probably a bug in the source code generator.", e);
	   }
	}
