...
get{
	...
	/** 
	 * Enumerate over the ORN_O02_ORDER results 
	 */ 
	public IEnumerable<ORN_O02_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (ORN_O02_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORN_O02_ORDER
	///</summary>
	public ORN_O02_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as ORN_O02_ORDER;
	}

	///<summary>
	///Removes the given ORN_O02_ORDER
	///</summary>
	public void RemoveORDER(ORN_O02_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the ORN_O02_ORDER at the given index
	///</summary>
