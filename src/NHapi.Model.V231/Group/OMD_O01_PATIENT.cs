...
public class OMD_O01_PATIENT : AbstractGroup {
	...
	public OMD_O01_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMD_O01_PATIENT_VISIT), false, false);
	      this.add(typeof(OMD_O01_INSURANCE), false, true);
...
get{
	   ...
	   try {
	      ret = (OMD_O01_PATIENT_VISIT)this.GetStructure("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OMD_O01_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (OMD_O01_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the OMD_O01_INSURANCE results 
	 */ 
	public IEnumerable<OMD_O01_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (OMD_O01_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new OMD_O01_INSURANCE
	///</summary>
	public OMD_O01_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as OMD_O01_INSURANCE;
	}

	///<summary>
	///Removes the given OMD_O01_INSURANCE
	///</summary>
	public void RemoveINSURANCE(OMD_O01_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the OMD_O01_INSURANCE at the given index
	///</summary>
