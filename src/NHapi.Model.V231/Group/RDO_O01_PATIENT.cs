...
get{
	...
	/** 
	 * Enumerate over the RDO_O01_INSURANCE results 
	 */ 
	public IEnumerable<RDO_O01_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RDO_O01_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDO_O01_INSURANCE
	///</summary>
	public RDO_O01_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RDO_O01_INSURANCE;
	}

	///<summary>
	///Removes the given RDO_O01_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RDO_O01_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RDO_O01_INSURANCE at the given index
	///</summary>
