...
{
///<summary>
/// Represents a RQA_I10 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: RF1 (Referral Information Segment) optional </li>
///<li>2: RQA_I10_AUTHORIZATION (a Group object) optional </li>
///<li>3: RQA_I10_PROVIDER (a Group object) repeating</li>
///<li>4: PID (Patient Identification) </li>
///<li>5: NK1 (Next of kin) optional repeating</li>
///<li>6: RQA_I10_GUARANTOR_INSURANCE (a Group object) optional </li>
...
///<li>11: RQA_I10_PROCEDURE (a Group object) optional repeating</li>
///<li>12: RQA_I10_RESULTS (a Group object) optional repeating</li>
///<li>13: RQA_I10_VISIT (a Group object) optional </li>
...
public class RQA_I10 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RQA_I10 Group with custom IModelClassFactory.
	///</summary>
	public RQA_I10(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for RQA_I10.  This does the segment setup for the message. 
	///</summary> 
...
get{
	   ...
	   try {
	      ret = (RQA_I10_AUTHORIZATION)this.GetStructure("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I10_PROVIDER GetPROVIDER() {
	   ...
	   try {
	      ret = (RQA_I10_PROVIDER)this.GetStructure("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I10_PROVIDER GetPROVIDER(int rep) { 
	   return (RQA_I10_PROVIDER)this.GetStructure("PROVIDER", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I10_PROVIDER results 
	 */ 
	public IEnumerable<RQA_I10_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RQA_I10_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I10_PROVIDER
	///</summary>
	public RQA_I10_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RQA_I10_PROVIDER;
	}

	///<summary>
	///Removes the given RQA_I10_PROVIDER
	///</summary>
	public void RemovePROVIDER(RQA_I10_PROVIDER toRemove)
	{
		this.RemoveStructure("PROVIDER", toRemove);
	}

	///<summary>
	///Removes the RQA_I10_PROVIDER at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RQA_I10_GUARANTOR_INSURANCE)this.GetStructure("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	public RQA_I10_PROCEDURE GetPROCEDURE() {
	   ...
	   try {
	      ret = (RQA_I10_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I10_PROCEDURE GetPROCEDURE(int rep) { 
	   return (RQA_I10_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I10_PROCEDURE results 
	 */ 
	public IEnumerable<RQA_I10_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (RQA_I10_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I10_PROCEDURE
	///</summary>
	public RQA_I10_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as RQA_I10_PROCEDURE;
	}

	///<summary>
	///Removes the given RQA_I10_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(RQA_I10_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the RQA_I10_PROCEDURE at the given index
	///</summary>
	...
	public RQA_I10_RESULTS GetRESULTS(int rep) { 
	   return (RQA_I10_RESULTS)this.GetStructure("RESULTS", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I10_RESULTS results 
	 */ 
	public IEnumerable<RQA_I10_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (RQA_I10_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I10_RESULTS
	///</summary>
	public RQA_I10_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as RQA_I10_RESULTS;
	}
	...
	///<summary>
	///Removes the RQA_I10_RESULTS at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RQA_I10_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
