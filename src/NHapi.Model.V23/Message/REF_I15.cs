...
{
///<summary>
/// Represents a REF_I15 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: RF1 (Referral Information Segment) optional </li>
///<li>2: REF_I15_AUTHORIZATION (a Group object) optional </li>
///<li>3: REF_I15_PROVIDER (a Group object) repeating</li>
///<li>4: PID (Patient Identification) </li>
///<li>5: NK1 (Next of kin) optional repeating</li>
///<li>6: GT1 (Guarantor) optional repeating</li>
///<li>7: REF_I15_INSURANCE (a Group object) optional repeating</li>
...
///<li>12: REF_I15_PROCEDURE (a Group object) optional repeating</li>
///<li>13: REF_I15_RESULTS (a Group object) optional repeating</li>
///<li>14: REF_I15_VISIT (a Group object) optional </li>
...
public class REF_I15 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new REF_I15 Group with custom IModelClassFactory.
	///</summary>
	public REF_I15(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for REF_I15.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      this.add(typeof(MSH), true, false);
	      this.add(typeof(RF1), false, false);
	      this.add(typeof(REF_I15_AUTHORIZATION), false, false);
	      this.add(typeof(REF_I15_PROVIDER), true, true);
	      this.add(typeof(PID), true, false);
	      this.add(typeof(NK1), false, true);
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(REF_I15_INSURANCE), false, true);
	      this.add(typeof(ACC), false, false);
	      this.add(typeof(DG1), false, true);
	      this.add(typeof(DRG), false, true);
	      this.add(typeof(AL1), false, true);
	      this.add(typeof(REF_I15_PROCEDURE), false, true);
	      this.add(typeof(REF_I15_RESULTS), false, true);
	      this.add(typeof(REF_I15_VISIT), false, false);
...
get{
	   ...
	   try {
	      ret = (REF_I15_AUTHORIZATION)this.GetStructure("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I15_PROVIDER GetPROVIDER() {
	   ...
	   try {
	      ret = (REF_I15_PROVIDER)this.GetStructure("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I15_PROVIDER GetPROVIDER(int rep) { 
	   return (REF_I15_PROVIDER)this.GetStructure("PROVIDER", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the REF_I15_PROVIDER results 
	 */ 
	public IEnumerable<REF_I15_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (REF_I15_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new REF_I15_PROVIDER
	///</summary>
	public REF_I15_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as REF_I15_PROVIDER;
	}

	///<summary>
	///Removes the given REF_I15_PROVIDER
	///</summary>
	public void RemovePROVIDER(REF_I15_PROVIDER toRemove)
	{
		this.RemoveStructure("PROVIDER", toRemove);
	}

	///<summary>
	///Removes the REF_I15_PROVIDER at the given index
	///</summary>
...
get{
	...
	public REF_I15_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (REF_I15_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I15_INSURANCE GetINSURANCE(int rep) { 
	   return (REF_I15_INSURANCE)this.GetStructure("INSURANCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the REF_I15_INSURANCE results 
	 */ 
	public IEnumerable<REF_I15_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (REF_I15_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new REF_I15_INSURANCE
	///</summary>
	public REF_I15_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as REF_I15_INSURANCE;
	}

	///<summary>
	///Removes the given REF_I15_INSURANCE
	///</summary>
	public void RemoveINSURANCE(REF_I15_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the REF_I15_INSURANCE at the given index
	///</summary>
...
get{
	...
	public REF_I15_PROCEDURE GetPROCEDURE() {
	   ...
	   try {
	      ret = (REF_I15_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I15_PROCEDURE GetPROCEDURE(int rep) { 
	   return (REF_I15_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the REF_I15_PROCEDURE results 
	 */ 
	public IEnumerable<REF_I15_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (REF_I15_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new REF_I15_PROCEDURE
	///</summary>
	public REF_I15_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as REF_I15_PROCEDURE;
	}

	///<summary>
	///Removes the given REF_I15_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(REF_I15_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the REF_I15_PROCEDURE at the given index
	///</summary>
	...
	public REF_I15_RESULTS GetRESULTS() {
	   ...
	   try {
	      ret = (REF_I15_RESULTS)this.GetStructure("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I15_RESULTS GetRESULTS(int rep) { 
	   return (REF_I15_RESULTS)this.GetStructure("RESULTS", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the REF_I15_RESULTS results 
	 */ 
	public IEnumerable<REF_I15_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (REF_I15_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new REF_I15_RESULTS
	///</summary>
	public REF_I15_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as REF_I15_RESULTS;
	}

	///<summary>
	///Removes the given REF_I15_RESULTS
	///</summary>
	public void RemoveRESULTS(REF_I15_RESULTS toRemove)
	{
		this.RemoveStructure("RESULTS", toRemove);
	}

	///<summary>
	///Removes the REF_I15_RESULTS at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (REF_I15_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
