...
get{
	...
	/** 
	 * Enumerate over the ORF_R02_QUERY_RESPONSE results 
	 */ 
	public IEnumerable<ORF_R02_QUERY_RESPONSE> QUERY_RESPONSEs 
	{ 
		get
		{
			for (int rep = 0; rep < QUERY_RESPONSERepetitionsUsed; rep++)
			{
				yield return (ORF_R02_QUERY_RESPONSE)this.GetStructure("QUERY_RESPONSE", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORF_R02_QUERY_RESPONSE
	///</summary>
	public ORF_R02_QUERY_RESPONSE AddQUERY_RESPONSE()
	{
		return this.AddStructure("QUERY_RESPONSE") as ORF_R02_QUERY_RESPONSE;
	}
	...
	///<summary>
	///Removes the ORF_R02_QUERY_RESPONSE at the given index
	///</summary>
