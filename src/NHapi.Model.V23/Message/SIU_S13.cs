...
{
///<summary>
/// Represents a SIU_S13 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
...
public class SIU_S13 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new SIU_S13 Group with custom IModelClassFactory.
	///</summary>
	public SIU_S13(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for SIU_S13.  This does the segment setup for the message. 
	///</summary> 
...
get{
	...
	/** 
	 * Enumerate over the SIU_S13_PATIENT results 
	 */ 
	public IEnumerable<SIU_S13_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SIU_S13_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S13_PATIENT
	///</summary>
	public SIU_S13_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SIU_S13_PATIENT;
	}

	///<summary>
	///Removes the given SIU_S13_PATIENT
	///</summary>
	public void RemovePATIENT(SIU_S13_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SIU_S13_PATIENT at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SIU_S13_RESOURCES results 
	 */ 
	public IEnumerable<SIU_S13_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SIU_S13_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S13_RESOURCES
	///</summary>
	public SIU_S13_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SIU_S13_RESOURCES;
	}

	///<summary>
	///Removes the given SIU_S13_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SIU_S13_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SIU_S13_RESOURCES at the given index
	///</summary>
