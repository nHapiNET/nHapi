...
{
///<summary>
/// Represents a RQI_I03 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: RQI_I03_PROVIDER (a Group object) repeating</li>
///<li>2: PID (Patient Identification) </li>
///<li>3: NK1 (Next of kin) optional repeating</li>
///<li>4: RQI_I03_GUARANTOR_INSURANCE (a Group object) optional </li>
...
public class RQI_I03 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RQI_I03 Group with custom IModelClassFactory.
	///</summary>
	public RQI_I03(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for RQI_I03.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      this.add(typeof(MSH), true, false);
	      this.add(typeof(RQI_I03_PROVIDER), true, true);
	      this.add(typeof(PID), true, false);
	      this.add(typeof(NK1), false, true);
	      this.add(typeof(RQI_I03_GUARANTOR_INSURANCE), false, false);
...
get{
	...
	public RQI_I03_PROVIDER GetPROVIDER() {
	   ...
	   try {
	      ret = (RQI_I03_PROVIDER)this.GetStructure("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQI_I03_PROVIDER GetPROVIDER(int rep) { 
	   return (RQI_I03_PROVIDER)this.GetStructure("PROVIDER", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQI_I03_PROVIDER results 
	 */ 
	public IEnumerable<RQI_I03_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RQI_I03_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQI_I03_PROVIDER
	///</summary>
	public RQI_I03_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RQI_I03_PROVIDER;
	}

	///<summary>
	///Removes the given RQI_I03_PROVIDER
	///</summary>
	public void RemovePROVIDER(RQI_I03_PROVIDER toRemove)
	{
		this.RemoveStructure("PROVIDER", toRemove);
	}

	///<summary>
	///Removes the RQI_I03_PROVIDER at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RQI_I03_GUARANTOR_INSURANCE)this.GetStructure("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
