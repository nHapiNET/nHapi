...
{
///<summary>
/// Represents a RRI_I13 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: MSA (Message acknowledgement segment) optional </li>
///<li>2: RF1 (Referral Information Segment) optional </li>
///<li>3: RRI_I13_AUTHORIZATION (a Group object) optional </li>
///<li>4: RRI_I13_PROVIDER (a Group object) repeating</li>
...
///<li>10: RRI_I13_PROCEDURE (a Group object) optional repeating</li>
///<li>11: RRI_I13_RESULTS (a Group object) optional repeating</li>
///<li>12: RRI_I13_VISIT (a Group object) optional </li>
...
public class RRI_I13 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RRI_I13 Group with custom IModelClassFactory.
	///</summary>
	public RRI_I13(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
...
get{
	   ...
	   try {
	      ret = (RRI_I13_AUTHORIZATION)this.GetStructure("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RRI_I13_PROVIDER GetPROVIDER(int rep) { 
	   return (RRI_I13_PROVIDER)this.GetStructure("PROVIDER", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RRI_I13_PROVIDER results 
	 */ 
	public IEnumerable<RRI_I13_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RRI_I13_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRI_I13_PROVIDER
	///</summary>
	public RRI_I13_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RRI_I13_PROVIDER;
	}
	...
	///<summary>
	///Removes the RRI_I13_PROVIDER at the given index
	///</summary>
...
get{
	...
	public RRI_I13_PROCEDURE GetPROCEDURE() {
	   ...
	   try {
	      ret = (RRI_I13_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RRI_I13_PROCEDURE GetPROCEDURE(int rep) { 
	   return (RRI_I13_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RRI_I13_PROCEDURE results 
	 */ 
	public IEnumerable<RRI_I13_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (RRI_I13_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRI_I13_PROCEDURE
	///</summary>
	public RRI_I13_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as RRI_I13_PROCEDURE;
	}

	///<summary>
	///Removes the given RRI_I13_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(RRI_I13_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the RRI_I13_PROCEDURE at the given index
	///</summary>
	...
	public RRI_I13_RESULTS GetRESULTS() {
	   ...
	   try {
	      ret = (RRI_I13_RESULTS)this.GetStructure("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RRI_I13_RESULTS GetRESULTS(int rep) { 
	   return (RRI_I13_RESULTS)this.GetStructure("RESULTS", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RRI_I13_RESULTS results 
	 */ 
	public IEnumerable<RRI_I13_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (RRI_I13_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRI_I13_RESULTS
	///</summary>
	public RRI_I13_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as RRI_I13_RESULTS;
	}

	///<summary>
	///Removes the given RRI_I13_RESULTS
	///</summary>
	public void RemoveRESULTS(RRI_I13_RESULTS toRemove)
	{
		this.RemoveStructure("RESULTS", toRemove);
	}

	///<summary>
	///Removes the RRI_I13_RESULTS at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RRI_I13_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
