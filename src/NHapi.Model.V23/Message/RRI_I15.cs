...
public class RRI_I15 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RRI_I15 Group with custom IModelClassFactory.
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the RRI_I15_PROVIDER results 
	 */ 
	public IEnumerable<RRI_I15_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RRI_I15_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRI_I15_PROVIDER
	///</summary>
	public RRI_I15_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RRI_I15_PROVIDER;
	}

	///<summary>
	///Removes the given RRI_I15_PROVIDER
	///</summary>
	public void RemovePROVIDER(RRI_I15_PROVIDER toRemove)
	{
		this.RemoveStructure("PROVIDER", toRemove);
	}

	///<summary>
	///Removes the RRI_I15_PROVIDER at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the RRI_I15_PROCEDURE results 
	 */ 
	public IEnumerable<RRI_I15_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (RRI_I15_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRI_I15_PROCEDURE
	///</summary>
	public RRI_I15_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as RRI_I15_PROCEDURE;
	}

	///<summary>
	///Removes the given RRI_I15_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(RRI_I15_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the RRI_I15_PROCEDURE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the RRI_I15_RESULTS results 
	 */ 
	public IEnumerable<RRI_I15_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (RRI_I15_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRI_I15_RESULTS
	///</summary>
	public RRI_I15_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as RRI_I15_RESULTS;
	}
	...
	///<summary>
	///Removes the RRI_I15_RESULTS at the given index
	///</summary>
