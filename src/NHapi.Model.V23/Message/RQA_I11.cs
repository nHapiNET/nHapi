...
{
///<summary>
/// Represents a RQA_I11 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: RF1 (Referral Information Segment) optional </li>
///<li>2: RQA_I11_AUTHORIZATION (a Group object) optional </li>
///<li>3: RQA_I11_PROVIDER (a Group object) repeating</li>
///<li>4: PID (Patient Identification) </li>
///<li>5: NK1 (Next of kin) optional repeating</li>
///<li>6: RQA_I11_GUARANTOR_INSURANCE (a Group object) optional </li>
...
///<li>11: RQA_I11_PROCEDURE (a Group object) optional repeating</li>
///<li>12: RQA_I11_RESULTS (a Group object) optional repeating</li>
///<li>13: RQA_I11_VISIT (a Group object) optional </li>
///<li>14: NTE (Notes and comments segment) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class RQA_I11 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new RQA_I11 Group with custom IModelClassFactory.
	///</summary>
	public RQA_I11(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for RQA_I11.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(RQA_I11_PROVIDER), true, true);
	      this.add(typeof(PID), true, false);
	      this.add(typeof(NK1), false, true);
	      this.add(typeof(RQA_I11_GUARANTOR_INSURANCE), false, false);
	      this.add(typeof(ACC), false, false);
	      this.add(typeof(DG1), false, true);
	      this.add(typeof(DRG), false, true);
	      this.add(typeof(AL1), false, true);
	      this.add(typeof(RQA_I11_PROCEDURE), false, true);
	      this.add(typeof(RQA_I11_RESULTS), false, true);
	      this.add(typeof(RQA_I11_VISIT), false, false);
...
get{
	...
	public RQA_I11_PROVIDER GetPROVIDER(int rep) { 
	   return (RQA_I11_PROVIDER)this.GetStructure("PROVIDER", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I11_PROVIDER results 
	 */ 
	public IEnumerable<RQA_I11_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RQA_I11_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I11_PROVIDER
	///</summary>
	public RQA_I11_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RQA_I11_PROVIDER;
	}
	...
	///<summary>
	///Removes the RQA_I11_PROVIDER at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RQA_I11_GUARANTOR_INSURANCE)this.GetStructure("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	public RQA_I11_PROCEDURE GetPROCEDURE() {
	   ...
	   try {
	      ret = (RQA_I11_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I11_PROCEDURE GetPROCEDURE(int rep) { 
	   return (RQA_I11_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I11_PROCEDURE results 
	 */ 
	public IEnumerable<RQA_I11_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (RQA_I11_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I11_PROCEDURE
	///</summary>
	public RQA_I11_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as RQA_I11_PROCEDURE;
	}

	///<summary>
	///Removes the given RQA_I11_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(RQA_I11_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the RQA_I11_PROCEDURE at the given index
	///</summary>
	...
	public RQA_I11_RESULTS GetRESULTS() {
	   ...
	   try {
	      ret = (RQA_I11_RESULTS)this.GetStructure("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I11_RESULTS GetRESULTS(int rep) { 
	   return (RQA_I11_RESULTS)this.GetStructure("RESULTS", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I11_RESULTS results 
	 */ 
	public IEnumerable<RQA_I11_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (RQA_I11_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I11_RESULTS
	///</summary>
	public RQA_I11_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as RQA_I11_RESULTS;
	}

	///<summary>
	///Removes the given RQA_I11_RESULTS
	///</summary>
	public void RemoveRESULTS(RQA_I11_RESULTS toRemove)
	{
		this.RemoveStructure("RESULTS", toRemove);
	}

	///<summary>
	///Removes the RQA_I11_RESULTS at the given index
	///</summary>
...
get{
	   ...
	   try {
	      ret = (RQA_I11_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
