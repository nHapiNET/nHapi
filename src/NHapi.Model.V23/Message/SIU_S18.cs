...
get{
	...
	/** 
	 * Enumerate over the SIU_S18_PATIENT results 
	 */ 
	public IEnumerable<SIU_S18_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SIU_S18_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S18_PATIENT
	///</summary>
	public SIU_S18_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SIU_S18_PATIENT;
	}

	///<summary>
	///Removes the given SIU_S18_PATIENT
	///</summary>
	public void RemovePATIENT(SIU_S18_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SIU_S18_PATIENT at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SIU_S18_RESOURCES results 
	 */ 
	public IEnumerable<SIU_S18_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SIU_S18_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S18_RESOURCES
	///</summary>
	public SIU_S18_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SIU_S18_RESOURCES;
	}

	///<summary>
	///Removes the given SIU_S18_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SIU_S18_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SIU_S18_RESOURCES at the given index
	///</summary>
