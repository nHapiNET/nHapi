...
get{
	...
	/** 
	 * Enumerate over the SRM_S06_PATIENT results 
	 */ 
	public IEnumerable<SRM_S06_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SRM_S06_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S06_PATIENT
	///</summary>
	public SRM_S06_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SRM_S06_PATIENT;
	}

	///<summary>
	///Removes the given SRM_S06_PATIENT
	///</summary>
	public void RemovePATIENT(SRM_S06_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SRM_S06_PATIENT at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRM_S06_RESOURCES results 
	 */ 
	public IEnumerable<SRM_S06_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SRM_S06_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S06_RESOURCES
	///</summary>
	public SRM_S06_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SRM_S06_RESOURCES;
	}

	///<summary>
	///Removes the given SRM_S06_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SRM_S06_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SRM_S06_RESOURCES at the given index
	///</summary>
