...
{
///<summary>
/// Represents a REF_I12 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: RF1 (Referral Information Segment) optional </li>
///<li>2: REF_I12_AUTHORIZATION (a Group object) optional </li>
...
///<li>13: REF_I12_RESULTS (a Group object) optional repeating</li>
///<li>14: REF_I12_VISIT (a Group object) optional </li>
...
public class REF_I12 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(REF_I12_AUTHORIZATION), false, false);
	      ...
	      this.add(typeof(REF_I12_RESULTS), false, true);
	      this.add(typeof(REF_I12_VISIT), false, false);
...
get{
	...
	///</summary>
	public REF_I12_AUTHORIZATION AUTHORIZATION { 
get{
	   REF_I12_AUTHORIZATION ret = null;
	   try {
	      ret = (REF_I12_AUTHORIZATION)this.GetStructure("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	///<summary>
	/// Returns  first repetition of REF_I12_RESULTS (a Group object) - creates it if necessary
	///</summary>
	public REF_I12_RESULTS GetRESULTS() {
	   REF_I12_RESULTS ret = null;
	   try {
	      ret = (REF_I12_RESULTS)this.GetStructure("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of REF_I12_RESULTS
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public REF_I12_RESULTS GetRESULTS(int rep) { 
	   return (REF_I12_RESULTS)this.GetStructure("RESULTS", rep);
	}

	/** 
	 * Returns the number of existing repetitions of REF_I12_RESULTS 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the REF_I12_RESULTS results 
	 */ 
	public IEnumerable<REF_I12_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (REF_I12_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new REF_I12_RESULTS
	///</summary>
	public REF_I12_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as REF_I12_RESULTS;
	}

	///<summary>
	///Removes the given REF_I12_RESULTS
	///</summary>
	public void RemoveRESULTS(REF_I12_RESULTS toRemove)
	{
		this.RemoveStructure("RESULTS", toRemove);
	}

	///<summary>
	///Removes the REF_I12_RESULTS at the given index
	///</summary>
	...
	///<summary>
	/// Returns REF_I12_VISIT (a Group object) - creates it if necessary
	///</summary>
	public REF_I12_VISIT VISIT { 
get{
	   REF_I12_VISIT ret = null;
	   try {
	      ret = (REF_I12_VISIT)this.GetStructure("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
