...
{
///<summary>
/// Represents a SRM_S02 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
...
///<li>4: SRM_S02_PATIENT (a Group object) optional repeating</li>
///<li>5: SRM_S02_RESOURCES (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class SRM_S02 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new SRM_S02 Group with custom IModelClassFactory.
	///</summary>
	public SRM_S02(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for SRM_S02.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(SRM_S02_PATIENT), false, true);
	      this.add(typeof(SRM_S02_RESOURCES), true, true);
...
get{
	...
	public SRM_S02_PATIENT GetPATIENT() {
	   ...
	   try {
	      ret = (SRM_S02_PATIENT)this.GetStructure("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S02_PATIENT GetPATIENT(int rep) { 
	   return (SRM_S02_PATIENT)this.GetStructure("PATIENT", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRM_S02_PATIENT results 
	 */ 
	public IEnumerable<SRM_S02_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SRM_S02_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S02_PATIENT
	///</summary>
	public SRM_S02_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SRM_S02_PATIENT;
	}

	///<summary>
	///Removes the given SRM_S02_PATIENT
	///</summary>
	public void RemovePATIENT(SRM_S02_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SRM_S02_PATIENT at the given index
	///</summary>
	...
	public SRM_S02_RESOURCES GetRESOURCES() {
	   ...
	   try {
	      ret = (SRM_S02_RESOURCES)this.GetStructure("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S02_RESOURCES GetRESOURCES(int rep) { 
	   return (SRM_S02_RESOURCES)this.GetStructure("RESOURCES", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRM_S02_RESOURCES results 
	 */ 
	public IEnumerable<SRM_S02_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SRM_S02_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S02_RESOURCES
	///</summary>
	public SRM_S02_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SRM_S02_RESOURCES;
	}

	///<summary>
	///Removes the given SRM_S02_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SRM_S02_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SRM_S02_RESOURCES at the given index
	///</summary>
