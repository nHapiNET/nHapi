...
get{
	...
	/** 
	 * Enumerate over the CRM_C04_PATIENT results 
	 */ 
	public IEnumerable<CRM_C04_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (CRM_C04_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new CRM_C04_PATIENT
	///</summary>
	public CRM_C04_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as CRM_C04_PATIENT;
	}

	///<summary>
	///Removes the given CRM_C04_PATIENT
	///</summary>
	public void RemovePATIENT(CRM_C04_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the CRM_C04_PATIENT at the given index
	///</summary>
