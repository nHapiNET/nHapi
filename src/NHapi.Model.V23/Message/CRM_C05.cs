...
get{
	...
	/** 
	 * Enumerate over the CRM_C05_PATIENT results 
	 */ 
	public IEnumerable<CRM_C05_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (CRM_C05_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new CRM_C05_PATIENT
	///</summary>
	public CRM_C05_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as CRM_C05_PATIENT;
	}

	///<summary>
	///Removes the given CRM_C05_PATIENT
	///</summary>
	public void RemovePATIENT(CRM_C05_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the CRM_C05_PATIENT at the given index
	///</summary>
