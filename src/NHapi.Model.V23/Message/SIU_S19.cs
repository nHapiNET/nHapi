...
{
///<summary>
/// Represents a SIU_S19 message structure (see chapter [AAA]). This structure contains the 
/// following elements:
///<ol>
///<li>0: MSH (Message header segment) </li>
///<li>1: SCH (Schedule Activity Information) </li>
///<li>2: NTE (Notes and comments segment) optional repeating</li>
///<li>3: SIU_S19_PATIENT (a Group object) optional repeating</li>
///<li>4: SIU_S19_RESOURCES (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class SIU_S19 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new SIU_S19 Group with custom IModelClassFactory.
	///</summary>
	public SIU_S19(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for SIU_S19.  This does the segment setup for the message. 
	///</summary> 
...
get{
	...
	public SIU_S19_PATIENT GetPATIENT() {
	   ...
	   try {
	      ret = (SIU_S19_PATIENT)this.GetStructure("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S19_PATIENT GetPATIENT(int rep) { 
	   return (SIU_S19_PATIENT)this.GetStructure("PATIENT", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SIU_S19_PATIENT results 
	 */ 
	public IEnumerable<SIU_S19_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SIU_S19_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S19_PATIENT
	///</summary>
	public SIU_S19_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SIU_S19_PATIENT;
	}

	///<summary>
	///Removes the given SIU_S19_PATIENT
	///</summary>
	public void RemovePATIENT(SIU_S19_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SIU_S19_PATIENT at the given index
	///</summary>
	...
	public SIU_S19_RESOURCES GetRESOURCES() {
	   ...
	   try {
	      ret = (SIU_S19_RESOURCES)this.GetStructure("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S19_RESOURCES GetRESOURCES(int rep) { 
	   return (SIU_S19_RESOURCES)this.GetStructure("RESOURCES", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SIU_S19_RESOURCES results 
	 */ 
	public IEnumerable<SIU_S19_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SIU_S19_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S19_RESOURCES
	///</summary>
	public SIU_S19_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SIU_S19_RESOURCES;
	}

	///<summary>
	///Removes the given SIU_S19_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SIU_S19_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SIU_S19_RESOURCES at the given index
	///</summary>
