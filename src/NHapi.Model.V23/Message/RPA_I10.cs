...
get{
	...
	/** 
	 * Enumerate over the RPA_I10_PROVIDER results 
	 */ 
	public IEnumerable<RPA_I10_PROVIDER> PROVIDERs 
	{ 
		get
		{
			for (int rep = 0; rep < PROVIDERRepetitionsUsed; rep++)
			{
				yield return (RPA_I10_PROVIDER)this.GetStructure("PROVIDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I10_PROVIDER
	///</summary>
	public RPA_I10_PROVIDER AddPROVIDER()
	{
		return this.AddStructure("PROVIDER") as RPA_I10_PROVIDER;
	}

	///<summary>
	///Removes the given RPA_I10_PROVIDER
	///</summary>
	public void RemovePROVIDER(RPA_I10_PROVIDER toRemove)
	{
		this.RemoveStructure("PROVIDER", toRemove);
	}

	///<summary>
	///Removes the RPA_I10_PROVIDER at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the RPA_I10_INSURANCE results 
	 */ 
	public IEnumerable<RPA_I10_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RPA_I10_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I10_INSURANCE
	///</summary>
	public RPA_I10_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RPA_I10_INSURANCE;
	}

	///<summary>
	///Removes the given RPA_I10_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RPA_I10_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RPA_I10_INSURANCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the RPA_I10_PROCEDURE results 
	 */ 
	public IEnumerable<RPA_I10_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (RPA_I10_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I10_PROCEDURE
	///</summary>
	public RPA_I10_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as RPA_I10_PROCEDURE;
	}

	///<summary>
	///Removes the given RPA_I10_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(RPA_I10_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the RPA_I10_PROCEDURE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the RPA_I10_RESULTS results 
	 */ 
	public IEnumerable<RPA_I10_RESULTS> RESULTSs 
	{ 
		get
		{
			for (int rep = 0; rep < RESULTSRepetitionsUsed; rep++)
			{
				yield return (RPA_I10_RESULTS)this.GetStructure("RESULTS", rep);
			}
		}
	}

	///<summary>
	///Adds a new RPA_I10_RESULTS
	///</summary>
	public RPA_I10_RESULTS AddRESULTS()
	{
		return this.AddStructure("RESULTS") as RPA_I10_RESULTS;
	}

	///<summary>
	///Removes the given RPA_I10_RESULTS
	///</summary>
	public void RemoveRESULTS(RPA_I10_RESULTS toRemove)
	{
		this.RemoveStructure("RESULTS", toRemove);
	}

	///<summary>
	///Removes the RPA_I10_RESULTS at the given index
	///</summary>
