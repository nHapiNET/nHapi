...
///<li>PTH-5: Pathway Lifecycle Status (CE)</li>
///<li>PTH-6: Change Pathway Lifecycle Status Date/Time (TS)</li>
///</ol>
...
public class PTH : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CE), true, 1, 80, new System.Object[]{message}, "Pathway ID");
       this.add(typeof(EI), true, 1, 60, new System.Object[]{message}, "Pathway Instance ID");
       this.add(typeof(TS), true, 1, 26, new System.Object[]{message}, "Pathway Established Date/Time");
       this.add(typeof(CE), false, 1, 80, new System.Object[]{message}, "Pathway Lifecycle Status");
       this.add(typeof(TS), false, 1, 26, new System.Object[]{message}, "Change Pathway Lifecycle Status Date/Time");
	...
	///<summary>
	/// Returns Pathway Lifecycle Status(PTH-5).
	///</summary>
	...
	///<summary>
	/// Returns Change Pathway Lifecycle Status Date/Time(PTH-6).
	///</summary>
