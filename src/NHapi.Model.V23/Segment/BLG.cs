...
public class BLG : AbstractSegment  {
  ...
  /**
   * Creates a BLG (Billing Segment) segment object that belongs to the given 
   * message.  
   */
    ...
    try {
       ...
       this.add(typeof(CK), false, 1, 100, new System.Object[]{message}, "Account ID");
