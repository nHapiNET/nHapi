...
///<li>OM5-2: Test/Observations Included w/an Ordered Test Battery (CE)</li>
...
public class OM5 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CE), false, 0, 200, new System.Object[]{message}, "Test/Observations Included w/an Ordered Test Battery");
	...
	///<summary>
	/// Returns a single repetition of Test/Observations Included w/an Ordered Test Battery(OM5-2).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
	public CE GetTestObservationsIncludedWAnOrderedTestBattery(int rep)
	{
			CE ret = null;
			try
			{
  ...
  /// Returns all repetitions of Test/Observations Included w/an Ordered Test Battery (OM5-2).
   ///</summary>
  public CE[] GetTestObservationsIncludedWAnOrderedTestBattery() {
     CE[] ret = null;
    try {
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Test/Observations Included w/an Ordered Test Battery (OM5-2).
   ///</summary>
  public int TestObservationsIncludedWAnOrderedTestBatteryRepetitionsUsed
{
get{
    try {
