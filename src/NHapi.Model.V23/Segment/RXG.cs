...
///<li>RXG-1: Give Sub-ID Counter (ID)</li>
...
///<li>RXG-11: Dispense-To Location (CM_LA1)</li>
...
public class RXG : AbstractSegment  {
  ...
  /**
   * Creates a RXG (Pharmacy give segment) segment object that belongs to the given 
   * message.  
   */
	public RXG(IGroup parent, IModelClassFactory factory) : base(parent,factory) {
	IMessage message = Message;
    try {
       this.add(typeof(ID), false, 1, 4, new System.Object[]{message, 0}, "Give Sub-ID Counter");
       ...
       this.add(typeof(CM_LA1), false, 1, 200, new System.Object[]{message}, "Dispense-To Location");
       this.add(typeof(ID), false, 1, 1, new System.Object[]{message, 136}, "Needs Human Review");
       this.add(typeof(CE), false, 1, 200, new System.Object[]{message}, "Pharmacy Special Administration Instructions");
...
get{
	...
	///<summary>
	/// Returns Pharmacy Special Administration Instructions(RXG-13).
	///</summary>
