...
public class QRD : AbstractSegment  {
  ...
  /**
   * Creates a QRD (Query definition segment) segment object that belongs to the given 
   * message.  
   */
	public QRD(IGroup parent, IModelClassFactory factory) : base(parent,factory) {
	IMessage message = Message;
    try {
       this.add(typeof(TS), false, 1, 26, new System.Object[]{message}, "Query Date/Time");
       ...
       this.add(typeof(XCN), true, 0, 60, new System.Object[]{message}, "Who Subject Filter");
       this.add(typeof(CE), true, 0, 60, new System.Object[]{message}, "What Subject Filter");
       this.add(typeof(CE), true, 0, 60, new System.Object[]{message}, "What Department Data Code");
