...
{
///<summary>
///Represents the PPR_PC3_PATHWAY Group.  A Group is an ordered collection of message 
...
public class PPR_PC3_PATHWAY : AbstractGroup {
	...
	///</summary>
	public PPR_PC3_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
