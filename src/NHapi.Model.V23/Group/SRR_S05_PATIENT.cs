...
{
///<summary>
///Represents the SRR_S05_PATIENT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SRR_S05_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new SRR_S05_PATIENT Group.
	///</summary>
	public SRR_S05_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRR_S05_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
