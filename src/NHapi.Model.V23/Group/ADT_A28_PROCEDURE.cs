...
{
///<summary>
///Represents the ADT_A28_PROCEDURE Group.  A Group is an ordered collection of message 
...
public class ADT_A28_PROCEDURE : AbstractGroup {
	...
	///</summary>
	public ADT_A28_PROCEDURE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
