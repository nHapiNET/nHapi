...
{
///<summary>
///Represents the PPP_PCD_PATHWAY_ROLE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PPP_PCD_PATHWAY_ROLE : AbstractGroup {

	///<summary> 
	/// Creates a new PPP_PCD_PATHWAY_ROLE Group.
	///</summary>
	public PPP_PCD_PATHWAY_ROLE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PPP_PCD_PATHWAY_ROLE - this is probably a bug in the source code generator.", e);
	   }
	}
