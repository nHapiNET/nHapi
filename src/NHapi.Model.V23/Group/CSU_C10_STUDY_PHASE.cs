...
{
///<summary>
///Represents the CSU_C10_STUDY_PHASE Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: CSP (Clinical Study Phase) optional </li>
///<li>1: CSU_C10_STUDY_SCHEDULE (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class CSU_C10_STUDY_PHASE : AbstractGroup {
	...
	///</summary>
	public CSU_C10_STUDY_PHASE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	public CSU_C10_STUDY_SCHEDULE GetSTUDY_SCHEDULE() {
	   ...
	   try {
	      ret = (CSU_C10_STUDY_SCHEDULE)this.GetStructure("STUDY_SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C10_STUDY_SCHEDULE GetSTUDY_SCHEDULE(int rep) { 
	   return (CSU_C10_STUDY_SCHEDULE)this.GetStructure("STUDY_SCHEDULE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the CSU_C10_STUDY_SCHEDULE results 
	 */ 
	public IEnumerable<CSU_C10_STUDY_SCHEDULE> STUDY_SCHEDULEs 
	{ 
		get
		{
			for (int rep = 0; rep < STUDY_SCHEDULERepetitionsUsed; rep++)
			{
				yield return (CSU_C10_STUDY_SCHEDULE)this.GetStructure("STUDY_SCHEDULE", rep);
			}
		}
	}

	///<summary>
	///Adds a new CSU_C10_STUDY_SCHEDULE
	///</summary>
	public CSU_C10_STUDY_SCHEDULE AddSTUDY_SCHEDULE()
	{
		return this.AddStructure("STUDY_SCHEDULE") as CSU_C10_STUDY_SCHEDULE;
	}

	///<summary>
	///Removes the given CSU_C10_STUDY_SCHEDULE
	///</summary>
	public void RemoveSTUDY_SCHEDULE(CSU_C10_STUDY_SCHEDULE toRemove)
	{
		this.RemoveStructure("STUDY_SCHEDULE", toRemove);
	}

	///<summary>
	///Removes the CSU_C10_STUDY_SCHEDULE at the given index
	///</summary>
