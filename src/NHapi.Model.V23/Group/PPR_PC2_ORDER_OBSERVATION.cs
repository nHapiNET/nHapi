...
{
///<summary>
///Represents the PPR_PC2_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PPR_PC2_ORDER_OBSERVATION : AbstractGroup {

	///<summary> 
	/// Creates a new PPR_PC2_ORDER_OBSERVATION Group.
	///</summary>
	public PPR_PC2_ORDER_OBSERVATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(OBX), true, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PPR_PC2_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
