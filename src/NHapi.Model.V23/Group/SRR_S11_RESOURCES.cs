...
{
///<summary>
///Represents the SRR_S11_RESOURCES Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: RGS (Resource Group) </li>
///<li>1: SRR_S11_SERVICE (a Group object) optional repeating</li>
///<li>2: SRR_S11_GENERAL_RESOURCE (a Group object) optional repeating</li>
///<li>3: SRR_S11_LOCATION_RESOURCE (a Group object) optional repeating</li>
///<li>4: SRR_S11_PERSONNEL_RESOURCE (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class SRR_S11_RESOURCES : AbstractGroup {
	...
	///</summary>
	public SRR_S11_RESOURCES(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	public SRR_S11_SERVICE GetSERVICE() {
	   ...
	   try {
	      ret = (SRR_S11_SERVICE)this.GetStructure("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S11_SERVICE GetSERVICE(int rep) { 
	   return (SRR_S11_SERVICE)this.GetStructure("SERVICE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRR_S11_SERVICE results 
	 */ 
	public IEnumerable<SRR_S11_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SRR_S11_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S11_SERVICE
	///</summary>
	public SRR_S11_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SRR_S11_SERVICE;
	}

	///<summary>
	///Removes the given SRR_S11_SERVICE
	///</summary>
	public void RemoveSERVICE(SRR_S11_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SRR_S11_SERVICE at the given index
	///</summary>
	...
	public SRR_S11_GENERAL_RESOURCE GetGENERAL_RESOURCE() {
	   ...
	   try {
	      ret = (SRR_S11_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S11_GENERAL_RESOURCE GetGENERAL_RESOURCE(int rep) { 
	   return (SRR_S11_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRR_S11_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S11_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S11_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S11_GENERAL_RESOURCE
	///</summary>
	public SRR_S11_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SRR_S11_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S11_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SRR_S11_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S11_GENERAL_RESOURCE at the given index
	///</summary>
	...
	public SRR_S11_LOCATION_RESOURCE GetLOCATION_RESOURCE() {
	   ...
	   try {
	      ret = (SRR_S11_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S11_LOCATION_RESOURCE GetLOCATION_RESOURCE(int rep) { 
	   return (SRR_S11_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRR_S11_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S11_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S11_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S11_LOCATION_RESOURCE
	///</summary>
	public SRR_S11_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SRR_S11_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S11_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SRR_S11_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S11_LOCATION_RESOURCE at the given index
	///</summary>
	...
	public SRR_S11_PERSONNEL_RESOURCE GetPERSONNEL_RESOURCE() {
	   ...
	   try {
	      ret = (SRR_S11_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S11_PERSONNEL_RESOURCE GetPERSONNEL_RESOURCE(int rep) { 
	   return (SRR_S11_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRR_S11_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S11_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S11_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S11_PERSONNEL_RESOURCE
	///</summary>
	public SRR_S11_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SRR_S11_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S11_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SRR_S11_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S11_PERSONNEL_RESOURCE at the given index
	///</summary>
