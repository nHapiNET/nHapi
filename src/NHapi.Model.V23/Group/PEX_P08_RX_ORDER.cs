...
{
///<summary>
///Represents the PEX_P08_RX_ORDER Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: RXE (Pharmacy encoded order segment) </li>
///<li>1: RXR (Pharmacy route segment) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class PEX_P08_RX_ORDER : AbstractGroup {

	///<summary> 
	/// Creates a new PEX_P08_RX_ORDER Group.
	///</summary>
	public PEX_P08_RX_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(RXE), true, false);
	      this.add(typeof(RXR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PEX_P08_RX_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
