...
get{
	...
	/** 
	 * Enumerate over the RRG_O02_ORDER results 
	 */ 
	public IEnumerable<RRG_O02_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (RRG_O02_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new RRG_O02_ORDER
	///</summary>
	public RRG_O02_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as RRG_O02_ORDER;
	}

	///<summary>
	///Removes the given RRG_O02_ORDER
	///</summary>
	public void RemoveORDER(RRG_O02_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the RRG_O02_ORDER at the given index
	///</summary>
