...
///<li>1: SRR_S03_SERVICE (a Group object) optional repeating</li>
///<li>2: SRR_S03_GENERAL_RESOURCE (a Group object) optional repeating</li>
///<li>3: SRR_S03_LOCATION_RESOURCE (a Group object) optional repeating</li>
///<li>4: SRR_S03_PERSONNEL_RESOURCE (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the SRR_S03_SERVICE results 
	 */ 
	public IEnumerable<SRR_S03_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SRR_S03_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S03_SERVICE
	///</summary>
	public SRR_S03_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SRR_S03_SERVICE;
	}

	///<summary>
	///Removes the given SRR_S03_SERVICE
	///</summary>
	public void RemoveSERVICE(SRR_S03_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SRR_S03_SERVICE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRR_S03_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S03_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S03_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S03_GENERAL_RESOURCE
	///</summary>
	public SRR_S03_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SRR_S03_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S03_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SRR_S03_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S03_GENERAL_RESOURCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRR_S03_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S03_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S03_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S03_LOCATION_RESOURCE
	///</summary>
	public SRR_S03_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SRR_S03_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S03_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SRR_S03_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S03_LOCATION_RESOURCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRR_S03_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S03_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S03_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S03_PERSONNEL_RESOURCE
	///</summary>
	public SRR_S03_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SRR_S03_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S03_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SRR_S03_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S03_PERSONNEL_RESOURCE at the given index
	///</summary>
