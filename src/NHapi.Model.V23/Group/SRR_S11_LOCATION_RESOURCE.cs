...
{
///<summary>
///Represents the SRR_S11_LOCATION_RESOURCE Group.  A Group is an ordered collection of message 
...
public class SRR_S11_LOCATION_RESOURCE : AbstractGroup {
	...
	///</summary>
	public SRR_S11_LOCATION_RESOURCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
