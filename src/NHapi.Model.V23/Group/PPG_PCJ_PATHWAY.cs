...
///<li>3: PPG_PCJ_PATHWAY_ROLE (a Group object) optional repeating</li>
///<li>4: PPG_PCJ_GOAL (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class PPG_PCJ_PATHWAY : AbstractGroup {
	...
	///</summary>
	public PPG_PCJ_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	/** 
	 * Enumerate over the PPG_PCJ_PATHWAY_ROLE results 
	 */ 
	public IEnumerable<PPG_PCJ_PATHWAY_ROLE> PATHWAY_ROLEs 
	{ 
		get
		{
			for (int rep = 0; rep < PATHWAY_ROLERepetitionsUsed; rep++)
			{
				yield return (PPG_PCJ_PATHWAY_ROLE)this.GetStructure("PATHWAY_ROLE", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPG_PCJ_PATHWAY_ROLE
	///</summary>
	public PPG_PCJ_PATHWAY_ROLE AddPATHWAY_ROLE()
	{
		return this.AddStructure("PATHWAY_ROLE") as PPG_PCJ_PATHWAY_ROLE;
	}

	///<summary>
	///Removes the given PPG_PCJ_PATHWAY_ROLE
	///</summary>
	public void RemovePATHWAY_ROLE(PPG_PCJ_PATHWAY_ROLE toRemove)
	{
		this.RemoveStructure("PATHWAY_ROLE", toRemove);
	}

	///<summary>
	///Removes the PPG_PCJ_PATHWAY_ROLE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPG_PCJ_GOAL results 
	 */ 
	public IEnumerable<PPG_PCJ_GOAL> GOALs 
	{ 
		get
		{
			for (int rep = 0; rep < GOALRepetitionsUsed; rep++)
			{
				yield return (PPG_PCJ_GOAL)this.GetStructure("GOAL", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPG_PCJ_GOAL
	///</summary>
	public PPG_PCJ_GOAL AddGOAL()
	{
		return this.AddStructure("GOAL") as PPG_PCJ_GOAL;
	}

	///<summary>
	///Removes the given PPG_PCJ_GOAL
	///</summary>
	public void RemoveGOAL(PPG_PCJ_GOAL toRemove)
	{
		this.RemoveStructure("GOAL", toRemove);
	}

	///<summary>
	///Removes the PPG_PCJ_GOAL at the given index
	///</summary>
