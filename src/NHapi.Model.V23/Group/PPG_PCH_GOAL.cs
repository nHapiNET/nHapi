...
get{
	...
	/** 
	 * Enumerate over the PPG_PCH_GOAL_ROLE results 
	 */ 
	public IEnumerable<PPG_PCH_GOAL_ROLE> GOAL_ROLEs 
	{ 
		get
		{
			for (int rep = 0; rep < GOAL_ROLERepetitionsUsed; rep++)
			{
				yield return (PPG_PCH_GOAL_ROLE)this.GetStructure("GOAL_ROLE", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPG_PCH_GOAL_ROLE
	///</summary>
	public PPG_PCH_GOAL_ROLE AddGOAL_ROLE()
	{
		return this.AddStructure("GOAL_ROLE") as PPG_PCH_GOAL_ROLE;
	}

	///<summary>
	///Removes the given PPG_PCH_GOAL_ROLE
	///</summary>
	public void RemoveGOAL_ROLE(PPG_PCH_GOAL_ROLE toRemove)
	{
		this.RemoveStructure("GOAL_ROLE", toRemove);
	}

	///<summary>
	///Removes the PPG_PCH_GOAL_ROLE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPG_PCH_GOAL_OBSERVATION results 
	 */ 
	public IEnumerable<PPG_PCH_GOAL_OBSERVATION> GOAL_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < GOAL_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (PPG_PCH_GOAL_OBSERVATION)this.GetStructure("GOAL_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPG_PCH_GOAL_OBSERVATION
	///</summary>
	public PPG_PCH_GOAL_OBSERVATION AddGOAL_OBSERVATION()
	{
		return this.AddStructure("GOAL_OBSERVATION") as PPG_PCH_GOAL_OBSERVATION;
	}

	///<summary>
	///Removes the given PPG_PCH_GOAL_OBSERVATION
	///</summary>
	public void RemoveGOAL_OBSERVATION(PPG_PCH_GOAL_OBSERVATION toRemove)
	{
		this.RemoveStructure("GOAL_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the PPG_PCH_GOAL_OBSERVATION at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPG_PCH_PROBLEM results 
	 */ 
	public IEnumerable<PPG_PCH_PROBLEM> PROBLEMs 
	{ 
		get
		{
			for (int rep = 0; rep < PROBLEMRepetitionsUsed; rep++)
			{
				yield return (PPG_PCH_PROBLEM)this.GetStructure("PROBLEM", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPG_PCH_PROBLEM
	///</summary>
	public PPG_PCH_PROBLEM AddPROBLEM()
	{
		return this.AddStructure("PROBLEM") as PPG_PCH_PROBLEM;
	}

	///<summary>
	///Removes the given PPG_PCH_PROBLEM
	///</summary>
	public void RemovePROBLEM(PPG_PCH_PROBLEM toRemove)
	{
		this.RemoveStructure("PROBLEM", toRemove);
	}

	///<summary>
	///Removes the PPG_PCH_PROBLEM at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPG_PCH_ORDER results 
	 */ 
	public IEnumerable<PPG_PCH_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (PPG_PCH_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPG_PCH_ORDER
	///</summary>
	public PPG_PCH_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as PPG_PCH_ORDER;
	}

	///<summary>
	///Removes the given PPG_PCH_ORDER
	///</summary>
	public void RemoveORDER(PPG_PCH_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the PPG_PCH_ORDER at the given index
	///</summary>
