...
{
///<summary>
///Represents the SRR_S11_SCHEDULE Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: SCH (Schedule Activity Information) </li>
///<li>1: NTE (Notes and comments segment) optional repeating</li>
///<li>2: SRR_S11_PATIENT (a Group object) optional repeating</li>
///<li>3: SRR_S11_RESOURCES (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class SRR_S11_SCHEDULE : AbstractGroup {
	...
	///</summary>
	public SRR_S11_SCHEDULE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(SCH), true, false);
	      this.add(typeof(NTE), false, true);
	      this.add(typeof(SRR_S11_PATIENT), false, true);
	      this.add(typeof(SRR_S11_RESOURCES), true, true);
...
get{
	...
	public SRR_S11_PATIENT GetPATIENT() {
	   ...
	   try {
	      ret = (SRR_S11_PATIENT)this.GetStructure("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S11_PATIENT GetPATIENT(int rep) { 
	   return (SRR_S11_PATIENT)this.GetStructure("PATIENT", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRR_S11_PATIENT results 
	 */ 
	public IEnumerable<SRR_S11_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SRR_S11_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S11_PATIENT
	///</summary>
	public SRR_S11_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SRR_S11_PATIENT;
	}

	///<summary>
	///Removes the given SRR_S11_PATIENT
	///</summary>
	public void RemovePATIENT(SRR_S11_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SRR_S11_PATIENT at the given index
	///</summary>
	...
	public SRR_S11_RESOURCES GetRESOURCES(int rep) { 
	   return (SRR_S11_RESOURCES)this.GetStructure("RESOURCES", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the SRR_S11_RESOURCES results 
	 */ 
	public IEnumerable<SRR_S11_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SRR_S11_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S11_RESOURCES
	///</summary>
	public SRR_S11_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SRR_S11_RESOURCES;
	}
	...
	///<summary>
	///Removes the SRR_S11_RESOURCES at the given index
	///</summary>
