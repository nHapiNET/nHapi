...
{
///<summary>
///Represents the RQA_I11_GUARANTOR_INSURANCE Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: GT1 (Guarantor) optional repeating</li>
///<li>1: RQA_I11_INSURANCE (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class RQA_I11_GUARANTOR_INSURANCE : AbstractGroup {
	...
	///</summary>
	public RQA_I11_GUARANTOR_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(RQA_I11_INSURANCE), true, true);
...
get{
	...
	public RQA_I11_INSURANCE GetINSURANCE() {
	   ...
	   try {
	      ret = (RQA_I11_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I11_INSURANCE GetINSURANCE(int rep) { 
	   return (RQA_I11_INSURANCE)this.GetStructure("INSURANCE", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RQA_I11_INSURANCE results 
	 */ 
	public IEnumerable<RQA_I11_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RQA_I11_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I11_INSURANCE
	///</summary>
	public RQA_I11_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RQA_I11_INSURANCE;
	}

	///<summary>
	///Removes the given RQA_I11_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RQA_I11_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RQA_I11_INSURANCE at the given index
	///</summary>
