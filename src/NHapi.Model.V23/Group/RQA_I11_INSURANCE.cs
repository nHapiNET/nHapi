...
public class RQA_I11_INSURANCE : AbstractGroup {
	...
	///<summary> 
	/// Creates a new RQA_I11_INSURANCE Group.
	///</summary>
	public RQA_I11_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(IN1), true, false);
	      this.add(typeof(IN2), false, false);
	      this.add(typeof(IN3), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RQA_I11_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
