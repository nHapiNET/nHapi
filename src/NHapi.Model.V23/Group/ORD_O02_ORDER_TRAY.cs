...
///<li>1: ODT (Diet tray instructions segment) optional repeating</li>
...
public class ORD_O02_ORDER_TRAY : AbstractGroup {
	...
	public ORD_O02_ORDER_TRAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORD_O02_ORDER_TRAY - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns  first repetition of ODT (Diet tray instructions segment) - creates it if necessary
	///</summary>
	public ODT GetODT() {
	   ODT ret = null;
	   try {
	...
	/// * (Diet tray instructions segment) - creates it if necessary
