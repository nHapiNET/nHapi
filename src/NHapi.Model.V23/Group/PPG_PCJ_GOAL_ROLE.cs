...
{
///<summary>
///Represents the PPG_PCJ_GOAL_ROLE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PPG_PCJ_GOAL_ROLE : AbstractGroup {

	///<summary> 
	/// Creates a new PPG_PCJ_GOAL_ROLE Group.
	///</summary>
	public PPG_PCJ_GOAL_ROLE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PPG_PCJ_GOAL_ROLE - this is probably a bug in the source code generator.", e);
	   }
	}
