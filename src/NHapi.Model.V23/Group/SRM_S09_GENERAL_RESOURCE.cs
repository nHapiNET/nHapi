...
{
///<summary>
///Represents the SRM_S09_GENERAL_RESOURCE Group.  A Group is an ordered collection of message 
...
public class SRM_S09_GENERAL_RESOURCE : AbstractGroup {
	...
	///</summary>
	public SRM_S09_GENERAL_RESOURCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
