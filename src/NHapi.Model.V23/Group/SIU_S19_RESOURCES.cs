...
///<li>1: SIU_S19_SERVICE (a Group object) optional repeating</li>
///<li>2: SIU_S19_GENERAL_RESOURCE (a Group object) optional repeating</li>
///<li>3: SIU_S19_LOCATION_RESOURCE (a Group object) optional repeating</li>
///<li>4: SIU_S19_PERSONNEL_RESOURCE (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the SIU_S19_SERVICE results 
	 */ 
	public IEnumerable<SIU_S19_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SIU_S19_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S19_SERVICE
	///</summary>
	public SIU_S19_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SIU_S19_SERVICE;
	}

	///<summary>
	///Removes the given SIU_S19_SERVICE
	///</summary>
	public void RemoveSERVICE(SIU_S19_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SIU_S19_SERVICE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SIU_S19_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SIU_S19_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SIU_S19_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S19_GENERAL_RESOURCE
	///</summary>
	public SIU_S19_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SIU_S19_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SIU_S19_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SIU_S19_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SIU_S19_GENERAL_RESOURCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SIU_S19_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SIU_S19_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SIU_S19_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S19_LOCATION_RESOURCE
	///</summary>
	public SIU_S19_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SIU_S19_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SIU_S19_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SIU_S19_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SIU_S19_LOCATION_RESOURCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SIU_S19_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SIU_S19_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SIU_S19_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SIU_S19_PERSONNEL_RESOURCE
	///</summary>
	public SIU_S19_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SIU_S19_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SIU_S19_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SIU_S19_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SIU_S19_PERSONNEL_RESOURCE at the given index
	///</summary>
