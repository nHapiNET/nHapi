...
{
///<summary>
///Represents the SIU_S17_PATIENT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SIU_S17_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new SIU_S17_PATIENT Group.
	///</summary>
	public SIU_S17_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SIU_S17_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
