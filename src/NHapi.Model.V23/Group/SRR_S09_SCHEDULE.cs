...
get{
	...
	/** 
	 * Enumerate over the SRR_S09_PATIENT results 
	 */ 
	public IEnumerable<SRR_S09_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SRR_S09_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S09_PATIENT
	///</summary>
	public SRR_S09_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SRR_S09_PATIENT;
	}

	///<summary>
	///Removes the given SRR_S09_PATIENT
	///</summary>
	public void RemovePATIENT(SRR_S09_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SRR_S09_PATIENT at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRR_S09_RESOURCES results 
	 */ 
	public IEnumerable<SRR_S09_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SRR_S09_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S09_RESOURCES
	///</summary>
	public SRR_S09_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SRR_S09_RESOURCES;
	}

	///<summary>
	///Removes the given SRR_S09_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SRR_S09_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SRR_S09_RESOURCES at the given index
	///</summary>
