...
get{
	...
	/** 
	 * Enumerate over the PEX_P08_ASSOCIATED_RX_ADMIN results 
	 */ 
	public IEnumerable<PEX_P08_ASSOCIATED_RX_ADMIN> ASSOCIATED_RX_ADMINs 
	{ 
		get
		{
			for (int rep = 0; rep < ASSOCIATED_RX_ADMINRepetitionsUsed; rep++)
			{
				yield return (PEX_P08_ASSOCIATED_RX_ADMIN)this.GetStructure("ASSOCIATED_RX_ADMIN", rep);
			}
		}
	}

	///<summary>
	///Adds a new PEX_P08_ASSOCIATED_RX_ADMIN
	///</summary>
	public PEX_P08_ASSOCIATED_RX_ADMIN AddASSOCIATED_RX_ADMIN()
	{
		return this.AddStructure("ASSOCIATED_RX_ADMIN") as PEX_P08_ASSOCIATED_RX_ADMIN;
	}

	///<summary>
	///Removes the given PEX_P08_ASSOCIATED_RX_ADMIN
	///</summary>
	public void RemoveASSOCIATED_RX_ADMIN(PEX_P08_ASSOCIATED_RX_ADMIN toRemove)
	{
		this.RemoveStructure("ASSOCIATED_RX_ADMIN", toRemove);
	}

	///<summary>
	///Removes the PEX_P08_ASSOCIATED_RX_ADMIN at the given index
	///</summary>
