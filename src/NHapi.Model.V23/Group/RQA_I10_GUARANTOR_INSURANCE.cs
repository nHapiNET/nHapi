...
get{
	...
	/** 
	 * Enumerate over the RQA_I10_INSURANCE results 
	 */ 
	public IEnumerable<RQA_I10_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (RQA_I10_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RQA_I10_INSURANCE
	///</summary>
	public RQA_I10_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as RQA_I10_INSURANCE;
	}

	///<summary>
	///Removes the given RQA_I10_INSURANCE
	///</summary>
	public void RemoveINSURANCE(RQA_I10_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the RQA_I10_INSURANCE at the given index
	///</summary>
