...
get{
	...
	/** 
	 * Enumerate over the CSU_C11_STUDY_OBSERVATION results 
	 */ 
	public IEnumerable<CSU_C11_STUDY_OBSERVATION> STUDY_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < STUDY_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CSU_C11_STUDY_OBSERVATION)this.GetStructure("STUDY_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CSU_C11_STUDY_OBSERVATION
	///</summary>
	public CSU_C11_STUDY_OBSERVATION AddSTUDY_OBSERVATION()
	{
		return this.AddStructure("STUDY_OBSERVATION") as CSU_C11_STUDY_OBSERVATION;
	}

	///<summary>
	///Removes the given CSU_C11_STUDY_OBSERVATION
	///</summary>
	public void RemoveSTUDY_OBSERVATION(CSU_C11_STUDY_OBSERVATION toRemove)
	{
		this.RemoveStructure("STUDY_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CSU_C11_STUDY_OBSERVATION at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the CSU_C11_STUDY_PHARM results 
	 */ 
	public IEnumerable<CSU_C11_STUDY_PHARM> STUDY_PHARMs 
	{ 
		get
		{
			for (int rep = 0; rep < STUDY_PHARMRepetitionsUsed; rep++)
			{
				yield return (CSU_C11_STUDY_PHARM)this.GetStructure("STUDY_PHARM", rep);
			}
		}
	}

	///<summary>
	///Adds a new CSU_C11_STUDY_PHARM
	///</summary>
	public CSU_C11_STUDY_PHARM AddSTUDY_PHARM()
	{
		return this.AddStructure("STUDY_PHARM") as CSU_C11_STUDY_PHARM;
	}

	///<summary>
	///Removes the given CSU_C11_STUDY_PHARM
	///</summary>
	public void RemoveSTUDY_PHARM(CSU_C11_STUDY_PHARM toRemove)
	{
		this.RemoveStructure("STUDY_PHARM", toRemove);
	}

	///<summary>
	///Removes the CSU_C11_STUDY_PHARM at the given index
	///</summary>
