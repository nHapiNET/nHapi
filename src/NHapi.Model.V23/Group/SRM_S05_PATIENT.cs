...
{
///<summary>
///Represents the SRM_S05_PATIENT Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class SRM_S05_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new SRM_S05_PATIENT Group.
	///</summary>
	public SRM_S05_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRM_S05_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
