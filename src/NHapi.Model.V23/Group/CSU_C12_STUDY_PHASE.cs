...
public class CSU_C12_STUDY_PHASE : AbstractGroup {
	...
	public CSU_C12_STUDY_PHASE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(CSU_C12_STUDY_SCHEDULE), true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CSU_C12_STUDY_PHASE - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	public CSU_C12_STUDY_SCHEDULE GetSTUDY_SCHEDULE() {
	   ...
	   try {
	      ret = (CSU_C12_STUDY_SCHEDULE)this.GetStructure("STUDY_SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the CSU_C12_STUDY_SCHEDULE results 
	 */ 
	public IEnumerable<CSU_C12_STUDY_SCHEDULE> STUDY_SCHEDULEs 
	{ 
		get
		{
			for (int rep = 0; rep < STUDY_SCHEDULERepetitionsUsed; rep++)
			{
				yield return (CSU_C12_STUDY_SCHEDULE)this.GetStructure("STUDY_SCHEDULE", rep);
			}
		}
	}

	///<summary>
	///Adds a new CSU_C12_STUDY_SCHEDULE
	///</summary>
	public CSU_C12_STUDY_SCHEDULE AddSTUDY_SCHEDULE()
	{
		return this.AddStructure("STUDY_SCHEDULE") as CSU_C12_STUDY_SCHEDULE;
	}

	///<summary>
	///Removes the given CSU_C12_STUDY_SCHEDULE
	///</summary>
	public void RemoveSTUDY_SCHEDULE(CSU_C12_STUDY_SCHEDULE toRemove)
	{
		this.RemoveStructure("STUDY_SCHEDULE", toRemove);
	}

	///<summary>
	///Removes the CSU_C12_STUDY_SCHEDULE at the given index
	///</summary>
