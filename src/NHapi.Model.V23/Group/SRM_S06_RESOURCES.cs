...
get{
	...
	/** 
	 * Enumerate over the SRM_S06_SERVICE results 
	 */ 
	public IEnumerable<SRM_S06_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SRM_S06_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S06_SERVICE
	///</summary>
	public SRM_S06_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SRM_S06_SERVICE;
	}

	///<summary>
	///Removes the given SRM_S06_SERVICE
	///</summary>
	public void RemoveSERVICE(SRM_S06_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SRM_S06_SERVICE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRM_S06_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SRM_S06_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRM_S06_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S06_GENERAL_RESOURCE
	///</summary>
	public SRM_S06_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SRM_S06_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SRM_S06_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SRM_S06_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRM_S06_GENERAL_RESOURCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRM_S06_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SRM_S06_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRM_S06_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S06_LOCATION_RESOURCE
	///</summary>
	public SRM_S06_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SRM_S06_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SRM_S06_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SRM_S06_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRM_S06_LOCATION_RESOURCE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the SRM_S06_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SRM_S06_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRM_S06_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRM_S06_PERSONNEL_RESOURCE
	///</summary>
	public SRM_S06_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SRM_S06_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SRM_S06_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SRM_S06_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRM_S06_PERSONNEL_RESOURCE at the given index
	///</summary>
