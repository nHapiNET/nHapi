...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_PROBLEM_ROLE results 
	 */ 
	public IEnumerable<PPR_PC2_PROBLEM_ROLE> PROBLEM_ROLEs 
	{ 
		get
		{
			for (int rep = 0; rep < PROBLEM_ROLERepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_PROBLEM_ROLE)this.GetStructure("PROBLEM_ROLE", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_PROBLEM_ROLE
	///</summary>
	public PPR_PC2_PROBLEM_ROLE AddPROBLEM_ROLE()
	{
		return this.AddStructure("PROBLEM_ROLE") as PPR_PC2_PROBLEM_ROLE;
	}

	///<summary>
	///Removes the given PPR_PC2_PROBLEM_ROLE
	///</summary>
	public void RemovePROBLEM_ROLE(PPR_PC2_PROBLEM_ROLE toRemove)
	{
		this.RemoveStructure("PROBLEM_ROLE", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_PROBLEM_ROLE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_PATHWAY results 
	 */ 
	public IEnumerable<PPR_PC2_PATHWAY> PATHWAYs 
	{ 
		get
		{
			for (int rep = 0; rep < PATHWAYRepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_PATHWAY)this.GetStructure("PATHWAY", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_PATHWAY
	///</summary>
	public PPR_PC2_PATHWAY AddPATHWAY()
	{
		return this.AddStructure("PATHWAY") as PPR_PC2_PATHWAY;
	}

	///<summary>
	///Removes the given PPR_PC2_PATHWAY
	///</summary>
	public void RemovePATHWAY(PPR_PC2_PATHWAY toRemove)
	{
		this.RemoveStructure("PATHWAY", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_PATHWAY at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_PROBLEM_OBSERVATION results 
	 */ 
	public IEnumerable<PPR_PC2_PROBLEM_OBSERVATION> PROBLEM_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PROBLEM_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_PROBLEM_OBSERVATION)this.GetStructure("PROBLEM_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_PROBLEM_OBSERVATION
	///</summary>
	public PPR_PC2_PROBLEM_OBSERVATION AddPROBLEM_OBSERVATION()
	{
		return this.AddStructure("PROBLEM_OBSERVATION") as PPR_PC2_PROBLEM_OBSERVATION;
	}

	///<summary>
	///Removes the given PPR_PC2_PROBLEM_OBSERVATION
	///</summary>
	public void RemovePROBLEM_OBSERVATION(PPR_PC2_PROBLEM_OBSERVATION toRemove)
	{
		this.RemoveStructure("PROBLEM_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_PROBLEM_OBSERVATION at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_GOAL results 
	 */ 
	public IEnumerable<PPR_PC2_GOAL> GOALs 
	{ 
		get
		{
			for (int rep = 0; rep < GOALRepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_GOAL)this.GetStructure("GOAL", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_GOAL
	///</summary>
	public PPR_PC2_GOAL AddGOAL()
	{
		return this.AddStructure("GOAL") as PPR_PC2_GOAL;
	}

	///<summary>
	///Removes the given PPR_PC2_GOAL
	///</summary>
	public void RemoveGOAL(PPR_PC2_GOAL toRemove)
	{
		this.RemoveStructure("GOAL", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_GOAL at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_ORDER results 
	 */ 
	public IEnumerable<PPR_PC2_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_ORDER
	///</summary>
	public PPR_PC2_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as PPR_PC2_ORDER;
	}

	///<summary>
	///Removes the given PPR_PC2_ORDER
	///</summary>
	public void RemoveORDER(PPR_PC2_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_ORDER at the given index
	///</summary>
