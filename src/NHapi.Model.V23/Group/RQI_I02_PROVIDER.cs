...
public class RQI_I02_PROVIDER : AbstractGroup {
	...
	///<summary> 
	/// Creates a new RQI_I02_PROVIDER Group.
	///</summary>
	public RQI_I02_PROVIDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(CTD), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RQI_I02_PROVIDER - this is probably a bug in the source code generator.", e);
	   }
	}
