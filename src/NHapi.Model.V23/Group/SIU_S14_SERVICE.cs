...
{
///<summary>
///Represents the SIU_S14_SERVICE Group.  A Group is an ordered collection of message 
...
public class SIU_S14_SERVICE : AbstractGroup {
	...
	///</summary>
	public SIU_S14_SERVICE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
