...
public class SRR_S07_SCHEDULE : AbstractGroup {
	...
	public SRR_S07_SCHEDULE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(SRR_S07_PATIENT), false, true);
	      this.add(typeof(SRR_S07_RESOURCES), true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SRR_S07_SCHEDULE - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	public SRR_S07_PATIENT GetPATIENT() {
	   ...
	   try {
	      ret = (SRR_S07_PATIENT)this.GetStructure("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the SRR_S07_PATIENT results 
	 */ 
	public IEnumerable<SRR_S07_PATIENT> PATIENTs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENTRepetitionsUsed; rep++)
			{
				yield return (SRR_S07_PATIENT)this.GetStructure("PATIENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S07_PATIENT
	///</summary>
	public SRR_S07_PATIENT AddPATIENT()
	{
		return this.AddStructure("PATIENT") as SRR_S07_PATIENT;
	}

	///<summary>
	///Removes the given SRR_S07_PATIENT
	///</summary>
	public void RemovePATIENT(SRR_S07_PATIENT toRemove)
	{
		this.RemoveStructure("PATIENT", toRemove);
	}

	///<summary>
	///Removes the SRR_S07_PATIENT at the given index
	///</summary>
	...
	public SRR_S07_RESOURCES GetRESOURCES() {
	   ...
	   try {
	      ret = (SRR_S07_RESOURCES)this.GetStructure("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	/** 
	 * Enumerate over the SRR_S07_RESOURCES results 
	 */ 
	public IEnumerable<SRR_S07_RESOURCES> RESOURCESs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCESRepetitionsUsed; rep++)
			{
				yield return (SRR_S07_RESOURCES)this.GetStructure("RESOURCES", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S07_RESOURCES
	///</summary>
	public SRR_S07_RESOURCES AddRESOURCES()
	{
		return this.AddStructure("RESOURCES") as SRR_S07_RESOURCES;
	}

	///<summary>
	///Removes the given SRR_S07_RESOURCES
	///</summary>
	public void RemoveRESOURCES(SRR_S07_RESOURCES toRemove)
	{
		this.RemoveStructure("RESOURCES", toRemove);
	}

	///<summary>
	///Removes the SRR_S07_RESOURCES at the given index
	///</summary>
