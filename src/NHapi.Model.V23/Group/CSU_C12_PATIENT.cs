...
///<li>3: CSU_C12_VISIT (a Group object) optional </li>
///<li>4: CSR (Clinical Study Registration) </li>
///<li>5: CSU_C12_STUDY_PHASE (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class CSU_C12_PATIENT : AbstractGroup {
	...
	///</summary>
	public CSU_C12_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	/** 
	 * Enumerate over the CSU_C12_STUDY_PHASE results 
	 */ 
	public IEnumerable<CSU_C12_STUDY_PHASE> STUDY_PHASEs 
	{ 
		get
		{
			for (int rep = 0; rep < STUDY_PHASERepetitionsUsed; rep++)
			{
				yield return (CSU_C12_STUDY_PHASE)this.GetStructure("STUDY_PHASE", rep);
			}
		}
	}

	///<summary>
	///Adds a new CSU_C12_STUDY_PHASE
	///</summary>
	public CSU_C12_STUDY_PHASE AddSTUDY_PHASE()
	{
		return this.AddStructure("STUDY_PHASE") as CSU_C12_STUDY_PHASE;
	}

	///<summary>
	///Removes the given CSU_C12_STUDY_PHASE
	///</summary>
	public void RemoveSTUDY_PHASE(CSU_C12_STUDY_PHASE toRemove)
	{
		this.RemoveStructure("STUDY_PHASE", toRemove);
	}

	///<summary>
	///Removes the CSU_C12_STUDY_PHASE at the given index
	///</summary>
