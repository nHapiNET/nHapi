...
{
///<summary>
///Represents the RPA_I10_AUTHORIZATION Group.  A Group is an ordered collection of message 
...
public class RPA_I10_AUTHORIZATION : AbstractGroup {
	...
	///</summary>
	public RPA_I10_AUTHORIZATION(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
