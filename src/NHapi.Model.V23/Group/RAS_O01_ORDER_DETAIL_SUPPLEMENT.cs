...
{
///<summary>
///Represents the RAS_O01_ORDER_DETAIL_SUPPLEMENT Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: NTE (Notes and comments segment) repeating</li>
///<li>1: RXR (Pharmacy route segment) repeating</li>
///<li>2: RAS_O01_COMPONENTS (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class RAS_O01_ORDER_DETAIL_SUPPLEMENT : AbstractGroup {
	...
	///</summary>
	public RAS_O01_ORDER_DETAIL_SUPPLEMENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(NTE), true, true);
	      this.add(typeof(RXR), true, true);
	      this.add(typeof(RAS_O01_COMPONENTS), false, false);
...
get{
	   ...
	   try {
	      ret = (RAS_O01_COMPONENTS)this.GetStructure("COMPONENTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
