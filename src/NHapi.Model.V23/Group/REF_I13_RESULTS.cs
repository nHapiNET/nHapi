...
get{
	...
	/** 
	 * Enumerate over the REF_I13_OBSERVATION results 
	 */ 
	public IEnumerable<REF_I13_OBSERVATION> OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (REF_I13_OBSERVATION)this.GetStructure("OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new REF_I13_OBSERVATION
	///</summary>
	public REF_I13_OBSERVATION AddOBSERVATION()
	{
		return this.AddStructure("OBSERVATION") as REF_I13_OBSERVATION;
	}

	///<summary>
	///Removes the given REF_I13_OBSERVATION
	///</summary>
	public void RemoveOBSERVATION(REF_I13_OBSERVATION toRemove)
	{
		this.RemoveStructure("OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the REF_I13_OBSERVATION at the given index
	///</summary>
