...
///<li>3: PPR_PC2_GOAL_ROLE (a Group object) optional repeating</li>
///<li>4: PPR_PC2_GOAL_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class PPR_PC2_GOAL : AbstractGroup {
	...
	///</summary>
	public PPR_PC2_GOAL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_GOAL_ROLE results 
	 */ 
	public IEnumerable<PPR_PC2_GOAL_ROLE> GOAL_ROLEs 
	{ 
		get
		{
			for (int rep = 0; rep < GOAL_ROLERepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_GOAL_ROLE)this.GetStructure("GOAL_ROLE", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_GOAL_ROLE
	///</summary>
	public PPR_PC2_GOAL_ROLE AddGOAL_ROLE()
	{
		return this.AddStructure("GOAL_ROLE") as PPR_PC2_GOAL_ROLE;
	}

	///<summary>
	///Removes the given PPR_PC2_GOAL_ROLE
	///</summary>
	public void RemoveGOAL_ROLE(PPR_PC2_GOAL_ROLE toRemove)
	{
		this.RemoveStructure("GOAL_ROLE", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_GOAL_ROLE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PPR_PC2_GOAL_OBSERVATION results 
	 */ 
	public IEnumerable<PPR_PC2_GOAL_OBSERVATION> GOAL_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < GOAL_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (PPR_PC2_GOAL_OBSERVATION)this.GetStructure("GOAL_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PPR_PC2_GOAL_OBSERVATION
	///</summary>
	public PPR_PC2_GOAL_OBSERVATION AddGOAL_OBSERVATION()
	{
		return this.AddStructure("GOAL_OBSERVATION") as PPR_PC2_GOAL_OBSERVATION;
	}

	///<summary>
	///Removes the given PPR_PC2_GOAL_OBSERVATION
	///</summary>
	public void RemoveGOAL_OBSERVATION(PPR_PC2_GOAL_OBSERVATION toRemove)
	{
		this.RemoveStructure("GOAL_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the PPR_PC2_GOAL_OBSERVATION at the given index
	///</summary>
