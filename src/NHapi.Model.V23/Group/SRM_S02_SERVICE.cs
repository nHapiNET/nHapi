...
{
///<summary>
///Represents the SRM_S02_SERVICE Group.  A Group is an ordered collection of message 
...
public class SRM_S02_SERVICE : AbstractGroup {
	...
	///</summary>
	public SRM_S02_SERVICE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
