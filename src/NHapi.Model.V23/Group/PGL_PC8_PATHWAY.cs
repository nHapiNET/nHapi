...
{
///<summary>
///Represents the PGL_PC8_PATHWAY Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PGL_PC8_PATHWAY : AbstractGroup {

	///<summary> 
	/// Creates a new PGL_PC8_PATHWAY Group.
	///</summary>
	public PGL_PC8_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PTH), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PGL_PC8_PATHWAY - this is probably a bug in the source code generator.", e);
	   }
	}
