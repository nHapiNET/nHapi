...
///<li>3: PGL_PC8_GOAL_ROLE (a Group object) optional repeating</li>
///<li>4: PGL_PC8_PATHWAY (a Group object) optional repeating</li>
///<li>5: PGL_PC8_OBSERVATION (a Group object) optional repeating</li>
///<li>6: PGL_PC8_PROBLEM (a Group object) optional repeating</li>
///<li>7: PGL_PC8_ORDER (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class PGL_PC8_GOAL : AbstractGroup {
	...
	///</summary>
	public PGL_PC8_GOAL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
...
get{
	...
	/** 
	 * Enumerate over the PGL_PC8_GOAL_ROLE results 
	 */ 
	public IEnumerable<PGL_PC8_GOAL_ROLE> GOAL_ROLEs 
	{ 
		get
		{
			for (int rep = 0; rep < GOAL_ROLERepetitionsUsed; rep++)
			{
				yield return (PGL_PC8_GOAL_ROLE)this.GetStructure("GOAL_ROLE", rep);
			}
		}
	}

	///<summary>
	///Adds a new PGL_PC8_GOAL_ROLE
	///</summary>
	public PGL_PC8_GOAL_ROLE AddGOAL_ROLE()
	{
		return this.AddStructure("GOAL_ROLE") as PGL_PC8_GOAL_ROLE;
	}

	///<summary>
	///Removes the given PGL_PC8_GOAL_ROLE
	///</summary>
	public void RemoveGOAL_ROLE(PGL_PC8_GOAL_ROLE toRemove)
	{
		this.RemoveStructure("GOAL_ROLE", toRemove);
	}

	///<summary>
	///Removes the PGL_PC8_GOAL_ROLE at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PGL_PC8_PATHWAY results 
	 */ 
	public IEnumerable<PGL_PC8_PATHWAY> PATHWAYs 
	{ 
		get
		{
			for (int rep = 0; rep < PATHWAYRepetitionsUsed; rep++)
			{
				yield return (PGL_PC8_PATHWAY)this.GetStructure("PATHWAY", rep);
			}
		}
	}

	///<summary>
	///Adds a new PGL_PC8_PATHWAY
	///</summary>
	public PGL_PC8_PATHWAY AddPATHWAY()
	{
		return this.AddStructure("PATHWAY") as PGL_PC8_PATHWAY;
	}

	///<summary>
	///Removes the given PGL_PC8_PATHWAY
	///</summary>
	public void RemovePATHWAY(PGL_PC8_PATHWAY toRemove)
	{
		this.RemoveStructure("PATHWAY", toRemove);
	}

	///<summary>
	///Removes the PGL_PC8_PATHWAY at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PGL_PC8_OBSERVATION results 
	 */ 
	public IEnumerable<PGL_PC8_OBSERVATION> OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (PGL_PC8_OBSERVATION)this.GetStructure("OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new PGL_PC8_OBSERVATION
	///</summary>
	public PGL_PC8_OBSERVATION AddOBSERVATION()
	{
		return this.AddStructure("OBSERVATION") as PGL_PC8_OBSERVATION;
	}

	///<summary>
	///Removes the given PGL_PC8_OBSERVATION
	///</summary>
	public void RemoveOBSERVATION(PGL_PC8_OBSERVATION toRemove)
	{
		this.RemoveStructure("OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the PGL_PC8_OBSERVATION at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PGL_PC8_PROBLEM results 
	 */ 
	public IEnumerable<PGL_PC8_PROBLEM> PROBLEMs 
	{ 
		get
		{
			for (int rep = 0; rep < PROBLEMRepetitionsUsed; rep++)
			{
				yield return (PGL_PC8_PROBLEM)this.GetStructure("PROBLEM", rep);
			}
		}
	}

	///<summary>
	///Adds a new PGL_PC8_PROBLEM
	///</summary>
	public PGL_PC8_PROBLEM AddPROBLEM()
	{
		return this.AddStructure("PROBLEM") as PGL_PC8_PROBLEM;
	}

	///<summary>
	///Removes the given PGL_PC8_PROBLEM
	///</summary>
	public void RemovePROBLEM(PGL_PC8_PROBLEM toRemove)
	{
		this.RemoveStructure("PROBLEM", toRemove);
	}

	///<summary>
	///Removes the PGL_PC8_PROBLEM at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the PGL_PC8_ORDER results 
	 */ 
	public IEnumerable<PGL_PC8_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (PGL_PC8_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new PGL_PC8_ORDER
	///</summary>
	public PGL_PC8_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as PGL_PC8_ORDER;
	}

	///<summary>
	///Removes the given PGL_PC8_ORDER
	///</summary>
	public void RemoveORDER(PGL_PC8_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the PGL_PC8_ORDER at the given index
	///</summary>
