...
public class SRR_S07_RESOURCES : AbstractGroup {
	...
	///<summary> 
	/// Creates a new SRR_S07_RESOURCES Group.
	///</summary>
...
get{
	...
	/** 
	 * Returns the number of existing repetitions of SRR_S07_SERVICE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SRR_S07_SERVICE results 
	 */ 
	public IEnumerable<SRR_S07_SERVICE> SERVICEs 
	{ 
		get
		{
			for (int rep = 0; rep < SERVICERepetitionsUsed; rep++)
			{
				yield return (SRR_S07_SERVICE)this.GetStructure("SERVICE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S07_SERVICE
	///</summary>
	public SRR_S07_SERVICE AddSERVICE()
	{
		return this.AddStructure("SERVICE") as SRR_S07_SERVICE;
	}

	///<summary>
	///Removes the given SRR_S07_SERVICE
	///</summary>
	public void RemoveSERVICE(SRR_S07_SERVICE toRemove)
	{
		this.RemoveStructure("SERVICE", toRemove);
	}

	///<summary>
	///Removes the SRR_S07_SERVICE at the given index
	///</summary>
	...
	///<summary>
	/// Returns  first repetition of SRR_S07_GENERAL_RESOURCE (a Group object) - creates it if necessary
	///</summary>
	...
	/** 
	 * Returns the number of existing repetitions of SRR_S07_GENERAL_RESOURCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SRR_S07_GENERAL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S07_GENERAL_RESOURCE> GENERAL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < GENERAL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S07_GENERAL_RESOURCE)this.GetStructure("GENERAL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S07_GENERAL_RESOURCE
	///</summary>
	public SRR_S07_GENERAL_RESOURCE AddGENERAL_RESOURCE()
	{
		return this.AddStructure("GENERAL_RESOURCE") as SRR_S07_GENERAL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S07_GENERAL_RESOURCE
	///</summary>
	public void RemoveGENERAL_RESOURCE(SRR_S07_GENERAL_RESOURCE toRemove)
	{
		this.RemoveStructure("GENERAL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S07_GENERAL_RESOURCE at the given index
	///</summary>
	...
	///<summary>
	/// Returns  first repetition of SRR_S07_LOCATION_RESOURCE (a Group object) - creates it if necessary
	///</summary>
	...
	/** 
	 * Returns the number of existing repetitions of SRR_S07_LOCATION_RESOURCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SRR_S07_LOCATION_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S07_LOCATION_RESOURCE> LOCATION_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < LOCATION_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S07_LOCATION_RESOURCE)this.GetStructure("LOCATION_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S07_LOCATION_RESOURCE
	///</summary>
	public SRR_S07_LOCATION_RESOURCE AddLOCATION_RESOURCE()
	{
		return this.AddStructure("LOCATION_RESOURCE") as SRR_S07_LOCATION_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S07_LOCATION_RESOURCE
	///</summary>
	public void RemoveLOCATION_RESOURCE(SRR_S07_LOCATION_RESOURCE toRemove)
	{
		this.RemoveStructure("LOCATION_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S07_LOCATION_RESOURCE at the given index
	///</summary>
	...
	///<summary>
	/// Returns  first repetition of SRR_S07_PERSONNEL_RESOURCE (a Group object) - creates it if necessary
	///</summary>
	...
	/** 
	 * Returns the number of existing repetitions of SRR_S07_PERSONNEL_RESOURCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the SRR_S07_PERSONNEL_RESOURCE results 
	 */ 
	public IEnumerable<SRR_S07_PERSONNEL_RESOURCE> PERSONNEL_RESOURCEs 
	{ 
		get
		{
			for (int rep = 0; rep < PERSONNEL_RESOURCERepetitionsUsed; rep++)
			{
				yield return (SRR_S07_PERSONNEL_RESOURCE)this.GetStructure("PERSONNEL_RESOURCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new SRR_S07_PERSONNEL_RESOURCE
	///</summary>
	public SRR_S07_PERSONNEL_RESOURCE AddPERSONNEL_RESOURCE()
	{
		return this.AddStructure("PERSONNEL_RESOURCE") as SRR_S07_PERSONNEL_RESOURCE;
	}

	///<summary>
	///Removes the given SRR_S07_PERSONNEL_RESOURCE
	///</summary>
	public void RemovePERSONNEL_RESOURCE(SRR_S07_PERSONNEL_RESOURCE toRemove)
	{
		this.RemoveStructure("PERSONNEL_RESOURCE", toRemove);
	}

	///<summary>
	///Removes the SRR_S07_PERSONNEL_RESOURCE at the given index
	///</summary>
