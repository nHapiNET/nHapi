...
{
///<summary>
///Represents the PPR_PC2_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class PPR_PC2_PROBLEM_ROLE : AbstractGroup {

	///<summary> 
	/// Creates a new PPR_PC2_PROBLEM_ROLE Group.
	///</summary>
	public PPR_PC2_PROBLEM_ROLE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating PPR_PC2_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
	   }
	}
