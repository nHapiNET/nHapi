...
get{
	...
	/** 
	 * Enumerate over the CSU_C10_RX_ADMIN results 
	 */ 
	public IEnumerable<CSU_C10_RX_ADMIN> RX_ADMINs 
	{ 
		get
		{
			for (int rep = 0; rep < RX_ADMINRepetitionsUsed; rep++)
			{
				yield return (CSU_C10_RX_ADMIN)this.GetStructure("RX_ADMIN", rep);
			}
		}
	}

	///<summary>
	///Adds a new CSU_C10_RX_ADMIN
	///</summary>
	public CSU_C10_RX_ADMIN AddRX_ADMIN()
	{
		return this.AddStructure("RX_ADMIN") as CSU_C10_RX_ADMIN;
	}

	///<summary>
	///Removes the given CSU_C10_RX_ADMIN
	///</summary>
	public void RemoveRX_ADMIN(CSU_C10_RX_ADMIN toRemove)
	{
		this.RemoveStructure("RX_ADMIN", toRemove);
	}

	///<summary>
	///Removes the CSU_C10_RX_ADMIN at the given index
	///</summary>
