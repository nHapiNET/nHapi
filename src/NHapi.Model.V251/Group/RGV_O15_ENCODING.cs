...
///<li>1: RGV_O15_TIMING_ENCODED (a Group object) repeating</li>
...
public class RGV_O15_ENCODING : AbstractGroup {
	...
	public RGV_O15_ENCODING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RGV_O15_TIMING_ENCODED), true, true);
...
get{
	...
	public RGV_O15_TIMING_ENCODED GetTIMING_ENCODED() {
	   ...
	   try {
	      ret = (RGV_O15_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RGV_O15_TIMING_ENCODED GetTIMING_ENCODED(int rep) { 
	   return (RGV_O15_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the RGV_O15_TIMING_ENCODED results 
	 */ 
	public IEnumerable<RGV_O15_TIMING_ENCODED> TIMING_ENCODEDs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_ENCODEDRepetitionsUsed; rep++)
			{
				yield return (RGV_O15_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
			}
		}
	}

	///<summary>
	///Adds a new RGV_O15_TIMING_ENCODED
	///</summary>
	public RGV_O15_TIMING_ENCODED AddTIMING_ENCODED()
	{
		return this.AddStructure("TIMING_ENCODED") as RGV_O15_TIMING_ENCODED;
	}

	///<summary>
	///Removes the given RGV_O15_TIMING_ENCODED
	///</summary>
	public void RemoveTIMING_ENCODED(RGV_O15_TIMING_ENCODED toRemove)
	{
		this.RemoveStructure("TIMING_ENCODED", toRemove);
	}

	///<summary>
	///Removes the RGV_O15_TIMING_ENCODED at the given index
	///</summary>
