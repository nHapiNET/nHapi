...
{
///<summary>
///Represents the OMD_O03_TIMING_DIET Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMD_O03_TIMING_DIET : AbstractGroup {

	///<summary> 
	/// Creates a new OMD_O03_TIMING_DIET Group.
	///</summary>
	public OMD_O03_TIMING_DIET(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMD_O03_TIMING_DIET - this is probably a bug in the source code generator.", e);
	   }
	}
