...
{
///<summary>
///Represents the ADT_A03_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ADT_A03_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new ADT_A03_INSURANCE Group.
	///</summary>
	public ADT_A03_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ADT_A03_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
