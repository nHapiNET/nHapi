...
{
///<summary>
///Represents the OSR_Q06_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OSR_Q06_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OSR_Q06_TIMING Group.
	///</summary>
	public OSR_Q06_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OSR_Q06_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
