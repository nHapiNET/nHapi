...
{
///<summary>
///Represents the BRT_O32_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class BRT_O32_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new BRT_O32_TIMING Group.
	///</summary>
	public BRT_O32_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating BRT_O32_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
