...
///<li>1: RSP_Z82_TIMING_ENCODED (a Group object) optional repeating</li>
...
public class RSP_Z82_ENCODED_ORDER : AbstractGroup {
	...
	public RSP_Z82_ENCODED_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(RSP_Z82_TIMING_ENCODED), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of RSP_Z82_TIMING_ENCODED (a Group object) - creates it if necessary
	///</summary>
	public RSP_Z82_TIMING_ENCODED GetTIMING_ENCODED() {
	   RSP_Z82_TIMING_ENCODED ret = null;
	   try {
	      ret = (RSP_Z82_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of RSP_Z82_TIMING_ENCODED
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public RSP_Z82_TIMING_ENCODED GetTIMING_ENCODED(int rep) { 
	   return (RSP_Z82_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RSP_Z82_TIMING_ENCODED 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the RSP_Z82_TIMING_ENCODED results 
	 */ 
	public IEnumerable<RSP_Z82_TIMING_ENCODED> TIMING_ENCODEDs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_ENCODEDRepetitionsUsed; rep++)
			{
				yield return (RSP_Z82_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
			}
		}
	}

	///<summary>
	///Adds a new RSP_Z82_TIMING_ENCODED
	///</summary>
	public RSP_Z82_TIMING_ENCODED AddTIMING_ENCODED()
	{
		return this.AddStructure("TIMING_ENCODED") as RSP_Z82_TIMING_ENCODED;
	}

	///<summary>
	///Removes the given RSP_Z82_TIMING_ENCODED
	///</summary>
	public void RemoveTIMING_ENCODED(RSP_Z82_TIMING_ENCODED toRemove)
	{
		this.RemoveStructure("TIMING_ENCODED", toRemove);
	}

	///<summary>
	///Removes the RSP_Z82_TIMING_ENCODED at the given index
	///</summary>
