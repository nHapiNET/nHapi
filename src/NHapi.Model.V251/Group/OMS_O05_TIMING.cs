...
{
///<summary>
///Represents the OMS_O05_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMS_O05_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OMS_O05_TIMING Group.
	///</summary>
	public OMS_O05_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMS_O05_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
