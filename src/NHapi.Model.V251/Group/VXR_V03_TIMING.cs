...
{
///<summary>
///Represents the VXR_V03_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class VXR_V03_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new VXR_V03_TIMING Group.
	///</summary>
	public VXR_V03_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating VXR_V03_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
