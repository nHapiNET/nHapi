...
get{
	...
	/** 
	 * Enumerate over the RDS_O13_TIMING_ENCODED results 
	 */ 
	public IEnumerable<RDS_O13_TIMING_ENCODED> TIMING_ENCODEDs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_ENCODEDRepetitionsUsed; rep++)
			{
				yield return (RDS_O13_TIMING_ENCODED)this.GetStructure("TIMING_ENCODED", rep);
			}
		}
	}

	///<summary>
	///Adds a new RDS_O13_TIMING_ENCODED
	///</summary>
	public RDS_O13_TIMING_ENCODED AddTIMING_ENCODED()
	{
		return this.AddStructure("TIMING_ENCODED") as RDS_O13_TIMING_ENCODED;
	}

	///<summary>
	///Removes the given RDS_O13_TIMING_ENCODED
	///</summary>
	public void RemoveTIMING_ENCODED(RDS_O13_TIMING_ENCODED toRemove)
	{
		this.RemoveStructure("TIMING_ENCODED", toRemove);
	}

	///<summary>
	///Removes the RDS_O13_TIMING_ENCODED at the given index
	///</summary>
