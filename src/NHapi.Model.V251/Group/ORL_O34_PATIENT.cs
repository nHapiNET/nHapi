...
public class ORL_O34_PATIENT : AbstractGroup {
	...
	///<summary> 
	/// Creates a new ORL_O34_PATIENT Group.
	///</summary>
	public ORL_O34_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PID), true, false);
	      this.add(typeof(ORL_O34_SPECIMEN), true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORL_O34_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
