...
{
///<summary>
///Represents the ADT_A16_INSURANCE Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ADT_A16_INSURANCE : AbstractGroup {

	///<summary> 
	/// Creates a new ADT_A16_INSURANCE Group.
	///</summary>
	public ADT_A16_INSURANCE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ADT_A16_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
