...
public class AUT : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(CE), false, 1, 250, new System.Object[]{message}, "Authorizing Payor, Plan ID");
       this.add(typeof(CE), true, 1, 250, new System.Object[]{message}, "Authorizing Payor, Company ID");
