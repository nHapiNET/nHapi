...
///<li>8: MFR_M07_MF_QUERY (a Group object) repeating</li>
...
get{
	...
	/** 
	 * Enumerate over the MFR_M07_MF_QUERY results 
	 */ 
	public IEnumerable<MFR_M07_MF_QUERY> MF_QUERYs 
	{ 
		get
		{
			for (int rep = 0; rep < MF_QUERYRepetitionsUsed; rep++)
			{
				yield return (MFR_M07_MF_QUERY)this.GetStructure("MF_QUERY", rep);
			}
		}
	}

	///<summary>
	///Adds a new MFR_M07_MF_QUERY
	///</summary>
	public MFR_M07_MF_QUERY AddMF_QUERY()
	{
		return this.AddStructure("MF_QUERY") as MFR_M07_MF_QUERY;
	}
	...
	///<summary>
	///Removes the MFR_M07_MF_QUERY at the given index
	///</summary>
