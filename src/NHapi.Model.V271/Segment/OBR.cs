...
///<li>OBR-29: Parent Result Observation Identifier (EIP)</li>
...
public class OBR : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(EIP), false, 1, 0, new System.Object[]{message}, "Parent Result Observation Identifier");
...
get{
	...
	///<summary>
	/// Returns Parent Result Observation Identifier(OBR-29).
	///</summary>
	public EIP ParentResultObservationIdentifier
	{
		get{
			EIP ret = null;
			try
