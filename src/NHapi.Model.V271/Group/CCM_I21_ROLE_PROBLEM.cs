...
{
///<summary>
///Represents the CCM_I21_ROLE_PROBLEM Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCM_I21_ROLE_PROBLEM : AbstractGroup {

	///<summary> 
	/// Creates a new CCM_I21_ROLE_PROBLEM Group.
	///</summary>
	public CCM_I21_ROLE_PROBLEM(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCM_I21_ROLE_PROBLEM - this is probably a bug in the source code generator.", e);
	   }
	}
