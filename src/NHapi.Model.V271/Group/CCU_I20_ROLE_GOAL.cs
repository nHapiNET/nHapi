...
{
///<summary>
///Represents the CCU_I20_ROLE_GOAL Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class CCU_I20_ROLE_GOAL : AbstractGroup {

	///<summary> 
	/// Creates a new CCU_I20_ROLE_GOAL Group.
	///</summary>
	public CCU_I20_ROLE_GOAL(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ROL), true, false);
	      this.add(typeof(PRD), true, false);
	      this.add(typeof(VAR), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating CCU_I20_ROLE_GOAL - this is probably a bug in the source code generator.", e);
	   }
	}
