...
{
///<summary>
/// Represents a ORA_R33 message structure (see chapter 7.3.7). This structure contains the 
/// following elements:
///<ol>
...
///<li>5: ORC (Common Order) optional </li>
///</ol>
///</summary>
[Serializable]
public class ORA_R33 : AbstractMessage  {

	///<summary> 
	/// Creates a new ORA_R33 Group with custom IModelClassFactory.
	///</summary>
	public ORA_R33(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new ORA_R33 Group with DefaultModelClassFactory. 
	///</summary> 
	public ORA_R33() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for ORA_R33.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORA_R33 - this is probably a bug in the source code generator.", e);
	   }
	}
