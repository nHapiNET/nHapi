...
{
///<summary>
/// Represents a SDR_S32 message structure (see chapter 17.5.5). This structure contains the 
/// following elements:
///<ol>
...
///</summary>
[Serializable]
public class SDR_S32 : AbstractMessage  {

	///<summary> 
	/// Creates a new SDR_S32 Group with custom IModelClassFactory.
	///</summary>
	public SDR_S32(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new SDR_S32 Group with DefaultModelClassFactory. 
	///</summary> 
	public SDR_S32() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for SDR_S32.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating SDR_S32 - this is probably a bug in the source code generator.", e);
	   }
	}
