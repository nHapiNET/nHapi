...
get{
	...
	/** 
	 * Enumerate over the SLT results 
	 */ 
	public IEnumerable<SLT> SLTs 
	{ 
		get
		{
			for (int rep = 0; rep < SLTRepetitionsUsed; rep++)
			{
				yield return (SLT)this.GetStructure("SLT", rep);
			}
		}
	}
	...
	public SLT AddSLT()
	{
		return this.AddStructure("SLT") as SLT;
	}
	...
	///<summary>
	///Removes the SLT at the given index
	///</summary>
	public void RemoveSLTAt(int index)
	{
		this.RemoveRepetition("SLT", index);
	}
