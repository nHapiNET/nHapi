...
{
///<summary>
/// Represents a MFR_M05 message structure (see chapter 8.9.1). This structure contains the 
/// following elements:
///<ol>
...
///<li>9: MFR_M05_MF_QUERY (a Group object) repeating</li>
...
public class MFR_M05 : AbstractMessage  {
	...
	///<summary> 
	/// Creates a new MFR_M05 Group with custom IModelClassFactory.
	///</summary>
	public MFR_M05(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///<summary>
	/// initalize method for MFR_M05.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating MFR_M05 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	public MFR_M05_MF_QUERY GetMF_QUERY() {
	   ...
	   try {
	      ret = (MFR_M05_MF_QUERY)this.GetStructure("MF_QUERY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public MFR_M05_MF_QUERY GetMF_QUERY(int rep) { 
	   return (MFR_M05_MF_QUERY)this.GetStructure("MF_QUERY", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the MFR_M05_MF_QUERY results 
	 */ 
	public IEnumerable<MFR_M05_MF_QUERY> MF_QUERYs 
	{ 
		get
		{
			for (int rep = 0; rep < MF_QUERYRepetitionsUsed; rep++)
			{
				yield return (MFR_M05_MF_QUERY)this.GetStructure("MF_QUERY", rep);
			}
		}
	}

	///<summary>
	///Adds a new MFR_M05_MF_QUERY
	///</summary>
	public MFR_M05_MF_QUERY AddMF_QUERY()
	{
		return this.AddStructure("MF_QUERY") as MFR_M05_MF_QUERY;
	}

	///<summary>
	///Removes the given MFR_M05_MF_QUERY
	///</summary>
	public void RemoveMF_QUERY(MFR_M05_MF_QUERY toRemove)
	{
		this.RemoveStructure("MF_QUERY", toRemove);
	}

	///<summary>
	///Removes the MFR_M05_MF_QUERY at the given index
	///</summary>
