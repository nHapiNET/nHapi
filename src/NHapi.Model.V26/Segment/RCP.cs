...
public class RCP : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CNE), false, 1, 250, new System.Object[]{message}, "Response Modality");
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "Execution and Delivery Time");
