...
public class ODS : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), false, 10, 250, new System.Object[]{message}, "Service Period");
       this.add(typeof(CWE), true, 20, 250, new System.Object[]{message}, "Diet, Supplement, or Preference Code");
