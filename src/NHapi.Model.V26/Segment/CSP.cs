...
public class CSP : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(CWE), true, 1, 705, new System.Object[]{message}, "Study Phase Identifier");
       this.add(typeof(DTM), true, 1, 24, new System.Object[]{message}, "Date/time Study Phase Began");
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "Date/time Study Phase Ended");
       this.add(typeof(CWE), false, 1, 705, new System.Object[]{message}, "Study Phase Evaluability");
