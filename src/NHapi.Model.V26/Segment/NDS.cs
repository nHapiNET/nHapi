...
public class NDS : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(DTM), true, 1, 24, new System.Object[]{message}, "Notification Date/Time");
       this.add(typeof(CWE), true, 1, 705, new System.Object[]{message}, "Notification Alert Severity");
       this.add(typeof(CWE), true, 1, 705, new System.Object[]{message}, "Notification Code");
