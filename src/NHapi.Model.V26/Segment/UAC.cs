...
public class UAC : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(CWE), true, 1, 705, new System.Object[]{message}, "User Authentication Credential Type Code");
       this.add(typeof(ED), true, 1, 65536, new System.Object[]{message}, "User Authentication Credential");
