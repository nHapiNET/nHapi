...
public class ISD : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(NM), true, 1, 20, new System.Object[]{message}, "Reference Interaction Number");
       this.add(typeof(CWE), false, 1, 705, new System.Object[]{message}, "Interaction Type Identifier");
       this.add(typeof(CWE), true, 1, 705, new System.Object[]{message}, "Interaction Active State");
