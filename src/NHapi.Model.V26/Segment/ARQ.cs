...
public class ARQ : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Request Event Reason");
       ...
       this.add(typeof(DR), false, 0, 49, new System.Object[]{message}, "Requested Start Date/Time Range");
