...
public class RFI : AbstractSegment  {
   ...
   */
    ...
    try {
       this.add(typeof(DTM), true, 1, 24, new System.Object[]{message}, "Request Date");
       this.add(typeof(DTM), true, 1, 24, new System.Object[]{message}, "Response Due Date");
       this.add(typeof(ID), false, 1, 1, new System.Object[]{message, 136}, "Patient Consent");
       this.add(typeof(DTM), false, 1, 24, new System.Object[]{message}, "Date Additional Information was submitted");
