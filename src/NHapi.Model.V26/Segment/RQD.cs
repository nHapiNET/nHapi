...
///<li>RQD-7: Cost Center Account Number (IS)</li>
...
public class RQD : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Item Code - Internal");
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Item Code - External");
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Hospital Item Code");
       this.add(typeof(NM), false, 1, 6, new System.Object[]{message}, "Requisition Quantity");
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Requisition Unit of Measure");
       this.add(typeof(IS), false, 1, 30, new System.Object[]{message, 319}, "Cost Center Account Number");
       this.add(typeof(IS), false, 1, 30, new System.Object[]{message, 320}, "Item Natural Account Code");
       this.add(typeof(CWE), false, 1, 250, new System.Object[]{message}, "Deliver To ID");
	...
	///</summary>
	public IS CostCenterAccountNumber
	{
		get{
			IS ret = null;
			try
