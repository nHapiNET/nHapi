...
get{
	...
	/** 
	 * Enumerate over the MFR_M06_MF_PHASE_SCHED_DETAIL results 
	 */ 
	public IEnumerable<MFR_M06_MF_PHASE_SCHED_DETAIL> MF_PHASE_SCHED_DETAILs 
	{ 
		get
		{
			for (int rep = 0; rep < MF_PHASE_SCHED_DETAILRepetitionsUsed; rep++)
			{
				yield return (MFR_M06_MF_PHASE_SCHED_DETAIL)this.GetStructure("MF_PHASE_SCHED_DETAIL", rep);
			}
		}
	}

	///<summary>
	///Adds a new MFR_M06_MF_PHASE_SCHED_DETAIL
	///</summary>
	public MFR_M06_MF_PHASE_SCHED_DETAIL AddMF_PHASE_SCHED_DETAIL()
	{
		return this.AddStructure("MF_PHASE_SCHED_DETAIL") as MFR_M06_MF_PHASE_SCHED_DETAIL;
	}

	///<summary>
	///Removes the given MFR_M06_MF_PHASE_SCHED_DETAIL
	///</summary>
	public void RemoveMF_PHASE_SCHED_DETAIL(MFR_M06_MF_PHASE_SCHED_DETAIL toRemove)
	{
		this.RemoveStructure("MF_PHASE_SCHED_DETAIL", toRemove);
	}

	///<summary>
	///Removes the MFR_M06_MF_PHASE_SCHED_DETAIL at the given index
	///</summary>
