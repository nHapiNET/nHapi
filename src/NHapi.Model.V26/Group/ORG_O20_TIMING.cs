...
{
///<summary>
///Represents the ORG_O20_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class ORG_O20_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new ORG_O20_TIMING Group.
	///</summary>
	public ORG_O20_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORG_O20_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
