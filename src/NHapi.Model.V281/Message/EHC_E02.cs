...
{
///<summary>
/// Represents a EHC_E02 message structure (see chapter 16.3.2). This structure contains the 
/// following elements:
///<ol>
...
///<li>7: EHC_E02_PRODUCT_SERVICE_SECTION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class EHC_E02 : AbstractMessage  {

	///<summary> 
	/// Creates a new EHC_E02 Group with custom IModelClassFactory.
	///</summary>
	public EHC_E02(IModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	///</summary> 
	public EHC_E02() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for EHC_E02.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(EHC_E02_PRODUCT_SERVICE_SECTION), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating EHC_E02 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	public EHC_E02_PRODUCT_SERVICE_SECTION GetPRODUCT_SERVICE_SECTION() {
	   ...
	   try {
	      ret = (EHC_E02_PRODUCT_SERVICE_SECTION)this.GetStructure("PRODUCT_SERVICE_SECTION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///     greater than the number of existing repetitions.
	///</summary>
	public EHC_E02_PRODUCT_SERVICE_SECTION GetPRODUCT_SERVICE_SECTION(int rep) { 
	   return (EHC_E02_PRODUCT_SERVICE_SECTION)this.GetStructure("PRODUCT_SERVICE_SECTION", rep);
	}
...
get{
	...
	/** 
	 * Enumerate over the EHC_E02_PRODUCT_SERVICE_SECTION results 
	 */ 
	public IEnumerable<EHC_E02_PRODUCT_SERVICE_SECTION> PRODUCT_SERVICE_SECTIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PRODUCT_SERVICE_SECTIONRepetitionsUsed; rep++)
			{
				yield return (EHC_E02_PRODUCT_SERVICE_SECTION)this.GetStructure("PRODUCT_SERVICE_SECTION", rep);
			}
		}
	}

	///<summary>
	///Adds a new EHC_E02_PRODUCT_SERVICE_SECTION
	///</summary>
	public EHC_E02_PRODUCT_SERVICE_SECTION AddPRODUCT_SERVICE_SECTION()
	{
		return this.AddStructure("PRODUCT_SERVICE_SECTION") as EHC_E02_PRODUCT_SERVICE_SECTION;
	}

	///<summary>
	///Removes the given EHC_E02_PRODUCT_SERVICE_SECTION
	///</summary>
	public void RemovePRODUCT_SERVICE_SECTION(EHC_E02_PRODUCT_SERVICE_SECTION toRemove)
	{
		this.RemoveStructure("PRODUCT_SERVICE_SECTION", toRemove);
	}

	///<summary>
	///Removes the EHC_E02_PRODUCT_SERVICE_SECTION at the given index
	///</summary>
