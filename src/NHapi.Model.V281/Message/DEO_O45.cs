...
get{
	...
	/** 
	 * Enumerate over the DEO_O45_DONATION_ORDER results 
	 */ 
	public IEnumerable<DEO_O45_DONATION_ORDER> DONATION_ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < DONATION_ORDERRepetitionsUsed; rep++)
			{
				yield return (DEO_O45_DONATION_ORDER)this.GetStructure("DONATION_ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new DEO_O45_DONATION_ORDER
	///</summary>
	public DEO_O45_DONATION_ORDER AddDONATION_ORDER()
	{
		return this.AddStructure("DONATION_ORDER") as DEO_O45_DONATION_ORDER;
	}

	///<summary>
	///Removes the given DEO_O45_DONATION_ORDER
	///</summary>
	public void RemoveDONATION_ORDER(DEO_O45_DONATION_ORDER toRemove)
	{
		this.RemoveStructure("DONATION_ORDER", toRemove);
	}

	///<summary>
	///Removes the DEO_O45_DONATION_ORDER at the given index
	///</summary>
