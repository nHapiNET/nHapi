...
{
///<summary>
/// Represents a ORL_O34 message structure (see chapter 4.4.9.1). This structure contains the 
/// following elements:
///<ol>
...
///<li>6: ORL_O34_RESPONSE (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class ORL_O34 : AbstractMessage  {

	///<summary> 
	/// Creates a new ORL_O34 Group with custom IModelClassFactory.
	///</summary>
	public ORL_O34(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new ORL_O34 Group with DefaultModelClassFactory. 
	///</summary> 
	public ORL_O34() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for ORL_O34.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(ORL_O34_RESPONSE), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ORL_O34 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns ORL_O34_RESPONSE (a Group object) - creates it if necessary
	///</summary>
	public ORL_O34_RESPONSE RESPONSE { 
get{
	   ORL_O34_RESPONSE ret = null;
	   try {
	      ret = (ORL_O34_RESPONSE)this.GetStructure("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
