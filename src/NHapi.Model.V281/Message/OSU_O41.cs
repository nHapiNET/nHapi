...
{
///<summary>
/// Represents a OSU_O41 message structure (see chapter 4.4.18). This structure contains the 
/// following elements:
///<ol>
...
///<li>6: PID (Patient Identification) optional </li>
///<li>7: ARV (Access Restriction) optional repeating</li>
///<li>8: OSU_O41_ORDER_STATUS (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
public class OSU_O41 : AbstractMessage  {

	///<summary> 
	/// Creates a new OSU_O41 Group with custom IModelClassFactory.
	///</summary>
	public OSU_O41(IModelClassFactory factory) : base(factory){
	   init(factory);
	}

	///<summary>
	/// Creates a new OSU_O41 Group with DefaultModelClassFactory. 
	///</summary> 
	public OSU_O41() : base(new DefaultModelClassFactory()) { 
	   init(new DefaultModelClassFactory());
	}

	///<summary>
	/// initalize method for OSU_O41.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(OSU_O41_ORDER_STATUS), true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OSU_O41 - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	///Returns a specific repetition of OSU_O41_ORDER_STATUS
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OSU_O41_ORDER_STATUS GetORDER_STATUS(int rep) { 
	   return (OSU_O41_ORDER_STATUS)this.GetStructure("ORDER_STATUS", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OSU_O41_ORDER_STATUS 
	 */ 
	public int ORDER_STATUSRepetitionsUsed { 
get{
	    int reps = -1; 
	    try { 
	        reps = this.GetAll("ORDER_STATUS").Length; 
	    } catch (HL7Exception e) { 
	        string message = "Unexpected error accessing data - this is probably a bug in the source code generator."; 
	        HapiLogFactory.GetHapiLog(GetType()).Error(message, e); 
	        throw new System.Exception(message);
	...
	/** 
	 * Enumerate over the OSU_O41_ORDER_STATUS results 
	 */ 
	public IEnumerable<OSU_O41_ORDER_STATUS> ORDER_STATUSs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDER_STATUSRepetitionsUsed; rep++)
			{
				yield return (OSU_O41_ORDER_STATUS)this.GetStructure("ORDER_STATUS", rep);
			}
		}
	}

	///<summary>
	///Adds a new OSU_O41_ORDER_STATUS
	///</summary>
	public OSU_O41_ORDER_STATUS AddORDER_STATUS()
	{
		return this.AddStructure("ORDER_STATUS") as OSU_O41_ORDER_STATUS;
	}
	...
	///<summary>
	///Removes the OSU_O41_ORDER_STATUS at the given index
	///</summary>
	public void RemoveORDER_STATUSAt(int index)
	{
		this.RemoveRepetition("ORDER_STATUS", index);
	}
