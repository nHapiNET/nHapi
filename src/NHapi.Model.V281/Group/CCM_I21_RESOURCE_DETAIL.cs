...
get{
	...
	/** 
	 * Enumerate over the CCM_I21_RESOURCE_OBSERVATION results 
	 */ 
	public IEnumerable<CCM_I21_RESOURCE_OBSERVATION> RESOURCE_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCE_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCM_I21_RESOURCE_OBSERVATION)this.GetStructure("RESOURCE_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCM_I21_RESOURCE_OBSERVATION
	///</summary>
	public CCM_I21_RESOURCE_OBSERVATION AddRESOURCE_OBSERVATION()
	{
		return this.AddStructure("RESOURCE_OBSERVATION") as CCM_I21_RESOURCE_OBSERVATION;
	}

	///<summary>
	///Removes the given CCM_I21_RESOURCE_OBSERVATION
	///</summary>
	public void RemoveRESOURCE_OBSERVATION(CCM_I21_RESOURCE_OBSERVATION toRemove)
	{
		this.RemoveStructure("RESOURCE_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CCM_I21_RESOURCE_OBSERVATION at the given index
	///</summary>
