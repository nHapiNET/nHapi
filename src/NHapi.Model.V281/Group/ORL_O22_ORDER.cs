...
///<li>2: ORL_O22_TIMING (a Group object) optional repeating</li>
///<li>3: ORL_O22_OBSERVATION_REQUEST (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the ORL_O22_TIMING results 
	 */ 
	public IEnumerable<ORL_O22_TIMING> TIMINGs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMINGRepetitionsUsed; rep++)
			{
				yield return (ORL_O22_TIMING)this.GetStructure("TIMING", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O22_TIMING
	///</summary>
	public ORL_O22_TIMING AddTIMING()
	{
		return this.AddStructure("TIMING") as ORL_O22_TIMING;
	}

	///<summary>
	///Removes the given ORL_O22_TIMING
	///</summary>
	public void RemoveTIMING(ORL_O22_TIMING toRemove)
	{
		this.RemoveStructure("TIMING", toRemove);
	}

	///<summary>
	///Removes the ORL_O22_TIMING at the given index
	///</summary>
