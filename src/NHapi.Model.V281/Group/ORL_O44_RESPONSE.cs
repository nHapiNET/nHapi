...
get{
	...
	/** 
	 * Enumerate over the ORL_O44_ORDER results 
	 */ 
	public IEnumerable<ORL_O44_ORDER> ORDERs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDERRepetitionsUsed; rep++)
			{
				yield return (ORL_O44_ORDER)this.GetStructure("ORDER", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O44_ORDER
	///</summary>
	public ORL_O44_ORDER AddORDER()
	{
		return this.AddStructure("ORDER") as ORL_O44_ORDER;
	}

	///<summary>
	///Removes the given ORL_O44_ORDER
	///</summary>
	public void RemoveORDER(ORL_O44_ORDER toRemove)
	{
		this.RemoveStructure("ORDER", toRemove);
	}

	///<summary>
	///Removes the ORL_O44_ORDER at the given index
	///</summary>
