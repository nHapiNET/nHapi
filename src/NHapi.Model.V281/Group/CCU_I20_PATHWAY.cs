...
///<li>3: CCU_I20_PATHWAY_OBSERVATION (a Group object) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class CCU_I20_PATHWAY : AbstractGroup {
	...
	public CCU_I20_PATHWAY(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(CCU_I20_PATHWAY_OBSERVATION), false, true);
...
get{
	...
	/** 
	 * Enumerate over the CCU_I20_ROLE_PATHWAY results 
	 */ 
	public IEnumerable<CCU_I20_ROLE_PATHWAY> ROLE_PATHWAYs 
	{ 
		get
		{
			for (int rep = 0; rep < ROLE_PATHWAYRepetitionsUsed; rep++)
			{
				yield return (CCU_I20_ROLE_PATHWAY)this.GetStructure("ROLE_PATHWAY", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCU_I20_ROLE_PATHWAY
	///</summary>
	public CCU_I20_ROLE_PATHWAY AddROLE_PATHWAY()
	{
		return this.AddStructure("ROLE_PATHWAY") as CCU_I20_ROLE_PATHWAY;
	}

	///<summary>
	///Removes the given CCU_I20_ROLE_PATHWAY
	///</summary>
	public void RemoveROLE_PATHWAY(CCU_I20_ROLE_PATHWAY toRemove)
	{
		this.RemoveStructure("ROLE_PATHWAY", toRemove);
	}

	///<summary>
	///Removes the CCU_I20_ROLE_PATHWAY at the given index
	///</summary>
	...
	///<summary>
	///Returns a specific repetition of CCU_I20_PATHWAY_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public CCU_I20_PATHWAY_OBSERVATION GetPATHWAY_OBSERVATION(int rep) { 
	   return (CCU_I20_PATHWAY_OBSERVATION)this.GetStructure("PATHWAY_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CCU_I20_PATHWAY_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the CCU_I20_PATHWAY_OBSERVATION results 
	 */ 
	public IEnumerable<CCU_I20_PATHWAY_OBSERVATION> PATHWAY_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PATHWAY_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCU_I20_PATHWAY_OBSERVATION)this.GetStructure("PATHWAY_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCU_I20_PATHWAY_OBSERVATION
	///</summary>
	public CCU_I20_PATHWAY_OBSERVATION AddPATHWAY_OBSERVATION()
	{
		return this.AddStructure("PATHWAY_OBSERVATION") as CCU_I20_PATHWAY_OBSERVATION;
	}
	...
	///<summary>
	///Removes the CCU_I20_PATHWAY_OBSERVATION at the given index
	///</summary>
