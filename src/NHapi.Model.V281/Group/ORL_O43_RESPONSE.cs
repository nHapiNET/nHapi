...
get{
	...
	/** 
	 * Enumerate over the ORL_O43_SPECIMEN results 
	 */ 
	public IEnumerable<ORL_O43_SPECIMEN> SPECIMENs 
	{ 
		get
		{
			for (int rep = 0; rep < SPECIMENRepetitionsUsed; rep++)
			{
				yield return (ORL_O43_SPECIMEN)this.GetStructure("SPECIMEN", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORL_O43_SPECIMEN
	///</summary>
	public ORL_O43_SPECIMEN AddSPECIMEN()
	{
		return this.AddStructure("SPECIMEN") as ORL_O43_SPECIMEN;
	}

	///<summary>
	///Removes the given ORL_O43_SPECIMEN
	///</summary>
	public void RemoveSPECIMEN(ORL_O43_SPECIMEN toRemove)
	{
		this.RemoveStructure("SPECIMEN", toRemove);
	}

	///<summary>
	///Removes the ORL_O43_SPECIMEN at the given index
	///</summary>
