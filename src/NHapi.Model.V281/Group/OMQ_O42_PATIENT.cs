...
{
///<summary>
///Represents the OMQ_O42_PATIENT Group.  A Group is an ordered collection of message 
...
///<li>6: OMQ_O42_PATIENT_VISIT (a Group object) optional </li>
///<li>7: OMQ_O42_INSURANCE (a Group object) optional repeating</li>
///<li>8: GT1 (Guarantor) optional </li>
///<li>9: AL1 (Patient Allergy Information) optional repeating</li>
///</ol>
///</summary>
[Serializable]
public class OMQ_O42_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new OMQ_O42_PATIENT Group.
	///</summary>
	public OMQ_O42_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OMQ_O42_PATIENT_VISIT), false, false);
	      this.add(typeof(OMQ_O42_INSURANCE), false, true);
	      this.add(typeof(GT1), false, false);
	      this.add(typeof(AL1), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMQ_O42_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns OMQ_O42_PATIENT_VISIT (a Group object) - creates it if necessary
	///</summary>
	public OMQ_O42_PATIENT_VISIT PATIENT_VISIT { 
get{
	   OMQ_O42_PATIENT_VISIT ret = null;
	   try {
	      ret = (OMQ_O42_PATIENT_VISIT)this.GetStructure("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	/// Returns  first repetition of OMQ_O42_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public OMQ_O42_INSURANCE GetINSURANCE() {
	   OMQ_O42_INSURANCE ret = null;
	   try {
	      ret = (OMQ_O42_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of OMQ_O42_INSURANCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OMQ_O42_INSURANCE GetINSURANCE(int rep) { 
	   return (OMQ_O42_INSURANCE)this.GetStructure("INSURANCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OMQ_O42_INSURANCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the OMQ_O42_INSURANCE results 
	 */ 
	public IEnumerable<OMQ_O42_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (OMQ_O42_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new OMQ_O42_INSURANCE
	///</summary>
	public OMQ_O42_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as OMQ_O42_INSURANCE;
	}

	///<summary>
	///Removes the given OMQ_O42_INSURANCE
	///</summary>
	public void RemoveINSURANCE(OMQ_O42_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the OMQ_O42_INSURANCE at the given index
	///</summary>
