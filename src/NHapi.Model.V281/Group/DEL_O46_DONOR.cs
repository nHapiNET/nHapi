...
{
///<summary>
///Represents the DEL_O46_DONOR Group.  A Group is an ordered collection of message 
...
///<li>6: DEL_O46_DONOR_REGISTRATION (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class DEL_O46_DONOR : AbstractGroup {

	///<summary> 
	/// Creates a new DEL_O46_DONOR Group.
	///</summary>
	public DEL_O46_DONOR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(DEL_O46_DONOR_REGISTRATION), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating DEL_O46_DONOR - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns DEL_O46_DONOR_REGISTRATION (a Group object) - creates it if necessary
	///</summary>
	public DEL_O46_DONOR_REGISTRATION DONOR_REGISTRATION { 
get{
	   DEL_O46_DONOR_REGISTRATION ret = null;
	   try {
	      ret = (DEL_O46_DONOR_REGISTRATION)this.GetStructure("DONOR_REGISTRATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
