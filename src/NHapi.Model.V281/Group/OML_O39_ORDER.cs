...
{
///<summary>
///Represents the OML_O39_ORDER Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: ORC (Common Order) </li>
///<li>1: PRT (Participation Information) optional repeating</li>
///<li>2: OML_O39_TIMING (a Group object) optional repeating</li>
///<li>3: OML_O39_OBSERVATION_REQUEST (a Group object) optional </li>
...
///</summary>
[Serializable]
public class OML_O39_ORDER : AbstractGroup {

	///<summary> 
	/// Creates a new OML_O39_ORDER Group.
	///</summary>
	public OML_O39_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(ORC), true, false);
	      this.add(typeof(PRT), false, true);
	      this.add(typeof(OML_O39_TIMING), false, true);
	      this.add(typeof(OML_O39_OBSERVATION_REQUEST), false, false);
	      this.add(typeof(FT1), false, true);
	      this.add(typeof(CTI), false, true);
	      this.add(typeof(BLG), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OML_O39_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns  first repetition of OML_O39_TIMING (a Group object) - creates it if necessary
	///</summary>
	public OML_O39_TIMING GetTIMING() {
	   OML_O39_TIMING ret = null;
	   try {
	      ret = (OML_O39_TIMING)this.GetStructure("TIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of OML_O39_TIMING
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OML_O39_TIMING GetTIMING(int rep) { 
	   return (OML_O39_TIMING)this.GetStructure("TIMING", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OML_O39_TIMING 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the OML_O39_TIMING results 
	 */ 
	public IEnumerable<OML_O39_TIMING> TIMINGs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMINGRepetitionsUsed; rep++)
			{
				yield return (OML_O39_TIMING)this.GetStructure("TIMING", rep);
			}
		}
	}

	///<summary>
	///Adds a new OML_O39_TIMING
	///</summary>
	public OML_O39_TIMING AddTIMING()
	{
		return this.AddStructure("TIMING") as OML_O39_TIMING;
	}

	///<summary>
	///Removes the given OML_O39_TIMING
	///</summary>
	public void RemoveTIMING(OML_O39_TIMING toRemove)
	{
		this.RemoveStructure("TIMING", toRemove);
	}

	///<summary>
	///Removes the OML_O39_TIMING at the given index
	///</summary>
	...
	///<summary>
	/// Returns OML_O39_OBSERVATION_REQUEST (a Group object) - creates it if necessary
	///</summary>
	public OML_O39_OBSERVATION_REQUEST OBSERVATION_REQUEST { 
get{
	   OML_O39_OBSERVATION_REQUEST ret = null;
	   try {
	      ret = (OML_O39_OBSERVATION_REQUEST)this.GetStructure("OBSERVATION_REQUEST");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
