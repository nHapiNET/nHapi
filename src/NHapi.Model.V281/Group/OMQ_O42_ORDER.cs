...
get{
	...
	/** 
	 * Enumerate over the OMQ_O42_ORDER_DOCUMENT results 
	 */ 
	public IEnumerable<OMQ_O42_ORDER_DOCUMENT> ORDER_DOCUMENTs 
	{ 
		get
		{
			for (int rep = 0; rep < ORDER_DOCUMENTRepetitionsUsed; rep++)
			{
				yield return (OMQ_O42_ORDER_DOCUMENT)this.GetStructure("ORDER_DOCUMENT", rep);
			}
		}
	}

	///<summary>
	///Adds a new OMQ_O42_ORDER_DOCUMENT
	///</summary>
	public OMQ_O42_ORDER_DOCUMENT AddORDER_DOCUMENT()
	{
		return this.AddStructure("ORDER_DOCUMENT") as OMQ_O42_ORDER_DOCUMENT;
	}

	///<summary>
	///Removes the given OMQ_O42_ORDER_DOCUMENT
	///</summary>
	public void RemoveORDER_DOCUMENT(OMQ_O42_ORDER_DOCUMENT toRemove)
	{
		this.RemoveStructure("ORDER_DOCUMENT", toRemove);
	}

	///<summary>
	///Removes the OMQ_O42_ORDER_DOCUMENT at the given index
	///</summary>
	public void RemoveORDER_DOCUMENTAt(int index)
	{
		this.RemoveRepetition("ORDER_DOCUMENT", index);
	}
