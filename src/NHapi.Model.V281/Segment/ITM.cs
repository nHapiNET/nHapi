...
///<li>ITM-30: Hazardous Indicator (CNE)</li>
///<li>ITM-31: Sterile Indicator (CNE)</li>
///<li>ITM-32: Material Data Safety Sheet Number (EI)</li>
///<li>ITM-33: United Nations Standard Products and Services Code (UNSPSC) (CWE)</li>
///</ol>
...
get{
	...
	///<summary>
	/// Returns Hazardous Indicator(ITM-30).
	///</summary>
	public CNE HazardousIndicator
	{
		get{
			CNE ret = null;
			try
	...
	///<summary>
	/// Returns Sterile Indicator(ITM-31).
	///</summary>
	public CNE SterileIndicator
	{
		get{
			CNE ret = null;
			try
	...
	///<summary>
	/// Returns Material Data Safety Sheet Number(ITM-32).
	///</summary>
	public EI MaterialDataSafetySheetNumber
	{
		get{
			EI ret = null;
			try
	...
	///<summary>
	/// Returns United Nations Standard Products and Services Code (UNSPSC)(ITM-33).
	///</summary>
	public CWE UnitedNationsStandardProductsAndServicesCodeUNSPSC
	{
		get{
			CWE ret = null;
			try
