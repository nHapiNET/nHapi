...
///<li>TCC-15: Test Criticality (CWE)</li>
///</ol>
...
public class TCC : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), false, 1, 705, new System.Object[]{message}, "Test Criticality");
	...
	///<summary>
	/// Returns Test Criticality(TCC-15).
	///</summary>
	public CWE TestCriticality
	{
		get{
			CWE ret = null;
			try
