...
get{
	...
	/** 
	 * Enumerate over the CCM_I21_RESOURCE_DETAIL results 
	 */ 
	public IEnumerable<CCM_I21_RESOURCE_DETAIL> RESOURCE_DETAILs 
	{ 
		get
		{
			for (int rep = 0; rep < RESOURCE_DETAILRepetitionsUsed; rep++)
			{
				yield return (CCM_I21_RESOURCE_DETAIL)this.GetStructure("RESOURCE_DETAIL", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCM_I21_RESOURCE_DETAIL
	///</summary>
	public CCM_I21_RESOURCE_DETAIL AddRESOURCE_DETAIL()
	{
		return this.AddStructure("RESOURCE_DETAIL") as CCM_I21_RESOURCE_DETAIL;
	}

	///<summary>
	///Removes the given CCM_I21_RESOURCE_DETAIL
	///</summary>
	public void RemoveRESOURCE_DETAIL(CCM_I21_RESOURCE_DETAIL toRemove)
	{
		this.RemoveStructure("RESOURCE_DETAIL", toRemove);
	}

	///<summary>
	///Removes the CCM_I21_RESOURCE_DETAIL at the given index
	///</summary>
