...
get{
	...
	/** 
	 * Enumerate over the CCM_I21_MEDICATION_ADMINISTRATION_DETAIL results 
	 */ 
	public IEnumerable<CCM_I21_MEDICATION_ADMINISTRATION_DETAIL> MEDICATION_ADMINISTRATION_DETAILs 
	{ 
		get
		{
			for (int rep = 0; rep < MEDICATION_ADMINISTRATION_DETAILRepetitionsUsed; rep++)
			{
				yield return (CCM_I21_MEDICATION_ADMINISTRATION_DETAIL)this.GetStructure("MEDICATION_ADMINISTRATION_DETAIL", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCM_I21_MEDICATION_ADMINISTRATION_DETAIL
	///</summary>
	public CCM_I21_MEDICATION_ADMINISTRATION_DETAIL AddMEDICATION_ADMINISTRATION_DETAIL()
	{
		return this.AddStructure("MEDICATION_ADMINISTRATION_DETAIL") as CCM_I21_MEDICATION_ADMINISTRATION_DETAIL;
	}

	///<summary>
	///Removes the given CCM_I21_MEDICATION_ADMINISTRATION_DETAIL
	///</summary>
	public void RemoveMEDICATION_ADMINISTRATION_DETAIL(CCM_I21_MEDICATION_ADMINISTRATION_DETAIL toRemove)
	{
		this.RemoveStructure("MEDICATION_ADMINISTRATION_DETAIL", toRemove);
	}

	///<summary>
	///Removes the CCM_I21_MEDICATION_ADMINISTRATION_DETAIL at the given index
	///</summary>
