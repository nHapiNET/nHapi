...
///<li>2: OML_O33_TIMING (a Group object) optional repeating</li>
///<li>3: OML_O33_OBSERVATION_REQUEST (a Group object) optional </li>
...
public class OML_O33_ORDER : AbstractGroup {
	...
	public OML_O33_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O33_TIMING), false, true);
...
get{
	...
	public OML_O33_TIMING GetTIMING(int rep) { 
	   return (OML_O33_TIMING)this.GetStructure("TIMING", rep);
	}
