...
{
///<summary>
/// Represents a RSP_K21 message structure (see chapter 3.3.56). This structure contains the 
/// following elements:
///<ol>
...
public class RSP_K21 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for RSP_K21.  This does the segment setup for the message. 
	///</summary> 
...
get{
	...
	/** 
	 * Enumerate over the RSP_K21_QUERY_RESPONSE results 
	 */ 
	public IEnumerable<RSP_K21_QUERY_RESPONSE> QUERY_RESPONSEs 
	{ 
		get
		{
			for (int rep = 0; rep < QUERY_RESPONSERepetitionsUsed; rep++)
			{
				yield return (RSP_K21_QUERY_RESPONSE)this.GetStructure("QUERY_RESPONSE", rep);
			}
		}
	}

	///<summary>
	///Adds a new RSP_K21_QUERY_RESPONSE
	///</summary>
	public RSP_K21_QUERY_RESPONSE AddQUERY_RESPONSE()
	{
		return this.AddStructure("QUERY_RESPONSE") as RSP_K21_QUERY_RESPONSE;
	}

	///<summary>
	///Removes the given RSP_K21_QUERY_RESPONSE
	///</summary>
	public void RemoveQUERY_RESPONSE(RSP_K21_QUERY_RESPONSE toRemove)
	{
		this.RemoveStructure("QUERY_RESPONSE", toRemove);
	}

	///<summary>
	///Removes the RSP_K21_QUERY_RESPONSE at the given index
	///</summary>
