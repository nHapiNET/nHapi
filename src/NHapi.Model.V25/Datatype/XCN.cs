...
public class XCN : AbstractType, IComposite{
	...
	public XCN(IMessage message, string description) : base(message, description){
		...
		data[18] = new TS(message,"Effective Date");
		data[19] = new TS(message,"Expiration Date");
...
get{
		try { 
			...
			throw new DataTypeException("Element " + index + " doesn't exist in 23 element XCN composite"); 
		} 
	} 
	} 
	///<summary>
