...
get{
	...
	/** 
	 * Enumerate over the ORF_R04_TIMING_QTY results 
	 */ 
	public IEnumerable<ORF_R04_TIMING_QTY> TIMING_QTYs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_QTYRepetitionsUsed; rep++)
			{
				yield return (ORF_R04_TIMING_QTY)this.GetStructure("TIMING_QTY", rep);
			}
		}
	}

	///<summary>
	///Adds a new ORF_R04_TIMING_QTY
	///</summary>
	public ORF_R04_TIMING_QTY AddTIMING_QTY()
	{
		return this.AddStructure("TIMING_QTY") as ORF_R04_TIMING_QTY;
	}
	...
	///<summary>
	///Removes the ORF_R04_TIMING_QTY at the given index
	///</summary>
