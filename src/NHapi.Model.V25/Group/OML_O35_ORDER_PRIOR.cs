...
///<li>3: OML_O35_TIMING_PRIOR (a Group object) optional repeating</li>
///<li>4: OML_O35_OBSERVATION_PRIOR (a Group object) repeating</li>
///</ol>
///</summary>
[Serializable]
...
get{
	...
	/** 
	 * Enumerate over the OML_O35_TIMING_PRIOR results 
	 */ 
	public IEnumerable<OML_O35_TIMING_PRIOR> TIMING_PRIORs 
	{ 
		get
		{
			for (int rep = 0; rep < TIMING_PRIORRepetitionsUsed; rep++)
			{
				yield return (OML_O35_TIMING_PRIOR)this.GetStructure("TIMING_PRIOR", rep);
			}
		}
	}

	///<summary>
	///Adds a new OML_O35_TIMING_PRIOR
	///</summary>
	public OML_O35_TIMING_PRIOR AddTIMING_PRIOR()
	{
		return this.AddStructure("TIMING_PRIOR") as OML_O35_TIMING_PRIOR;
	}

	///<summary>
	///Removes the given OML_O35_TIMING_PRIOR
	///</summary>
	public void RemoveTIMING_PRIOR(OML_O35_TIMING_PRIOR toRemove)
	{
		this.RemoveStructure("TIMING_PRIOR", toRemove);
	}

	///<summary>
	///Removes the OML_O35_TIMING_PRIOR at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the OML_O35_OBSERVATION_PRIOR results 
	 */ 
	public IEnumerable<OML_O35_OBSERVATION_PRIOR> OBSERVATION_PRIORs 
	{ 
		get
		{
			for (int rep = 0; rep < OBSERVATION_PRIORRepetitionsUsed; rep++)
			{
				yield return (OML_O35_OBSERVATION_PRIOR)this.GetStructure("OBSERVATION_PRIOR", rep);
			}
		}
	}

	///<summary>
	///Adds a new OML_O35_OBSERVATION_PRIOR
	///</summary>
	public OML_O35_OBSERVATION_PRIOR AddOBSERVATION_PRIOR()
	{
		return this.AddStructure("OBSERVATION_PRIOR") as OML_O35_OBSERVATION_PRIOR;
	}

	///<summary>
	///Removes the given OML_O35_OBSERVATION_PRIOR
	///</summary>
	public void RemoveOBSERVATION_PRIOR(OML_O35_OBSERVATION_PRIOR toRemove)
	{
		this.RemoveStructure("OBSERVATION_PRIOR", toRemove);
	}

	///<summary>
	///Removes the OML_O35_OBSERVATION_PRIOR at the given index
	///</summary>
