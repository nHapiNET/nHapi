...
{
///<summary>
///Represents the OMG_O19_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class OMG_O19_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new OMG_O19_TIMING Group.
	///</summary>
	public OMG_O19_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OMG_O19_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
