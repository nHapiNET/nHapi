...
{
///<summary>
///Represents the RSP_Z90_TIMING Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class RSP_Z90_TIMING : AbstractGroup {

	///<summary> 
	/// Creates a new RSP_Z90_TIMING Group.
	///</summary>
	public RSP_Z90_TIMING(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(TQ1), true, false);
	      this.add(typeof(TQ2), false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating RSP_Z90_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
