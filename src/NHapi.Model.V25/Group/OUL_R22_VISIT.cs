...
{
///<summary>
///Represents the OUL_R22_VISIT Group.  A Group is an ordered collection of message 
...
public class OUL_R22_VISIT : AbstractGroup {
	...
	///</summary>
	public OUL_R22_VISIT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
