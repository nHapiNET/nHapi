...
{
///<summary>
/// Represents a ADT_A16 message structure (see chapter 3.3.16). This structure contains the 
/// following elements:
///<ol>
...
///<li>9: PV1 (Patient Visit) </li>
///<li>10: PV2 (Patient Visit - Additional Information) optional </li>
///<li>11: ARV (Access Restriction) optional repeating</li>
...
///<li>15: AL1 (Patient Allergy Information) optional repeating</li>
///<li>16: DG1 (Diagnosis) optional repeating</li>
///<li>17: DRG (Diagnosis Related Group) optional </li>
///<li>18: ADT_A16_PROCEDURE (a Group object) optional repeating</li>
///<li>19: GT1 (Guarantor) optional repeating</li>
///<li>20: ADT_A16_INSURANCE (a Group object) optional repeating</li>
///<li>21: ACC (Accident) optional </li>
///</ol>
///</summary>
[Serializable]
public class ADT_A16 : AbstractMessage  {
	...
	///<summary>
	/// initalize method for ADT_A16.  This does the segment setup for the message. 
	///</summary> 
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(ADT_A16_PROCEDURE), false, true);
	      this.add(typeof(GT1), false, true);
	      this.add(typeof(ADT_A16_INSURANCE), false, true);
...
get{
	...
	///<summary>
	/// Returns  first repetition of ADT_A16_PROCEDURE (a Group object) - creates it if necessary
	///</summary>
	public ADT_A16_PROCEDURE GetPROCEDURE() {
	   ADT_A16_PROCEDURE ret = null;
	   try {
	      ret = (ADT_A16_PROCEDURE)this.GetStructure("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ADT_A16_PROCEDURE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ADT_A16_PROCEDURE GetPROCEDURE(int rep) { 
	   return (ADT_A16_PROCEDURE)this.GetStructure("PROCEDURE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A16_PROCEDURE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the ADT_A16_PROCEDURE results 
	 */ 
	public IEnumerable<ADT_A16_PROCEDURE> PROCEDUREs 
	{ 
		get
		{
			for (int rep = 0; rep < PROCEDURERepetitionsUsed; rep++)
			{
				yield return (ADT_A16_PROCEDURE)this.GetStructure("PROCEDURE", rep);
			}
		}
	}

	///<summary>
	///Adds a new ADT_A16_PROCEDURE
	///</summary>
	public ADT_A16_PROCEDURE AddPROCEDURE()
	{
		return this.AddStructure("PROCEDURE") as ADT_A16_PROCEDURE;
	}

	///<summary>
	///Removes the given ADT_A16_PROCEDURE
	///</summary>
	public void RemovePROCEDURE(ADT_A16_PROCEDURE toRemove)
	{
		this.RemoveStructure("PROCEDURE", toRemove);
	}

	///<summary>
	///Removes the ADT_A16_PROCEDURE at the given index
	///</summary>
...
get{
	...
	///<summary>
	/// Returns  first repetition of ADT_A16_INSURANCE (a Group object) - creates it if necessary
	///</summary>
	public ADT_A16_INSURANCE GetINSURANCE() {
	   ADT_A16_INSURANCE ret = null;
	   try {
	      ret = (ADT_A16_INSURANCE)this.GetStructure("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of ADT_A16_INSURANCE
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public ADT_A16_INSURANCE GetINSURANCE(int rep) { 
	   return (ADT_A16_INSURANCE)this.GetStructure("INSURANCE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A16_INSURANCE 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the ADT_A16_INSURANCE results 
	 */ 
	public IEnumerable<ADT_A16_INSURANCE> INSURANCEs 
	{ 
		get
		{
			for (int rep = 0; rep < INSURANCERepetitionsUsed; rep++)
			{
				yield return (ADT_A16_INSURANCE)this.GetStructure("INSURANCE", rep);
			}
		}
	}

	///<summary>
	///Adds a new ADT_A16_INSURANCE
	///</summary>
	public ADT_A16_INSURANCE AddINSURANCE()
	{
		return this.AddStructure("INSURANCE") as ADT_A16_INSURANCE;
	}

	///<summary>
	///Removes the given ADT_A16_INSURANCE
	///</summary>
	public void RemoveINSURANCE(ADT_A16_INSURANCE toRemove)
	{
		this.RemoveStructure("INSURANCE", toRemove);
	}

	///<summary>
	///Removes the ADT_A16_INSURANCE at the given index
	///</summary>
