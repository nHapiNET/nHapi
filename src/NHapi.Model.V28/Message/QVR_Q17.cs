...
{
///<summary>
/// Represents a QVR_Q17 message structure (see chapter 5.4.5). This structure contains the 
/// following elements:
///<ol>
...
///<li>4: QVR_Q17_QBP (a Group object) optional </li>
...
public class QVR_Q17 : AbstractMessage  {
	...
	private void init(IModelClassFactory factory) {
	   try {
	      ...
	      this.add(typeof(QVR_Q17_QBP), false, false);
...
get{
	...
	///<summary>
	/// Returns QVR_Q17_QBP (a Group object) - creates it if necessary
	///</summary>
	public QVR_Q17_QBP QBP { 
get{
	   QVR_Q17_QBP ret = null;
	   try {
	      ret = (QVR_Q17_QBP)this.GetStructure("QBP");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
