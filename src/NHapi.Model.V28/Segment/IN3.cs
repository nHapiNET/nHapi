...
///<li>IN3-26: Certification Type (CWE)</li>
///<li>IN3-27: Certification Category (CWE)</li>
///</ol>
...
public class IN3 : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), false, 1, 0, new System.Object[]{message}, "Certification Type");
       this.add(typeof(CWE), false, 1, 0, new System.Object[]{message}, "Certification Category");
...
get{
	...
	///<summary>
	/// Returns Certification Type(IN3-26).
	///</summary>
	public CWE CertificationType
	{
		get{
			CWE ret = null;
			try
	...
	///<summary>
	/// Returns Certification Category(IN3-27).
	///</summary>
	public CWE CertificationCategory
	{
		get{
			CWE ret = null;
			try
