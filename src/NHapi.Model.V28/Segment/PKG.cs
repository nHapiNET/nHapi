...
///<li>PKG-8: Global Trade Item Number (CWE)</li>
///</ol>
...
public class PKG : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CWE), false, 1, 0, new System.Object[]{message}, "Global Trade Item Number");
	...
	///<summary>
	/// Returns Global Trade Item Number(PKG-8).
	///</summary>
	public CWE GlobalTradeItemNumber
	{
		get{
			CWE ret = null;
			try
