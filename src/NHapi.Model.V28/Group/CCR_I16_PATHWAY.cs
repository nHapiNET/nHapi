...
get{
	...
	/** 
	 * Enumerate over the CCR_I16_ROLE_PATHWAY results 
	 */ 
	public IEnumerable<CCR_I16_ROLE_PATHWAY> ROLE_PATHWAYs 
	{ 
		get
		{
			for (int rep = 0; rep < ROLE_PATHWAYRepetitionsUsed; rep++)
			{
				yield return (CCR_I16_ROLE_PATHWAY)this.GetStructure("ROLE_PATHWAY", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCR_I16_ROLE_PATHWAY
	///</summary>
	public CCR_I16_ROLE_PATHWAY AddROLE_PATHWAY()
	{
		return this.AddStructure("ROLE_PATHWAY") as CCR_I16_ROLE_PATHWAY;
	}

	///<summary>
	///Removes the given CCR_I16_ROLE_PATHWAY
	///</summary>
	public void RemoveROLE_PATHWAY(CCR_I16_ROLE_PATHWAY toRemove)
	{
		this.RemoveStructure("ROLE_PATHWAY", toRemove);
	}

	///<summary>
	///Removes the CCR_I16_ROLE_PATHWAY at the given index
	///</summary>
...
get{
	...
	/** 
	 * Enumerate over the CCR_I16_PATHWAY_OBSERVATION results 
	 */ 
	public IEnumerable<CCR_I16_PATHWAY_OBSERVATION> PATHWAY_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PATHWAY_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCR_I16_PATHWAY_OBSERVATION)this.GetStructure("PATHWAY_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCR_I16_PATHWAY_OBSERVATION
	///</summary>
	public CCR_I16_PATHWAY_OBSERVATION AddPATHWAY_OBSERVATION()
	{
		return this.AddStructure("PATHWAY_OBSERVATION") as CCR_I16_PATHWAY_OBSERVATION;
	}

	///<summary>
	///Removes the given CCR_I16_PATHWAY_OBSERVATION
	///</summary>
	public void RemovePATHWAY_OBSERVATION(CCR_I16_PATHWAY_OBSERVATION toRemove)
	{
		this.RemoveStructure("PATHWAY_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CCR_I16_PATHWAY_OBSERVATION at the given index
	///</summary>
