...
{
///<summary>
///Represents the OUL_R23_PATIENT Group.  A Group is an ordered collection of message 
...
///<li>5: OUL_R23_PATIENT_OBSERVATION (a Group object) optional repeating</li>
///<li>6: OUL_R23_VISIT (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class OUL_R23_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new OUL_R23_PATIENT Group.
	///</summary>
	public OUL_R23_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OUL_R23_PATIENT_OBSERVATION), false, true);
	      this.add(typeof(OUL_R23_VISIT), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating OUL_R23_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns  first repetition of OUL_R23_PATIENT_OBSERVATION (a Group object) - creates it if necessary
	///</summary>
	public OUL_R23_PATIENT_OBSERVATION GetPATIENT_OBSERVATION() {
	   OUL_R23_PATIENT_OBSERVATION ret = null;
	   try {
	      ret = (OUL_R23_PATIENT_OBSERVATION)this.GetStructure("PATIENT_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	///<summary>
	///Returns a specific repetition of OUL_R23_PATIENT_OBSERVATION
	/// * (a Group object) - creates it if necessary
	/// throws HL7Exception if the repetition requested is more than one 
	///     greater than the number of existing repetitions.
	///</summary>
	public OUL_R23_PATIENT_OBSERVATION GetPATIENT_OBSERVATION(int rep) { 
	   return (OUL_R23_PATIENT_OBSERVATION)this.GetStructure("PATIENT_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OUL_R23_PATIENT_OBSERVATION 
	 */ 
...
get{
	...
	/** 
	 * Enumerate over the OUL_R23_PATIENT_OBSERVATION results 
	 */ 
	public IEnumerable<OUL_R23_PATIENT_OBSERVATION> PATIENT_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < PATIENT_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (OUL_R23_PATIENT_OBSERVATION)this.GetStructure("PATIENT_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new OUL_R23_PATIENT_OBSERVATION
	///</summary>
	public OUL_R23_PATIENT_OBSERVATION AddPATIENT_OBSERVATION()
	{
		return this.AddStructure("PATIENT_OBSERVATION") as OUL_R23_PATIENT_OBSERVATION;
	}

	///<summary>
	///Removes the given OUL_R23_PATIENT_OBSERVATION
	///</summary>
	public void RemovePATIENT_OBSERVATION(OUL_R23_PATIENT_OBSERVATION toRemove)
	{
		this.RemoveStructure("PATIENT_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the OUL_R23_PATIENT_OBSERVATION at the given index
	///</summary>
