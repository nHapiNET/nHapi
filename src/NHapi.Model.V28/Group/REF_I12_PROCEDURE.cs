...
///<li>1: REF_I12_AUTHORIZATION_CONTACT2 (a Group object) optional </li>
///</ol>
///</summary>
[Serializable]
public class REF_I12_PROCEDURE : AbstractGroup {
	...
	public REF_I12_PROCEDURE(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(REF_I12_AUTHORIZATION_CONTACT2), false, false);
...
get{
	...
	///<summary>
	/// Returns REF_I12_AUTHORIZATION_CONTACT2 (a Group object) - creates it if necessary
	///</summary>
	public REF_I12_AUTHORIZATION_CONTACT2 AUTHORIZATION_CONTACT2 { 
get{
	   REF_I12_AUTHORIZATION_CONTACT2 ret = null;
	   try {
	      ret = (REF_I12_AUTHORIZATION_CONTACT2)this.GetStructure("AUTHORIZATION_CONTACT2");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
