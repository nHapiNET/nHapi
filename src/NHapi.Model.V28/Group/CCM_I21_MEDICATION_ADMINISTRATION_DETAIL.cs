...
get{
	...
	/** 
	 * Enumerate over the CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION results 
	 */ 
	public IEnumerable<CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION> MEDICATION_ADMINISTRATION_OBSERVATIONs 
	{ 
		get
		{
			for (int rep = 0; rep < MEDICATION_ADMINISTRATION_OBSERVATIONRepetitionsUsed; rep++)
			{
				yield return (CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION)this.GetStructure("MEDICATION_ADMINISTRATION_OBSERVATION", rep);
			}
		}
	}

	///<summary>
	///Adds a new CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION
	///</summary>
	public CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION AddMEDICATION_ADMINISTRATION_OBSERVATION()
	{
		return this.AddStructure("MEDICATION_ADMINISTRATION_OBSERVATION") as CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION;
	}

	///<summary>
	///Removes the given CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION
	///</summary>
	public void RemoveMEDICATION_ADMINISTRATION_OBSERVATION(CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION toRemove)
	{
		this.RemoveStructure("MEDICATION_ADMINISTRATION_OBSERVATION", toRemove);
	}

	///<summary>
	///Removes the CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION at the given index
	///</summary>
