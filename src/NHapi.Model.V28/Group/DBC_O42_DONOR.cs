...
{
///<summary>
///Represents the DBC_O42_DONOR Group.  A Group is an ordered collection of message 
...
///</summary>
[Serializable]
public class DBC_O42_DONOR : AbstractGroup {

	///<summary> 
	/// Creates a new DBC_O42_DONOR Group.
	///</summary>
	public DBC_O42_DONOR(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating DBC_O42_DONOR - this is probably a bug in the source code generator.", e);
	   }
	}
